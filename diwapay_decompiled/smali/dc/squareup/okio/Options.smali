...
.method private static buildTrieRecursive(JLdc/squareup/okio/Buffer;ILjava/util/List;IILjava/util/List;)V
    ...
    check-cast v6, Ldc/squareup/okio/ByteString;
    ...
    check-cast v9, Ldc/squareup/okio/ByteString;

    invoke-virtual {v9, v1}, Ldc/squareup/okio/ByteString;->getByte(I)B
    ...
    .line 39
    :cond_7
    new-instance v4, Ldc/squareup/okio/Buffer;

    invoke-direct {v4}, Ldc/squareup/okio/Buffer;-><init>()V
    ...
    .line 57
    :cond_a
    invoke-static {v4}, Ldc/squareup/okio/Options;->intCount(Ldc/squareup/okio/Buffer;)I
    ...
    invoke-virtual {v0, v4, v1, v2}, Ldc/squareup/okio/Buffer;->write(Ldc/squareup/okio/Buffer;J)V
    ...
    .line 77
    invoke-virtual {v3, v11}, Ldc/squareup/okio/ByteString;->getByte(I)B

    move-result v12

    move-wide/from16 v17, v13

    invoke-virtual {v4, v11}, Ldc/squareup/okio/ByteString;->getByte(I)B
    ...
    .line 91
    invoke-virtual {v3, v2}, Ldc/squareup/okio/ByteString;->getByte(I)B
    ...
    .line 106
    invoke-static {v3}, Ldc/squareup/okio/Options;->intCount(Ldc/squareup/okio/Buffer;)I
...
.method public static varargs of([Ldc/squareup/okio/ByteString;)Ldc/squareup/okio/Options;
    ...
    new-array v0, v2, [Ldc/squareup/okio/ByteString;
    ...
    .line 29
    invoke-virtual {v5, v1}, Ldc/squareup/okio/ByteString;->startsWith(Ldc/squareup/okio/ByteString;)Z
    ...
    invoke-static/range {v3 .. v10}, Ldc/squareup/okio/Options;->buildTrieRecursive(JLdc/squareup/okio/Buffer;ILjava/util/List;IILjava/util/List;)V

    .line 50
    invoke-static {v5}, Ldc/squareup/okio/Options;->intCount(Ldc/squareup/okio/Buffer;)I
    ...
    .line 52
    invoke-virtual {v5}, Ldc/squareup/okio/Buffer;->readInt()I
    ...
    .line 54
    :cond_8
    invoke-virtual {v5}, Ldc/squareup/okio/Buffer;->exhausted()Z
    ...
    invoke-direct {v0, p0, v1}, Ldc/squareup/okio/Options;-><init>([Ldc/squareup/okio/ByteString;[I)V
