...
.method public indexOf(BJJ)J
    ...
    .line 16
    iget-object p4, p0, Ldc/squareup/okio/RealBufferedSource;->source:Ldc/squareup/okio/Source;

    const-wide/16 v0, 0x2000

    invoke-interface {p4, p1, v0, v1}, Ldc/squareup/okio/Source;->read(Ldc/squareup/okio/Buffer;J)J
...
.method public rangeEquals(JLdc/squareup/okio/ByteString;II)Z
    ...
    invoke-virtual {v4, v2, v3}, Ldc/squareup/okio/Buffer;->getByte(J)B
...
.method public readDecimalLong()J
    ...
    .line 3
    invoke-virtual {p0, v2, v3}, Ldc/squareup/okio/RealBufferedSource;->request(J)Z
    ...
    invoke-virtual {v2, v3, v4}, Ldc/squareup/okio/Buffer;->getByte(J)B
...
.method public readFully([B)V
    ...
    .line 14
    invoke-virtual {v2, p1, v1, v3}, Ldc/squareup/okio/Buffer;->read([BII)I
...
.method public readUtf8LineStrict(J)Ljava/lang/String;
    ...
    .line 2
    invoke-virtual/range {v7 .. v12}, Ldc/squareup/okio/RealBufferedSource;->indexOf(BJJ)J
    ...
    .line 3
    iget-object p1, v7, Ldc/squareup/okio/RealBufferedSource;->buffer:Ldc/squareup/okio/Buffer;

    invoke-virtual {p1, v5, v6}, Ldc/squareup/okio/Buffer;->readUtf8Line(J)Ljava/lang/String;
    ...
    .line 5
    invoke-virtual {p0, v11, v12}, Ldc/squareup/okio/RealBufferedSource;->request(J)Z

    move-result v0

    if-eqz v0, :cond_2

    iget-object v0, v7, Ldc/squareup/okio/RealBufferedSource;->buffer:Ldc/squareup/okio/Buffer;
    ...
    invoke-virtual {v0, v11, v12}, Ldc/squareup/okio/Buffer;->getByte(J)B
    ...
    invoke-virtual {p1, v11, v12}, Ldc/squareup/okio/Buffer;->readUtf8Line(J)Ljava/lang/String;
    ...
    iget-object v3, v7, Ldc/squareup/okio/RealBufferedSource;->buffer:Ldc/squareup/okio/Buffer;
    ...
    invoke-virtual {p2}, Ldc/squareup/okio/ByteString;->hex()Ljava/lang/String;
