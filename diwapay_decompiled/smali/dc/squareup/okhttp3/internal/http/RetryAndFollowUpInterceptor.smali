...
.method private createAddress(Ldc/squareup/okhttp3/HttpUrl;)Ldc/squareup/okhttp3/Address;
    ...
    invoke-virtual {v0}, Ldc/squareup/okhttp3/OkHttpClient;->sslSocketFactory()Ljavax/net/ssl/SSLSocketFactory;
    ...
    .line 4
    iget-object v2, p0, Ldc/squareup/okhttp3/internal/http/RetryAndFollowUpInterceptor;->client:Ldc/squareup/okhttp3/OkHttpClient;

    invoke-virtual {v2}, Ldc/squareup/okhttp3/OkHttpClient;->certificatePinner()Ldc/squareup/okhttp3/CertificatePinner;
    ...
    iget-object p1, p0, Ldc/squareup/okhttp3/internal/http/RetryAndFollowUpInterceptor;->client:Ldc/squareup/okhttp3/OkHttpClient;

    invoke-virtual {p1}, Ldc/squareup/okhttp3/OkHttpClient;->dns()Ldc/squareup/okhttp3/Dns;

    move-result-object v4

    iget-object p1, p0, Ldc/squareup/okhttp3/internal/http/RetryAndFollowUpInterceptor;->client:Ldc/squareup/okhttp3/OkHttpClient;

    invoke-virtual {p1}, Ldc/squareup/okhttp3/OkHttpClient;->socketFactory()Ljavax/net/SocketFactory;
    ...
    .line 8
    invoke-virtual {p1}, Ldc/squareup/okhttp3/OkHttpClient;->proxyAuthenticator()Ldc/squareup/okhttp3/Authenticator;
    ...
    .line 9
    invoke-virtual {p1}, Ldc/squareup/okhttp3/OkHttpClient;->proxy()Ljava/net/Proxy;
    ...
    invoke-virtual {p1}, Ldc/squareup/okhttp3/OkHttpClient;->connectionSpecs()Ljava/util/List;

    move-result-object v12

    iget-object p1, p0, Ldc/squareup/okhttp3/internal/http/RetryAndFollowUpInterceptor;->client:Ldc/squareup/okhttp3/OkHttpClient;

    invoke-virtual {p1}, Ldc/squareup/okhttp3/OkHttpClient;->proxySelector()Ljava/net/ProxySelector;

    move-result-object v13

    invoke-direct/range {v1 .. v13}, Ldc/squareup/okhttp3/Address;-><init>(Ljava/lang/String;ILdc/squareup/okhttp3/Dns;Ljavax/net/SocketFactory;Ljavax/net/ssl/SSLSocketFactory;Ljavax/net/ssl/HostnameVerifier;Ldc/squareup/okhttp3/CertificatePinner;Ldc/squareup/okhttp3/Authenticator;Ljava/net/Proxy;Ljava/util/List;Ljava/util/List;Ljava/net/ProxySelector;)V
...
.method public intercept(Ldc/squareup/okhttp3/Interceptor$Chain;)Ldc/squareup/okhttp3/Response;
    ...
    .line 6
    new-instance v1, Ldc/squareup/okhttp3/internal/connection/StreamAllocation;

    iget-object v2, p0, Ldc/squareup/okhttp3/internal/http/RetryAndFollowUpInterceptor;->client:Ldc/squareup/okhttp3/OkHttpClient;

    invoke-virtual {v2}, Ldc/squareup/okhttp3/OkHttpClient;->connectionPool()Ldc/squareup/okhttp3/ConnectionPool;
    ...
    invoke-direct {p0, v3}, Ldc/squareup/okhttp3/internal/http/RetryAndFollowUpInterceptor;->createAddress(Ldc/squareup/okhttp3/HttpUrl;)Ldc/squareup/okhttp3/Address;
    ...
    .line 8
    iput-object v1, p0, Ldc/squareup/okhttp3/internal/http/RetryAndFollowUpInterceptor;->streamAllocation:Ldc/squareup/okhttp3/internal/connection/StreamAllocation;
    ...
    .line 21
    :try_start_0
    invoke-virtual {p1, v1, v2, v8, v8}, Ldc/squareup/okhttp3/internal/http/RealInterceptorChain;->proceed(Ldc/squareup/okhttp3/Request;Ldc/squareup/okhttp3/internal/connection/StreamAllocation;Ldc/squareup/okhttp3/internal/http/HttpCodec;Ldc/squareup/okhttp3/internal/connection/RealConnection;)Ldc/squareup/okhttp3/Response;
    ...
    .line 48
    invoke-virtual {v1, v8}, Ldc/squareup/okhttp3/Response$Builder;->body(Ldc/squareup/okhttp3/ResponseBody;)Ldc/squareup/okhttp3/Response$Builder;
    ...
    :cond_0
    :try_start_1
    invoke-virtual {v2}, Ldc/squareup/okhttp3/internal/connection/StreamAllocation;->route()Ldc/squareup/okhttp3/Route;
    ...
    .line 65
    invoke-virtual {v2}, Ldc/squareup/okhttp3/internal/connection/StreamAllocation;->release()V
    ...
    .line 76
    invoke-virtual {v9}, Ldc/squareup/okhttp3/Request;->body()Ldc/squareup/okhttp3/RequestBody;
    ...
    .line 81
    invoke-virtual {v9}, Ldc/squareup/okhttp3/Request;->url()Ldc/squareup/okhttp3/HttpUrl;
    ...
    .line 86
    :cond_2
    invoke-virtual {v2}, Ldc/squareup/okhttp3/internal/connection/StreamAllocation;->codec()Ldc/squareup/okhttp3/internal/http/HttpCodec;
    ...
    .line 94
    :try_start_2
    instance-of v9, v0, Ldc/squareup/okhttp3/internal/http2/ConnectionShutdownException;

    xor-int/lit8 v9, v9, 0x1

    .line 95
    invoke-direct {p0, v0, v2, v9, v1}, Ldc/squareup/okhttp3/internal/http/RetryAndFollowUpInterceptor;->recover(Ljava/io/IOException;Ldc/squareup/okhttp3/internal/connection/StreamAllocation;ZLdc/squareup/okhttp3/Request;)Z
    ...
    .line 97
    invoke-virtual {v0}, Ldc/squareup/okhttp3/internal/connection/RouteException;->getLastConnectException()Ljava/io/IOException;

    move-result-object v9

    invoke-direct {p0, v9, v2, v7, v1}, Ldc/squareup/okhttp3/internal/http/RetryAndFollowUpInterceptor;->recover(Ljava/io/IOException;Ldc/squareup/okhttp3/internal/connection/StreamAllocation;ZLdc/squareup/okhttp3/Request;)Z
    ...
    .line 98
    :cond_7
    invoke-virtual {v0}, Ldc/squareup/okhttp3/internal/connection/RouteException;->getFirstConnectException()Ljava/io/IOException;
    ...
    .line 111
    :goto_2
    invoke-virtual {v2, v8}, Ldc/squareup/okhttp3/internal/connection/StreamAllocation;->streamFailed(Ljava/io/IOException;)V
