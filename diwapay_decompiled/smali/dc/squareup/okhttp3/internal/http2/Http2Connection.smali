...
.method static constructor <clinit>()V
    ...
    sput-object v0, Ldc/squareup/okhttp3/internal/http2/Http2Connection;->listenerExecutor:Ljava/util/concurrent/ExecutorService;
...
.method constructor <init>(Ldc/squareup/okhttp3/internal/http2/Http2Connection$Builder;)V
    ...
    invoke-static {v8, v9}, Ldc/squareup/okhttp3/internal/Util;->threadFactory(Ljava/lang/String;Z)Ljava/util/concurrent/ThreadFactory;
    ...
    invoke-static {v7, v6}, Ldc/squareup/okhttp3/internal/Util;->format(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    ...
    iput-object v14, v0, Ldc/squareup/okhttp3/internal/http2/Http2Connection;->pushExecutor:Ljava/util/concurrent/ExecutorService;
...
.method private newStream(ILjava/util/List;Z)Ldc/squareup/okhttp3/internal/http2/Http2Stream;
    ...
    .line 2
    iget-object v6, p0, Ldc/squareup/okhttp3/internal/http2/Http2Connection;->writer:Ldc/squareup/okhttp3/internal/http2/Http2Writer;
    ...
    .line 10
    iget v1, p0, Ldc/squareup/okhttp3/internal/http2/Http2Connection;->nextStreamId:I
    ...
    .line 12
    new-instance v0, Ldc/squareup/okhttp3/internal/http2/Http2Stream;
    :try_end_3
    ...
    .line 13
    iget-wide v4, v2, Ldc/squareup/okhttp3/internal/http2/Http2Connection;->bytesLeftInWriteWindow:J
    ...
    iget-wide v4, v0, Ldc/squareup/okhttp3/internal/http2/Http2Stream;->bytesLeftInWriteWindow:J
    ...
    .line 14
    :goto_2
    invoke-virtual {v0}, Ldc/squareup/okhttp3/internal/http2/Http2Stream;->isOpen()Z
    ...
    .line 15
    iget-object v4, v2, Ldc/squareup/okhttp3/internal/http2/Http2Connection;->streams:Ljava/util/Map;
    ...
    .line 19
    :try_start_5
    iget-object v4, v2, Ldc/squareup/okhttp3/internal/http2/Http2Connection;->writer:Ldc/squareup/okhttp3/internal/http2/Http2Writer;

    invoke-virtual {v4, v3, v1, p1, p2}, Ldc/squareup/okhttp3/internal/http2/Http2Writer;->synStream(ZIILjava/util/List;)V

    goto :goto_3

    .line 20
    :cond_4
    iget-boolean v3, v2, Ldc/squareup/okhttp3/internal/http2/Http2Connection;->client:Z

    if-nez v3, :cond_6

    .line 23
    iget-object v3, v2, Ldc/squareup/okhttp3/internal/http2/Http2Connection;->writer:Ldc/squareup/okhttp3/internal/http2/Http2Writer;

    invoke-virtual {v3, p1, v1, p2}, Ldc/squareup/okhttp3/internal/http2/Http2Writer;->pushPromise(IILjava/util/List;)V
    ...
    .line 28
    iget-object p1, v2, Ldc/squareup/okhttp3/internal/http2/Http2Connection;->writer:Ldc/squareup/okhttp3/internal/http2/Http2Writer;
...
.method pushDataLater(ILdc/squareup/okio/BufferedSource;IZ)V
    ...
    .line 5
    new-instance v0, Ldc/squareup/okhttp3/internal/http2/Http2Connection$6;

    iget-object p2, p0, Ldc/squareup/okhttp3/internal/http2/Http2Connection;->hostname:Ljava/lang/String;
...
.method pushHeadersLater(ILjava/util/List;Z)V
    ...
    .line 1
    :try_start_0
    new-instance v0, Ldc/squareup/okhttp3/internal/http2/Http2Connection$5;
...
.method pushRequestLater(ILjava/util/List;)V
    ...
    .line 9
    :try_start_3
    new-instance v2, Ldc/squareup/okhttp3/internal/http2/Http2Connection$4;
    ...
    invoke-direct {p0, v2}, Ldc/squareup/okhttp3/internal/http2/Http2Connection;->pushExecutorExecute(Ldc/squareup/okhttp3/internal/NamedRunnable;)V
    :try_end_4
...
.method pushResetLater(ILdc/squareup/okhttp3/internal/http2/ErrorCode;)V
    ...
    .line 1
    new-instance v0, Ldc/squareup/okhttp3/internal/http2/Http2Connection$7;
...
.method sendDegradedPingLater()V
    ...
    iget-object v3, p0, Ldc/squareup/okhttp3/internal/http2/Http2Connection;->hostname:Ljava/lang/String;
...
.method public writeData(IZLdc/squareup/okio/Buffer;J)V
    ...
    invoke-virtual {p4, p2, p1, p3, v3}, Ldc/squareup/okhttp3/internal/http2/Http2Writer;->data(ZILdc/squareup/okio/Buffer;I)V
    ...
    .line 12
    iget-object v2, p0, Ldc/squareup/okhttp3/internal/http2/Http2Connection;->streams:Ljava/util/Map;
    ...
    invoke-virtual {v4}, Ldc/squareup/okhttp3/internal/http2/Http2Writer;->maxDataLength()I
    ...
    :goto_2
    invoke-virtual {v4, v5, p1, p3, v2}, Ldc/squareup/okhttp3/internal/http2/Http2Writer;->data(ZILdc/squareup/okio/Buffer;I)V
...
.method writePing()V
    ...
    .line 7
    invoke-virtual {p0, v2, v0, v1}, Ldc/squareup/okhttp3/internal/http2/Http2Connection;->writePing(ZII)V
...
.method writeSynResetLater(ILdc/squareup/okhttp3/internal/http2/ErrorCode;)V
    ...
    new-instance v1, Ldc/squareup/okhttp3/internal/http2/Http2Connection$1;
...
.method writeWindowUpdateLater(IJ)V
    ...
    new-instance v1, Ldc/squareup/okhttp3/internal/http2/Http2Connection$2;
