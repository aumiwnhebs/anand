...
.method public close()V
    ...
    iget-object v4, p0, Ldc/squareup/okhttp3/internal/http2/Http2Stream$FramingSource;->this$0:Ldc/squareup/okhttp3/internal/http2/Http2Stream;

    invoke-static {v4}, Ldc/squareup/okhttp3/internal/http2/Http2Stream;->access$000(Ldc/squareup/okhttp3/internal/http2/Http2Stream;)Ljava/util/Deque;
    ...
    invoke-static {v4}, Ldc/squareup/okhttp3/internal/http2/Http2Stream;->access$100(Ldc/squareup/okhttp3/internal/http2/Http2Stream;)Ldc/squareup/okhttp3/internal/http2/Header$Listener;
    ...
    check-cast v2, Ldc/squareup/okhttp3/Headers;

    .line 18
    invoke-interface {v4, v2}, Ldc/squareup/okhttp3/internal/http2/Header$Listener;->onHeaders(Ldc/squareup/okhttp3/Headers;)V
...
.method public read(Ldc/squareup/okio/Buffer;J)J
    ...
    invoke-virtual {v0, v12, v10, v11}, Ldc/squareup/okio/Buffer;->read(Ldc/squareup/okio/Buffer;J)J
    ...
    iget-wide v13, v0, Ldc/squareup/okhttp3/internal/http2/Http2Stream;->unacknowledgedBytesRead:J

    add-long/2addr v13, v10

    iput-wide v13, v0, Ldc/squareup/okhttp3/internal/http2/Http2Stream;->unacknowledgedBytesRead:J
    ...
    invoke-virtual {v8, v9, v13, v14}, Ldc/squareup/okhttp3/internal/http2/Http2Connection;->writeWindowUpdateLater(IJ)V
    ...
    .line 37
    :goto_3
    iget-object v9, v1, Ldc/squareup/okhttp3/internal/http2/Http2Stream$FramingSource;->this$0:Ldc/squareup/okhttp3/internal/http2/Http2Stream;

    iget-object v9, v9, Ldc/squareup/okhttp3/internal/http2/Http2Stream;->readTimeout:Ldc/squareup/okhttp3/internal/http2/Http2Stream$StreamTimeout;

    invoke-virtual {v9}, Ldc/squareup/okhttp3/internal/http2/Http2Stream$StreamTimeout;->exitAndThrowIfTimedOut()V
    ...
    .line 44
    invoke-interface {v0, v8}, Ldc/squareup/okhttp3/internal/http2/Header$Listener;->onHeaders(Ldc/squareup/okhttp3/Headers;)V
    ...
    .line 50
    invoke-direct {v1, v10, v11}, Ldc/squareup/okhttp3/internal/http2/Http2Stream$FramingSource;->updateConnectionFlowControl(J)V
