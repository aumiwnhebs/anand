...
.method static lengthWithoutPadding(IBS)I
    ...
    invoke-static {p1, p0}, Ldc/squareup/okhttp3/internal/http2/Http2;->ioException(Ljava/lang/String;[Ljava/lang/Object;)Ljava/io/IOException;
...
.method private readGoAway(Ldc/squareup/okhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    .line 4
    invoke-static {v0}, Ldc/squareup/okhttp3/internal/http2/ErrorCode;->fromHttp2(I)Ldc/squareup/okhttp3/internal/http2/ErrorCode;
    ...
    invoke-interface {v0, v1, v2}, Ldc/squareup/okio/BufferedSource;->readByteString(J)Ldc/squareup/okio/ByteString;

    move-result-object v0

    .line 12
    :cond_0
    invoke-interface {p1, p4, p3, v0}, Ldc/squareup/okhttp3/internal/http2/Http2Reader$Handler;->goAway(ILdc/squareup/okhttp3/internal/http2/ErrorCode;Ldc/squareup/okio/ByteString;)V
...
.method private readPing(Ldc/squareup/okhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    .line 4
    :cond_0
    invoke-interface {p1, p2, p4, v0}, Ldc/squareup/okhttp3/internal/http2/Http2Reader$Handler;->ping(ZII)V
...
.method private readRstStream(Ldc/squareup/okhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    .line 6
    invoke-interface {p1, p4, p3}, Ldc/squareup/okhttp3/internal/http2/Http2Reader$Handler;->rstStream(ILdc/squareup/okhttp3/internal/http2/ErrorCode;)V
...
.method private readWindowUpdate(Ldc/squareup/okhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    .line 3
    invoke-interface {p1, p4, p2, p3}, Ldc/squareup/okhttp3/internal/http2/Http2Reader$Handler;->windowUpdate(IJ)V
...
.method public nextFrame(ZLdc/squareup/okhttp3/internal/http2/Http2Reader$Handler;)Z
    ...
    invoke-static {v0}, Ldc/squareup/okhttp3/internal/http2/Http2Reader;->readMedium(Ldc/squareup/okio/BufferedSource;)I
    ...
    invoke-static {v5, v2, v0, v1, p1}, Ldc/squareup/okhttp3/internal/http2/Http2;->frameLog(ZIIBB)Ljava/lang/String;
    ...
    .line 69
    :pswitch_0
    invoke-direct {p0, p2, v0, p1, v2}, Ldc/squareup/okhttp3/internal/http2/Http2Reader;->readWindowUpdate(Ldc/squareup/okhttp3/internal/http2/Http2Reader$Handler;IBI)V

    goto :goto_1

    .line 70
    :pswitch_1
    invoke-direct {p0, p2, v0, p1, v2}, Ldc/squareup/okhttp3/internal/http2/Http2Reader;->readGoAway(Ldc/squareup/okhttp3/internal/http2/Http2Reader$Handler;IBI)V

    goto :goto_1

    .line 71
    :pswitch_2
    invoke-direct {p0, p2, v0, p1, v2}, Ldc/squareup/okhttp3/internal/http2/Http2Reader;->readPing(Ldc/squareup/okhttp3/internal/http2/Http2Reader$Handler;IBI)V

    goto :goto_1

    .line 72
    :pswitch_3
    invoke-direct {p0, p2, v0, p1, v2}, Ldc/squareup/okhttp3/internal/http2/Http2Reader;->readPushPromise(Ldc/squareup/okhttp3/internal/http2/Http2Reader$Handler;IBI)V

    goto :goto_1

    .line 73
    :pswitch_4
    invoke-direct {p0, p2, v0, p1, v2}, Ldc/squareup/okhttp3/internal/http2/Http2Reader;->readSettings(Ldc/squareup/okhttp3/internal/http2/Http2Reader$Handler;IBI)V

    goto :goto_1

    .line 74
    :pswitch_5
    invoke-direct {p0, p2, v0, p1, v2}, Ldc/squareup/okhttp3/internal/http2/Http2Reader;->readRstStream(Ldc/squareup/okhttp3/internal/http2/Http2Reader$Handler;IBI)V

    goto :goto_1

    .line 75
    :pswitch_6
    invoke-direct {p0, p2, v0, p1, v2}, Ldc/squareup/okhttp3/internal/http2/Http2Reader;->readPriority(Ldc/squareup/okhttp3/internal/http2/Http2Reader$Handler;IBI)V

    goto :goto_1

    .line 76
    :pswitch_7
    invoke-direct {p0, p2, v0, p1, v2}, Ldc/squareup/okhttp3/internal/http2/Http2Reader;->readHeaders(Ldc/squareup/okhttp3/internal/http2/Http2Reader$Handler;IBI)V

    goto :goto_1

    .line 77
    :pswitch_8
    invoke-direct {p0, p2, v0, p1, v2}, Ldc/squareup/okhttp3/internal/http2/Http2Reader;->readData(Ldc/squareup/okhttp3/internal/http2/Http2Reader$Handler;IBI)V
...
.method public readConnectionPreface(Ldc/squareup/okhttp3/internal/http2/Http2Reader$Handler;)V
    ...
    .line 3
    invoke-virtual {p0, v0, p1}, Ldc/squareup/okhttp3/internal/http2/Http2Reader;->nextFrame(ZLdc/squareup/okhttp3/internal/http2/Http2Reader$Handler;)Z
    ...
    invoke-interface {p1, v1, v2}, Ldc/squareup/okio/BufferedSource;->readByteString(J)Ldc/squareup/okio/ByteString;

    move-result-object p1

    .line 9
    sget-object v1, Ldc/squareup/okhttp3/internal/http2/Http2Reader;->logger:Ljava/util/logging/Logger;
    ...
    invoke-static {v3, v2}, Ldc/squareup/okhttp3/internal/Util;->format(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
