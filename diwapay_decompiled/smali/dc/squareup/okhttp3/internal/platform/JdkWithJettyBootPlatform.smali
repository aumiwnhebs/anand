...
.method public static buildIfSupported()Ldc/squareup/okhttp3/internal/platform/Platform;
    ...
    .line 9
    new-instance v3, Ldc/squareup/okhttp3/internal/platform/JdkWithJettyBootPlatform;

    move-object v4, v1

    move-object v5, v2

    invoke-direct/range {v3 .. v8}, Ldc/squareup/okhttp3/internal/platform/JdkWithJettyBootPlatform;-><init>(Ljava/lang/reflect/Method;Ljava/lang/reflect/Method;Ljava/lang/reflect/Method;Ljava/lang/Class;Ljava/lang/Class;)V
    :try_end_0
...
.method public configureTlsExtensions(Ljavax/net/ssl/SSLSocket;Ljava/lang/String;Ljava/util/List;)V
    ...
    iget-object v0, p0, Ldc/squareup/okhttp3/internal/platform/JdkWithJettyBootPlatform;->clientProviderClass:Ljava/lang/Class;

    iget-object v1, p0, Ldc/squareup/okhttp3/internal/platform/JdkWithJettyBootPlatform;->serverProviderClass:Ljava/lang/Class;
    ...
    new-instance v0, Ldc/squareup/okhttp3/internal/platform/JdkWithJettyBootPlatform$JettyNegoProvider;

    invoke-direct {v0, p2}, Ldc/squareup/okhttp3/internal/platform/JdkWithJettyBootPlatform$JettyNegoProvider;-><init>(Ljava/util/List;)V
...
.method public getSelectedProtocol(Ljavax/net/ssl/SSLSocket;)Ljava/lang/String;
    ...
    check-cast p1, Ldc/squareup/okhttp3/internal/platform/JdkWithJettyBootPlatform$JettyNegoProvider;

    .line 3
    iget-boolean v0, p1, Ldc/squareup/okhttp3/internal/platform/JdkWithJettyBootPlatform$JettyNegoProvider;->unsupported:Z

    if-nez v0, :cond_0

    iget-object v2, p1, Ldc/squareup/okhttp3/internal/platform/JdkWithJettyBootPlatform$JettyNegoProvider;->selected:Ljava/lang/String;
    ...
    invoke-virtual {p1, v2, v0, v1}, Ldc/squareup/okhttp3/internal/platform/Platform;->log(ILjava/lang/String;Ljava/lang/Throwable;)V
    ...
    .line 8
    :cond_1
    iget-object p1, p1, Ldc/squareup/okhttp3/internal/platform/JdkWithJettyBootPlatform$JettyNegoProvider;->selected:Ljava/lang/String;
    :try_end_0
    .catch Ljava/lang/reflect/InvocationTargetException; {:try_start_0 .. :try_end_0} :catch_1
    .catch Ljava/lang/IllegalAccessException; {:try_start_0 .. :try_end_0} :catch_0
