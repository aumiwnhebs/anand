...
.method public connect(IIIIZLdc/squareup/okhttp3/Call;Ldc/squareup/okhttp3/EventListener;)V
    ...
    .line 5
    new-instance v7, Ldc/squareup/okhttp3/internal/connection/ConnectionSpecSelector;

    invoke-direct {v7, v0}, Ldc/squareup/okhttp3/internal/connection/ConnectionSpecSelector;-><init>(Ljava/util/List;)V
    ...
    .line 14
    :cond_0
    new-instance p1, Ldc/squareup/okhttp3/internal/connection/RouteException;
    ...
    invoke-direct {p1, p2}, Ldc/squareup/okhttp3/internal/connection/RouteException;-><init>(Ljava/io/IOException;)V
    ...
    .line 39
    invoke-direct {p0, p1, p2, v2, v1}, Ldc/squareup/okhttp3/internal/connection/RealConnection;->connectSocket(IILdc/squareup/okhttp3/Call;Ldc/squareup/okhttp3/EventListener;)V
    :try_end_2
    ...
    .line 41
    :try_start_3
    invoke-direct {p0, v7, v11, v2, v1}, Ldc/squareup/okhttp3/internal/connection/RealConnection;->establishProtocol(Ldc/squareup/okhttp3/internal/connection/ConnectionSpecSelector;ILdc/squareup/okhttp3/Call;Ldc/squareup/okhttp3/EventListener;)V
    ...
    invoke-virtual {v3}, Ldc/squareup/okhttp3/Route;->proxy()Ljava/net/Proxy;

    move-result-object v3

    iget-object v4, p0, Ldc/squareup/okhttp3/internal/connection/RealConnection;->protocol:Ldc/squareup/okhttp3/Protocol;

    invoke-virtual {v1, v2, v0, v3, v4}, Ldc/squareup/okhttp3/EventListener;->connectEnd(Ldc/squareup/okhttp3/Call;Ljava/net/InetSocketAddress;Ljava/net/Proxy;Ldc/squareup/okhttp3/Protocol;)V
    :try_end_3
    ...
    invoke-virtual {p1}, Ldc/squareup/okhttp3/Route;->requiresTunnel()Z
    ...
    :cond_6
    :goto_3
    iget-object p1, p0, Ldc/squareup/okhttp3/internal/connection/RealConnection;->http2Connection:Ldc/squareup/okhttp3/internal/http2/Http2Connection;

    if-eqz p1, :cond_7

    .line 76
    iget-object p1, p0, Ldc/squareup/okhttp3/internal/connection/RealConnection;->connectionPool:Ldc/squareup/okhttp3/ConnectionPool;

    monitor-enter p1

    .line 77
    :try_start_4
    iget-object p2, p0, Ldc/squareup/okhttp3/internal/connection/RealConnection;->http2Connection:Ldc/squareup/okhttp3/internal/http2/Http2Connection;

    invoke-virtual {p2}, Ldc/squareup/okhttp3/internal/http2/Http2Connection;->maxConcurrentStreams()I

    move-result p2

    iput p2, p0, Ldc/squareup/okhttp3/internal/connection/RealConnection;->allocationLimit:I
    ...
    .line 81
    iput-object v8, p0, Ldc/squareup/okhttp3/internal/connection/RealConnection;->socket:Ljava/net/Socket;

    .line 82
    iput-object v8, p0, Ldc/squareup/okhttp3/internal/connection/RealConnection;->rawSocket:Ljava/net/Socket;

    .line 83
    iput-object v8, p0, Ldc/squareup/okhttp3/internal/connection/RealConnection;->source:Ldc/squareup/okio/BufferedSource;

    .line 84
    iput-object v8, p0, Ldc/squareup/okhttp3/internal/connection/RealConnection;->sink:Ldc/squareup/okio/BufferedSink;

    .line 85
    iput-object v8, p0, Ldc/squareup/okhttp3/internal/connection/RealConnection;->handshake:Ldc/squareup/okhttp3/Handshake;

    .line 86
    iput-object v8, p0, Ldc/squareup/okhttp3/internal/connection/RealConnection;->protocol:Ldc/squareup/okhttp3/Protocol;

    .line 87
    iput-object v8, p0, Ldc/squareup/okhttp3/internal/connection/RealConnection;->http2Connection:Ldc/squareup/okhttp3/internal/http2/Http2Connection;
    ...
    .line 92
    new-instance v9, Ldc/squareup/okhttp3/internal/connection/RouteException;

    invoke-direct {v9, v6}, Ldc/squareup/okhttp3/internal/connection/RouteException;-><init>(Ljava/io/IOException;)V

    goto :goto_7

    .line 94
    :cond_8
    invoke-virtual {v9, v6}, Ldc/squareup/okhttp3/internal/connection/RouteException;->addConnectException(Ljava/io/IOException;)V

    :goto_7
    if-eqz p5, :cond_9

    .line 97
    invoke-virtual {v7, v6}, Ldc/squareup/okhttp3/internal/connection/ConnectionSpecSelector;->connectionFailed(Ljava/io/IOException;)Z
...
.method public newWebSocketStreams(Ldc/squareup/okhttp3/internal/connection/StreamAllocation;)Ldc/squareup/okhttp3/internal/ws/RealWebSocket$Streams;
    ...
    .line 1
    new-instance v0, Ldc/squareup/okhttp3/internal/connection/RealConnection$1;
