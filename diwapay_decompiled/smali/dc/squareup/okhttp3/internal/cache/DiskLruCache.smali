...
.method public static create(Ldc/squareup/okhttp3/internal/io/FileSystem;Ljava/io/File;IIJ)Ldc/squareup/okhttp3/internal/cache/DiskLruCache;
    ...
    invoke-static {v0, v2}, Ldc/squareup/okhttp3/internal/Util;->threadFactory(Ljava/lang/String;Z)Ljava/util/concurrent/ThreadFactory;
    ...
    invoke-direct/range {v1 .. v8}, Ldc/squareup/okhttp3/internal/cache/DiskLruCache;-><init>(Ldc/squareup/okhttp3/internal/io/FileSystem;Ljava/io/File;IIJLjava/util/concurrent/Executor;)V
...
.method private readJournal()V
    ...
    iget-object v3, p0, Ldc/squareup/okhttp3/internal/cache/DiskLruCache;->journalFile:Ljava/io/File;
    ...
    .line 3
    :try_start_0
    invoke-interface {v2}, Ldc/squareup/okio/BufferedSource;->readUtf8LineStrict()Ljava/lang/String;
    ...
    iget v8, p0, Ldc/squareup/okhttp3/internal/cache/DiskLruCache;->appVersion:I
    ...
    iget v5, p0, Ldc/squareup/okhttp3/internal/cache/DiskLruCache;->valueCount:I
    ...
    invoke-direct {p0, v1}, Ldc/squareup/okhttp3/internal/cache/DiskLruCache;->readJournalLine(Ljava/lang/String;)V
    :try_end_1
...
.method declared-synchronized edit(Ljava/lang/String;J)Ldc/squareup/okhttp3/internal/cache/DiskLruCache$Editor;
    ...
    .line 7
    iget-wide v3, v0, Ldc/squareup/okhttp3/internal/cache/DiskLruCache$Entry;->sequenceNumber:J
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public declared-synchronized initialize()V
    ...
    .line 3
    :try_start_0
    iget-boolean v1, p0, Ldc/squareup/okhttp3/internal/cache/DiskLruCache;->initialized:Z
    :try_end_0
    ...
    invoke-interface {v1, v2}, Ldc/squareup/okhttp3/internal/io/FileSystem;->exists(Ljava/io/File;)Z
    ...
    invoke-interface {v1, v2, v3}, Ldc/squareup/okhttp3/internal/io/FileSystem;->rename(Ljava/io/File;Ljava/io/File;)V
    ...
    .line 22
    iput-boolean v2, p0, Ldc/squareup/okhttp3/internal/cache/DiskLruCache;->initialized:Z
    :try_end_2
    ...
    .line 27
    invoke-virtual {v3, v4, v0, v1}, Ldc/squareup/okhttp3/internal/platform/Platform;->log(ILjava/lang/String;Ljava/lang/Throwable;)V
    :try_end_3
