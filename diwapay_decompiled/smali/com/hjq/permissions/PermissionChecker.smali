...
.method static checkManifestPermission(Ljava/util/List;Ljava/lang/String;I)V
    ...
    const-string v1, "\" android:maxSdkVersion=\""
    ...
    const-string v1, "\" /> does not meet the requirements, "
    ...
    const-string/jumbo v1, "the minimum requirement for maxSdkVersion is "
    ...
    const-string v1, "please delete the android:maxSdkVersion=\""
...
.method static checkNearbyDevicesPermission(Ljava/util/List;Lcom/hjq/permissions/AndroidManifestInfo;)V
    ...
    const-string v1, "/> node, if your app need use "

    invoke-virtual {p0, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object p0

    iget-object p1, p1, Lcom/hjq/permissions/AndroidManifestInfo$PermissionInfo;->name:Ljava/lang/String;

    invoke-virtual {p0, p1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object p0

    const-string p1, " to get physical location, also need to add android.permission.ACCESS_FINE_LOCATION permissions"
...
.method static checkPictureInPicturePermission(Landroid/app/Activity;Ljava/util/List;Lcom/hjq/permissions/AndroidManifestInfo;)V
    ...
    const-string p2, "\" android:supportsPictureInPicture=\"true\" > in AndroidManifest.xml"
