...
.method public constructor <init>(Lcom/taobao/weex/WXSDKInstance;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ILjava/util/Map;Ljava/util/Map;Ljava/util/Set;[F[F[F)V
    ...
    iget-object p6, p0, Lcom/taobao/weex/ui/action/GraphicActionAbstractAddElement;->mParentRef:Ljava/lang/String;

    invoke-virtual {p4, p5, p6}, Lcom/taobao/weex/ui/WXRenderManager;->getWXComponent(Ljava/lang/String;Ljava/lang/String;)Lcom/taobao/weex/ui/component/WXComponent;

    move-result-object p4

    check-cast p4, Lcom/taobao/weex/ui/component/WXVContainer;

    iput-object p4, p0, Lcom/taobao/weex/ui/action/GraphicActionAddElement;->parent:Lcom/taobao/weex/ui/component/WXVContainer;
    ...
    .line 22
    new-instance p6, Lcom/taobao/weex/ui/action/BasicComponentData;

    iget-object p7, p0, Lcom/taobao/weex/ui/action/GraphicActionAbstractAddElement;->mComponentType:Ljava/lang/String;

    iget-object p8, p0, Lcom/taobao/weex/ui/action/GraphicActionAbstractAddElement;->mParentRef:Ljava/lang/String;

    invoke-direct {p6, p2, p7, p8}, Lcom/taobao/weex/ui/action/BasicComponentData;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    .line 24
    iget-object p2, p0, Lcom/taobao/weex/ui/action/GraphicActionAddElement;->parent:Lcom/taobao/weex/ui/component/WXVContainer;

    invoke-virtual {p0, p1, p2, p6}, Lcom/taobao/weex/ui/action/GraphicActionAbstractAddElement;->createComponent(Lcom/taobao/weex/WXSDKInstance;Lcom/taobao/weex/ui/component/WXVContainer;Lcom/taobao/weex/ui/action/BasicComponentData;)Lcom/taobao/weex/ui/component/WXComponent;
    ...
    iget-object p7, p0, Lcom/taobao/weex/ui/action/GraphicActionAddElement;->child:Lcom/taobao/weex/ui/component/WXComponent;

    invoke-static {p6, p7}, Lcom/taobao/weex/dom/transition/WXTransition;->fromMap(Ljava/util/Map;Lcom/taobao/weex/ui/component/WXComponent;)Lcom/taobao/weex/dom/transition/WXTransition;

    move-result-object p6

    invoke-virtual {p2, p6}, Lcom/taobao/weex/ui/component/WXComponent;->setTransition(Lcom/taobao/weex/dom/transition/WXTransition;)V
    ...
    iget-wide p4, p2, Lcom/taobao/weex/performance/WXInstanceApm;->componentCreateTime:J

    add-long/2addr p4, p6

    iput-wide p4, p2, Lcom/taobao/weex/performance/WXInstanceApm;->componentCreateTime:J
    ...
    iget-boolean p5, p2, Lcom/taobao/weex/ui/component/WXComponent;->isIgnoreInteraction:Z
    ...
    const-string p5, "ignoreInteraction"

    invoke-virtual {p2, p5}, Lio/dcloud/feature/uniapp/dom/AbsAttr;->get(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    const-string p5, "addElement"

    invoke-virtual {p2, p4, p5}, Lcom/taobao/weex/performance/WXStateRecord;->recordAction(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_0
    ...
    .line 52
    iget-object p5, p0, Lcom/taobao/weex/ui/action/GraphicActionAbstractAddElement;->mStyle:Ljava/util/Map;
    ...
    .line 55
    invoke-virtual {p4}, Lcom/taobao/weex/ui/component/basic/WXBasicComponent;->getStyles()Lcom/taobao/weex/dom/WXStyle;
    ...
    invoke-virtual {p5}, Lio/dcloud/feature/uniapp/dom/AbsStyle;->isEmpty()Z
    ...
    invoke-virtual {p5}, Lio/dcloud/feature/uniapp/dom/AbsStyle;->toString()Ljava/lang/String;

    move-result-object p5

    const-string p6, "parent.style"

    invoke-interface {p2, p6, p5}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    .line 59
    :cond_9
    iget-object p5, p0, Lcom/taobao/weex/ui/action/GraphicActionAbstractAddElement;->mAttributes:Ljava/util/Map;
    ...
    .line 62
    invoke-virtual {p4}, Lcom/taobao/weex/ui/component/basic/WXBasicComponent;->getAttrs()Lcom/taobao/weex/dom/WXAttr;
    ...
    invoke-virtual {p5}, Lio/dcloud/feature/uniapp/dom/AbsAttr;->isEmpty()Z
    ...
    invoke-virtual {p5}, Lio/dcloud/feature/uniapp/dom/AbsAttr;->toString()Ljava/lang/String;

    move-result-object p5

    const-string p6, "parent.attr"

    invoke-interface {p2, p6, p5}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    .line 66
    :cond_b
    iget-object p5, p0, Lcom/taobao/weex/ui/action/GraphicActionAbstractAddElement;->mEvents:Ljava/util/Set;
    ...
    .line 69
    invoke-virtual {p4}, Lcom/taobao/weex/ui/component/basic/WXBasicComponent;->getEvents()Lcom/taobao/weex/dom/WXEvent;
    ...
    const-string p6, "parent.event"

    invoke-interface {p2, p6, p5}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    .line 73
    :cond_d
    iget-object p5, p0, Lcom/taobao/weex/ui/action/GraphicActionAbstractAddElement;->mMargins:[F
    ...
    .line 76
    invoke-virtual {p4}, Lcom/taobao/weex/ui/component/basic/WXBasicComponent;->getMargin()Lcom/taobao/weex/dom/CSSShorthand;
    ...
    invoke-virtual {p5}, Lio/dcloud/feature/uniapp/dom/AbsCSSShorthand;->toString()Ljava/lang/String;

    move-result-object p5

    const-string p6, "parent.margin"

    invoke-interface {p2, p6, p5}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    .line 80
    :cond_f
    iget-object p5, p0, Lcom/taobao/weex/ui/action/GraphicActionAbstractAddElement;->mPaddings:[F
    ...
    .line 83
    invoke-virtual {p4}, Lcom/taobao/weex/ui/component/basic/WXBasicComponent;->getPadding()Lcom/taobao/weex/dom/CSSShorthand;
    ...
    const-string p6, "parent.padding"

    invoke-interface {p2, p6, p5}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    .line 87
    :cond_11
    iget-object p5, p0, Lcom/taobao/weex/ui/action/GraphicActionAbstractAddElement;->mBorders:[F
    ...
    .line 90
    invoke-virtual {p4}, Lcom/taobao/weex/ui/component/basic/WXBasicComponent;->getBorder()Lcom/taobao/weex/dom/CSSShorthand;
    ...
    invoke-virtual {p4}, Lio/dcloud/feature/uniapp/dom/AbsCSSShorthand;->toString()Ljava/lang/String;

    move-result-object p4

    const-string p5, "parent.border"
    ...
    sget-object p4, Lcom/taobao/weex/common/WXErrorCode;->WX_RENDER_ERR_CONTAINER_TYPE:Lcom/taobao/weex/common/WXErrorCode;
    ...
    invoke-virtual {p6}, Lio/dcloud/feature/uniapp/ui/component/AbsBasicComponent;->getComponentType()Ljava/lang/String;
    ...
    .line 100
    const-string p6, "You are trying to add a %s to a %2$s, which is illegal as %2$s is not a container"

    invoke-static {p5, p6, p3}, Ljava/lang/String;->format(Ljava/util/Locale;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;

    move-result-object p3

    .line 101
    const-string p5, "GraphicActionAddElement"

    invoke-static {p1, p4, p5, p3, p2}, Lcom/taobao/weex/utils/WXExceptionUtils;->commitCriticalExceptionRT(Ljava/lang/String;Lcom/taobao/weex/common/WXErrorCode;Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;)V
