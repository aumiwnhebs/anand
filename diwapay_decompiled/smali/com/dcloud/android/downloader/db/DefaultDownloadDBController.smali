...
.method static constructor <clinit>()V
    ...
    const-string/jumbo v3, "supportRanges"
    ...
    const-string v1, "downloadInfoId"
    ...
    const-string v1, "REPLACE INTO %s (_id,threadId,downloadInfoId,uri,start,end,progress) VALUES(?,?,?,?,?,?,?);"

    invoke-static {v1, v0}, Lio/dcloud/common/util/StringUtil;->format(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;

    move-result-object v0

    sput-object v0, Lcom/dcloud/android/downloader/db/DefaultDownloadDBController;->SQL_UPDATE_DOWNLOAD_THREAD_INFO:Ljava/lang/String;
    ...
    const-string v2, "REPLACE INTO %s (_id,supportRanges,createAt,uri,location,path,size,progress,status) VALUES(?,?,?,?,?,?,?,?,?);"
