...
.method private transformArgs(Ljava/lang/String;Ljava/util/List;)V
    ...
    invoke-static {v0, v1}, Lcom/alibaba/android/bindingx/core/internal/Utils;->getExpressionPair(Ljava/util/Map;Ljava/lang/String;)Lcom/alibaba/android/bindingx/core/internal/ExpressionPair;
    ...
    .line 142
    const-string v1, "parse config failed"
    ...
    .line 150
    :cond_2
    new-instance v2, Lcom/alibaba/android/bindingx/core/internal/ExpressionHolder;
    ...
    const-string v0, "skip illegal binding args["
...
.method protected consumeExpression(Ljava/util/Map;Ljava/util/Map;Ljava/lang/String;)V
    ...
    const-string v5, "consume expression with %d tasks. event type is %s"
    ...
    check-cast v6, Lcom/alibaba/android/bindingx/core/internal/ExpressionHolder;

    .line 258
    iget-object v7, v6, Lcom/alibaba/android/bindingx/core/internal/ExpressionHolder;->eventType:Ljava/lang/String;
    ...
    const-string v9, "skip expression with wrong event type.[expected:"
    ...
    iget-object v6, v6, Lcom/alibaba/android/bindingx/core/internal/ExpressionHolder;->eventType:Ljava/lang/String;
    ...
    .line 263
    iget-object v7, v0, Lcom/alibaba/android/bindingx/core/internal/AbstractEventHandler;->mExtensionParams:[Ljava/lang/Object;
    ...
    .line 267
    :cond_5
    iget-object v7, v6, Lcom/alibaba/android/bindingx/core/internal/ExpressionHolder;->targetInstanceId:Ljava/lang/String;
    ...
    iget-object v7, v0, Lcom/alibaba/android/bindingx/core/internal/AbstractEventHandler;->mInstanceId:Ljava/lang/String;
    ...
    .line 272
    :cond_7
    iget-object v9, v6, Lcom/alibaba/android/bindingx/core/internal/ExpressionHolder;->expressionPair:Lcom/alibaba/android/bindingx/core/internal/ExpressionPair;

    .line 273
    invoke-static {v9}, Lcom/alibaba/android/bindingx/core/internal/ExpressionPair;->isValid(Lcom/alibaba/android/bindingx/core/internal/ExpressionPair;)Z
    ...
    .line 276
    :cond_8
    iget-object v10, v0, Lcom/alibaba/android/bindingx/core/internal/AbstractEventHandler;->mCachedExpressionMap:Lcom/alibaba/android/bindingx/core/internal/AbstractEventHandler$Cache;

    iget-object v11, v9, Lcom/alibaba/android/bindingx/core/internal/ExpressionPair;->transformed:Ljava/lang/String;

    invoke-virtual {v10, v11}, Lcom/alibaba/android/bindingx/core/internal/AbstractEventHandler$Cache;->get(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v10

    check-cast v10, Lcom/alibaba/android/bindingx/core/internal/Expression;

    if-nez v10, :cond_9

    .line 278
    new-instance v10, Lcom/alibaba/android/bindingx/core/internal/Expression;

    iget-object v11, v9, Lcom/alibaba/android/bindingx/core/internal/ExpressionPair;->transformed:Ljava/lang/String;

    invoke-direct {v10, v11}, Lcom/alibaba/android/bindingx/core/internal/Expression;-><init>(Ljava/lang/String;)V

    .line 279
    iget-object v11, v0, Lcom/alibaba/android/bindingx/core/internal/AbstractEventHandler;->mCachedExpressionMap:Lcom/alibaba/android/bindingx/core/internal/AbstractEventHandler$Cache;

    iget-object v9, v9, Lcom/alibaba/android/bindingx/core/internal/ExpressionPair;->transformed:Ljava/lang/String;

    invoke-virtual {v11, v9, v10}, Lcom/alibaba/android/bindingx/core/internal/AbstractEventHandler$Cache;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    .line 282
    :cond_9
    invoke-virtual {v10, v1}, Lcom/alibaba/android/bindingx/core/internal/Expression;->execute(Ljava/util/Map;)Ljava/lang/Object;
    ...
    .line 284
    const-string v6, "failed to execute expression,expression result is null"

    invoke-static {v6}, Lcom/alibaba/android/bindingx/core/LogProxy;->e(Ljava/lang/String;)V
    ...
    :cond_b
    instance-of v9, v14, Ljava/lang/Float;
    ...
    .line 289
    :cond_c
    const-string v6, "failed to execute expression,expression result is NaN"
    ...
    .line 293
    :cond_d
    iget-object v9, v0, Lcom/alibaba/android/bindingx/core/internal/AbstractEventHandler;->mPlatformManager:Lcom/alibaba/android/bindingx/core/PlatformManager;

    invoke-virtual {v9}, Lcom/alibaba/android/bindingx/core/PlatformManager;->getViewFinder()Lcom/alibaba/android/bindingx/core/PlatformManager$IViewFinder;

    move-result-object v9

    iget-object v10, v6, Lcom/alibaba/android/bindingx/core/internal/ExpressionHolder;->targetRef:Ljava/lang/String;

    invoke-interface {v3}, Ljava/util/List;->toArray()[Ljava/lang/Object;

    move-result-object v11

    invoke-interface {v9, v10, v11}, Lcom/alibaba/android/bindingx/core/PlatformManager$IViewFinder;->findViewBy(Ljava/lang/String;[Ljava/lang/Object;)Landroid/view/View;
    ...
    iget-object v13, v6, Lcom/alibaba/android/bindingx/core/internal/ExpressionHolder;->prop:Ljava/lang/String;

    iget-object v9, v0, Lcom/alibaba/android/bindingx/core/internal/AbstractEventHandler;->mPlatformManager:Lcom/alibaba/android/bindingx/core/PlatformManager;

    .line 298
    invoke-virtual {v9}, Lcom/alibaba/android/bindingx/core/PlatformManager;->getResolutionTranslator()Lcom/alibaba/android/bindingx/core/PlatformManager$IDeviceResolutionTranslator;

    move-result-object v15

    iget-object v9, v6, Lcom/alibaba/android/bindingx/core/internal/ExpressionHolder;->config:Ljava/util/Map;
    ...
    .line 294
    invoke-virtual/range {v11 .. v17}, Lcom/alibaba/android/bindingx/core/BindingXPropertyInterceptor;->performIntercept(Landroid/view/View;Ljava/lang/String;Ljava/lang/Object;Lcom/alibaba/android/bindingx/core/PlatformManager$IDeviceResolutionTranslator;Ljava/util/Map;[Ljava/lang/Object;)V
    ...
    const-string v9, "failed to execute expression,target view not found.[ref:"

    invoke-direct {v7, v9}, Ljava/lang/StringBuilder;-><init>(Ljava/lang/String;)V

    iget-object v6, v6, Lcom/alibaba/android/bindingx/core/internal/ExpressionHolder;->targetRef:Ljava/lang/String;
    ...
    .line 311
    :cond_e
    iget-object v8, v0, Lcom/alibaba/android/bindingx/core/internal/AbstractEventHandler;->mPlatformManager:Lcom/alibaba/android/bindingx/core/PlatformManager;

    invoke-virtual {v8}, Lcom/alibaba/android/bindingx/core/PlatformManager;->getViewUpdater()Lcom/alibaba/android/bindingx/core/PlatformManager$IViewUpdater;
    ...
    .line 315
    invoke-virtual {v8}, Lcom/alibaba/android/bindingx/core/PlatformManager;->getResolutionTranslator()Lcom/alibaba/android/bindingx/core/PlatformManager$IDeviceResolutionTranslator;

    move-result-object v15

    iget-object v8, v6, Lcom/alibaba/android/bindingx/core/internal/ExpressionHolder;->config:Ljava/util/Map;
    ...
    .line 311
    invoke-interface/range {v11 .. v17}, Lcom/alibaba/android/bindingx/core/PlatformManager$IViewUpdater;->synchronouslyUpdateViewOnUIThread(Landroid/view/View;Ljava/lang/String;Ljava/lang/Object;Lcom/alibaba/android/bindingx/core/PlatformManager$IDeviceResolutionTranslator;Ljava/util/Map;[Ljava/lang/Object;)V
...
.method public performInterceptIfNeeded(Ljava/lang/String;Lcom/alibaba/android/bindingx/core/internal/ExpressionPair;Ljava/util/Map;)V
    ...
    const-string v1, "evaluate interceptor ["
    ...
    const-string v1, "] expression failed. "
