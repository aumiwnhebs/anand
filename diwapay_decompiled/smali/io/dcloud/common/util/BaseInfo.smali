...
.field public static final sBaseVersion:Ljava/lang/String; = "1.9.9.82597"
...
.method static constructor <clinit>()V
    ...
    .line 57
    sput-boolean v4, Lio/dcloud/common/util/BaseInfo;->sSupportAddByHand:Z
    ...
    sput-object v5, Lio/dcloud/common/util/BaseInfo;->PDR:Ljava/lang/String;

    .line 68
    const-string/jumbo v5, "update.xml"

    sput-object v5, Lio/dcloud/common/util/BaseInfo;->WGTU_UPDATE_XML:Ljava/lang/String;

    .line 69
    const-string/jumbo v5, "webcache/"

    sput-object v5, Lio/dcloud/common/util/BaseInfo;->APP_WEB_CHACHE:Ljava/lang/String;

    .line 70
    const-string v5, "jsdata/"

    sput-object v5, Lio/dcloud/common/util/BaseInfo;->APP_JSDATA:Ljava/lang/String;

    .line 71
    const-string v5, "dbdata/"

    sput-object v5, Lio/dcloud/common/util/BaseInfo;->APP_DB_DATA:Ljava/lang/String;

    .line 75
    const-string v5, "apps/"

    sput-object v5, Lio/dcloud/common/util/BaseInfo;->APPS_NAME:Ljava/lang/String;

    .line 80
    const-string v5, "sitemap/"

    sput-object v5, Lio/dcloud/common/util/BaseInfo;->SITMAP:Ljava/lang/String;
    ...
    sput-object v5, Lio/dcloud/common/util/BaseInfo;->uniVersionV3:Ljava/lang/String;
    ...
    .line 118
    sput v6, Lio/dcloud/common/util/BaseInfo;->s_Runing_App_Count_Max:I
    ...
    .line 154
    sput-object v5, Lio/dcloud/common/util/BaseInfo;->sDocumentFullPath:Ljava/lang/String;

    .line 159
    sput-boolean v0, Lio/dcloud/common/util/BaseInfo;->sCoverApkRuning:Z

    .line 164
    const-string v6, "/data/dcloud_properties.xml"

    sput-object v6, Lio/dcloud/common/util/BaseInfo;->s_properties:Ljava/lang/String;

    .line 166
    const-string v6, "manifest.json"

    sput-object v6, Lio/dcloud/common/util/BaseInfo;->sConfigXML:Ljava/lang/String;

    .line 171
    const-string/jumbo v6, "www/"

    sput-object v6, Lio/dcloud/common/util/BaseInfo;->APP_WWW_FS_DIR:Ljava/lang/String;

    .line 188
    sput-object v1, Lio/dcloud/common/util/BaseInfo;->sBaseNotificationPath:Ljava/lang/String;

    .line 197
    sput-object v6, Lio/dcloud/common/util/BaseInfo;->REAL_PRIVATE_WWW_DIR:Ljava/lang/String;
    ...
    .line 214
    sput-boolean v4, Lio/dcloud/common/util/BaseInfo;->isDefaultAim:Z
    ...
    .line 232
    sput-object v5, Lio/dcloud/common/util/BaseInfo;->lia:Ljava/lang/String;

    .line 241
    sput-object v5, Lio/dcloud/common/util/BaseInfo;->renderer:Ljava/lang/String;

    .line 246
    sput-object v5, Lio/dcloud/common/util/BaseInfo;->minUserAgentVersion:Ljava/lang/String;
...
.method private static checkOrResetTemplate(Lio/dcloud/common/DHInterface/IApp;)V
    ...
    const-string/jumbo v5, "wap2app__template/__template.json"
    ...
    .line 10
    :try_start_1
    new-instance v6, Lio/dcloud/common/adapter/io/UnicodeInputStream;
    ...
    invoke-direct {v6, v7, v3}, Lio/dcloud/common/adapter/io/UnicodeInputStream;-><init>(Ljava/io/InputStream;Ljava/lang/String;)V

    .line 11
    invoke-static {v6}, Lio/dcloud/common/util/IOUtil;->getBytes(Ljava/io/InputStream;)[B
    ...
    const-string/jumbo v8, "wap2app__template/"
    ...
    invoke-interface {v2, v6, v1}, Lio/dcloud/common/DHInterface/IConfusionMgr;->handleEncryption(Landroid/content/Context;[B)Ljava/lang/String;
...
.method public static getLauncherData(Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_1
    iget-object p0, p0, Lio/dcloud/common/util/BaseInfo$CmtInfo;->plusLauncher:Ljava/lang/String;
...
.method public static parseControl()V
    ...
    .line 8
    const-string/jumbo v1, "syncDebug"
...
.method public static parseControl(Landroid/content/Context;Lio/dcloud/common/DHInterface/ICore;Lio/dcloud/common/DHInterface/ICore$ICoreStatusListener;)[Ljava/lang/String;
    ...
    .line 28
    const-string/jumbo v8, "syncDebug"
    ...
    .line 78
    :try_start_c
    sput v7, Lio/dcloud/common/util/BaseInfo;->s_Runing_App_Count_Trim:I
    :try_end_c
    ...
    sput-boolean v10, Lio/dcloud/common/util/BaseInfo;->sCoverApkRuning:Z
    ...
    .line 100
    sget-object v10, Lio/dcloud/common/util/BaseInfo;->mInstalledAppInfoSet:Ljava/util/HashMap;
    :try_end_f
    ...
    invoke-static {v14, v4}, Lio/dcloud/common/util/XmlUtil;->getAttributeValue(Lio/dcloud/common/util/XmlUtil$DHNode;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {v14, v15, v4}, Lio/dcloud/common/util/BaseInfo$BaseAppInfo;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 110
    sget-boolean v17, Lio/dcloud/common/util/BaseInfo;->sCoverApkRuning:Z

    if-nez v17, :cond_c

    .line 111
    invoke-virtual {v14, v4}, Lio/dcloud/common/util/BaseInfo$BaseAppInfo;->high(Lio/dcloud/common/util/BaseInfo$BaseAppInfo;)Z
    ...
    .line 118
    :cond_b
    iput-boolean v7, v14, Lio/dcloud/common/util/BaseInfo$BaseAppInfo;->mMoreRecent:Z
    ...
    const-string v6, " App has new version! it is "

    invoke-virtual {v4, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v4

    iget-object v6, v14, Lio/dcloud/common/util/BaseInfo$BaseAppInfo;->mAppVer:Ljava/lang/String;
    ...
    .line 138
    :goto_c
    sput-boolean v16, Lio/dcloud/common/util/BaseInfo;->sParsedControl:Z
    ...
    .line 140
    invoke-static/range {v16 .. v16}, Lio/dcloud/common/adapter/util/Logger;->setOpen(Z)V
    ...
    const-string v3, ";ver:1.9.9.82597;max:"
    ...
    .line 149
    const-string/jumbo v0, "will exc coreListener.onCoreReady"
...
.method public static setUniVersionV3(Ljava/lang/String;Landroid/content/Context;)V
    .locals 2

    .line 1
    sput-object p0, Lio/dcloud/common/util/BaseInfo;->uniVersionV3:Ljava/lang/String;
    ...
    invoke-static {p1, v0, v1, p0}, Lio/dcloud/common/adapter/util/SP;->setBundleData(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
