...
.method static constructor <clinit>()V
    ...
    sput-char v1, Lio/dcloud/common/adapter/util/DeviceInfo;->sSeparatorChar:C
    ...
    sput-object v1, Lio/dcloud/common/adapter/util/DeviceInfo;->sBaseResRootPathName:Ljava/lang/String;
    ...
    sput-object v1, Lio/dcloud/common/adapter/util/DeviceInfo;->rootRelatedDirs:[Ljava/lang/String;
...
.method public static getDevicestatus_js(Lio/dcloud/common/DHInterface/IApp;)Ljava/lang/String;
    ...
    .line 14
    sget-object p0, Lio/dcloud/common/adapter/util/DeviceInfo;->DEVICESTATUS_JS:Ljava/lang/String;

    sget-object v3, Lio/dcloud/common/adapter/util/DeviceInfo;->sIMSI:Ljava/lang/String;

    sget-object v4, Lio/dcloud/common/adapter/util/DeviceInfo;->sModel:Ljava/lang/String;

    sget-object v5, Lio/dcloud/common/adapter/util/DeviceInfo;->sVendor:Ljava/lang/String;

    sget-object v6, Lio/dcloud/common/adapter/util/DeviceInfo;->sLanguage:Ljava/lang/String;

    sget-object v7, Lio/dcloud/common/adapter/util/DeviceInfo;->sVersion_release:Ljava/lang/String;
...
.method public static getNetWorkType(Landroid/content/Context;)Ljava/lang/String;
    ...
    .line 12
    sget-object p0, Lio/dcloud/common/adapter/util/DeviceInfo;->CONNECTION_UNKNOW:Ljava/lang/String;
    ...
    .line 14
    sget-object p0, Lio/dcloud/common/adapter/util/DeviceInfo;->NETTYPE_WIFI:Ljava/lang/String;
    ...
    .line 54
    :pswitch_1
    sget-object p0, Lio/dcloud/common/adapter/util/DeviceInfo;->CONNECTION_CELL5G:Ljava/lang/String;

    return-object p0

    .line 55
    :pswitch_2
    sget-object p0, Lio/dcloud/common/adapter/util/DeviceInfo;->CONNECTION_CELL3G:Ljava/lang/String;

    return-object p0

    .line 62
    :pswitch_3
    sget-object p0, Lio/dcloud/common/adapter/util/DeviceInfo;->CONNECTION_CELL4G:Ljava/lang/String;
    ...
    .line 69
    :pswitch_6
    sget-object p0, Lio/dcloud/common/adapter/util/DeviceInfo;->CONNECTION_CELL2G:Ljava/lang/String;
...
.method public static getStatusHeight(Landroid/content/Context;)I
    ...
    const-string v2, "getStatusHeight --"
    ...
    invoke-static {v1, p0}, Lio/dcloud/common/adapter/util/Logger;->e(Ljava/lang/String;Ljava/lang/String;)V
...
.method public static initPath(Landroid/content/Context;Z)V
    ...
    .line 9
    sget-boolean v2, Lio/dcloud/common/util/BaseInfo;->ISDEBUG:Z
    ...
    sget-object v1, Lio/dcloud/common/adapter/util/DeviceInfo;->sPackageName:Ljava/lang/String;
    ...
    .line 38
    :cond_8
    sput-boolean v4, Lio/dcloud/common/adapter/util/DeviceInfo;->isPrivateDirectory:Z
    ...
    sget-char v0, Lio/dcloud/common/adapter/util/DeviceInfo;->sSeparatorChar:C
    ...
    .line 43
    :cond_9
    sput-boolean v3, Lio/dcloud/common/util/BaseInfo;->ISDEBUG:Z
...
.method public static isAppNightMode(Landroid/content/Context;)Ljava/lang/Boolean;
    ...
    .line 8
    :cond_1
    invoke-static {p0}, Lio/dcloud/common/adapter/util/DeviceInfo;->isSystemNightMode(Landroid/content/Context;)Ljava/lang/Boolean;
...
.method public static isSystemNightMode(Landroid/content/Context;)Ljava/lang/Boolean;
    .locals 1
...
.method static synthetic lambda$showSoftInput$0(Landroid/view/View;)V
    .locals 2
...
.method static synthetic lambda$showSoftInput$1(Landroid/view/View;Z)V
    .locals 1
    ...
    .line 4
    :cond_0
    sget-boolean p0, Lio/dcloud/common/adapter/util/DeviceInfo;->isIMEShow:Z
...
.method public static showIME(Landroid/view/View;Z)V
    ...
    .line 3
    invoke-static {p0, p1}, Lio/dcloud/common/adapter/util/DeviceInfo;->showSoftInput(Landroid/view/View;Z)V

    :cond_0
    return-void
.end method

.method private static showSoftInput(Landroid/view/View;Z)V
    .locals 2
    ...
    .line 2
    new-instance p1, Lio/dcloud/common/adapter/util/DeviceInfo$$ExternalSyntheticLambda0;

    invoke-direct {p1, p0}, Lio/dcloud/common/adapter/util/DeviceInfo$$ExternalSyntheticLambda0;-><init>(Landroid/view/View;)V

    const-wide/16 v0, 0x64

    invoke-static {p1, v0, v1}, Lio/dcloud/common/adapter/util/MessageHandler;->postDelayed(Ljava/lang/Runnable;J)V

    return-void

    .line 10
    :cond_0
    new-instance v0, Lio/dcloud/common/adapter/util/DeviceInfo$$ExternalSyntheticLambda1;

    invoke-direct {v0, p0, p1}, Lio/dcloud/common/adapter/util/DeviceInfo$$ExternalSyntheticLambda1;-><init>(Landroid/view/View;Z)V

    const-wide/16 p0, 0xfa

    invoke-static {v0, p0, p1}, Lio/dcloud/common/adapter/util/MessageHandler;->postDelayed(Ljava/lang/Runnable;J)V
