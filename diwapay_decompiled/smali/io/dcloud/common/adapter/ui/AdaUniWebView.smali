...
.method public constructor <init>(Landroid/content/Context;Lio/dcloud/common/DHInterface/IApp;Lio/dcloud/common/adapter/ui/AdaFrameView;Ljava/lang/String;Ljava/lang/String;Lorg/json/JSONObject;Z)V
    ...
    invoke-virtual {p1}, Lio/dcloud/common/adapter/ui/AdaContainerFrameItem;->obtainMainViewGroup()Landroid/view/ViewGroup;

    move-result-object p1

    filled-new-array {p0, p1, v2, p5}, [Ljava/lang/Object;

    move-result-object p1

    .line 86
    iget-object p3, p0, Lio/dcloud/common/adapter/ui/AdaUniWebView;->mWinMgr:Lio/dcloud/common/DHInterface/AbsMgr;

    sget-object p4, Lio/dcloud/common/DHInterface/IMgr$MgrType;->FeatureMgr:Lio/dcloud/common/DHInterface/IMgr$MgrType;

    const-string/jumbo p5, "weex,io.dcloud.feature.weex.WeexFeature"

    const-string p6, "createUniNView"

    filled-new-array {p2, p5, p6, p1}, [Ljava/lang/Object;

    move-result-object p1

    const/16 p2, 0xa

    invoke-interface {p3, p4, p2, p1}, Lio/dcloud/common/DHInterface/IMgr;->processEvent(Lio/dcloud/common/DHInterface/IMgr$MgrType;ILjava/lang/Object;)Ljava/lang/Object;
...
.method public exec(Ljava/lang/String;Ljava/lang/String;Lorg/json/JSONArray;)Ljava/lang/String;
    ...
    :cond_0
    :try_start_0
    const-string/jumbo v0, "syncExecMethod"
    ...
    .line 5
    const-string/jumbo p2, "syncUniExecMethod"
...
.method public getConfigInfo()Ljava/lang/Object;
    ...
    const-string/jumbo v2, "startupTime"
    ...
    const-string/jumbo v2, "uniVersion"
...
.method initUserAgent(Lio/dcloud/common/DHInterface/IApp;)V
    ...
    invoke-virtual {p1, v2, v1}, Lio/dcloud/common/util/AppStatusBarManager;->checkImmersedStatusBar(Landroid/content/Context;Z)Z
    ...
    iget v2, p0, Lio/dcloud/common/adapter/ui/AdaUniWebView;->mScale:F
    ...
    .line 25
    iget-object v0, p0, Lio/dcloud/common/adapter/ui/AdaUniWebView;->mUserAgent:Ljava/lang/String;
...
.method public prompt(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 7
    invoke-virtual {v3, v2}, Lorg/json/JSONArray;->getBoolean(I)Z
    ...
    .line 10
    iget-object v2, p0, Lio/dcloud/common/adapter/ui/AdaUniWebView;->iMessages:Lio/dcloud/common/adapter/util/MessageHandler$IMessages;
    ...
    .line 12
    :cond_0
    invoke-virtual {p0, p2, v1, p1}, Lio/dcloud/common/adapter/ui/AdaUniWebView;->exec(Ljava/lang/String;Ljava/lang/String;Lorg/json/JSONArray;)Ljava/lang/String;
