...
.method private checkRedCssline(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p1, v1, v0}, Ljava/lang/StringBuffer;->substring(II)Ljava/lang/String;
...
.method public clearHistory()V
    ...
    invoke-interface {v0, v3, v1, v2}, Lio/dcloud/common/adapter/ui/webview/DCWebView;->loadData(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method public execScript(Ljava/lang/String;Ljava/lang/String;Lorg/json/JSONArray;Z)Ljava/lang/String;
    ...
    invoke-static {p4, p1}, Lio/dcloud/common/adapter/util/MessageHandler;->sendMessage(Lio/dcloud/common/adapter/util/MessageHandler$IMessages;Ljava/lang/Object;)V
...
.method public getPreLoadJsString()Ljava/lang/String;
    ...
    .line 7
    :goto_0
    iget-object v2, p0, Lio/dcloud/common/adapter/ui/AdaWebview;->mPreloadJsFile:Ljava/util/ArrayList;
    ...
    .line 9
    iget-object v7, p0, Lio/dcloud/common/adapter/ui/AdaWebview;->mPlusrequire:Ljava/lang/String;
    ...
    const-string v7, "__wap2appconfig.js"
    ...
    .line 12
    :cond_2
    invoke-virtual {p0, v6, v0}, Lio/dcloud/common/adapter/ui/AdaWebview;->wrapAppendJsFile(Ljava/lang/String;I)Ljava/lang/String;
...
.method public getScreenAndDisplayJson(Lio/dcloud/common/DHInterface/IWebview;)Ljava/lang/String;
    ...
    sget v2, Lio/dcloud/common/adapter/util/DeviceInfo;->dpiX:F

    invoke-static {v2}, Ljava/lang/Float;->valueOf(F)Ljava/lang/Float;

    move-result-object v8

    sget v2, Lio/dcloud/common/adapter/util/DeviceInfo;->dpiY:F
    ...
    .line 9
    const-string v0, "(function(p){p.screen.scale=%f;p.screen.resolutionHeight=%d;p.screen.resolutionWidth=%d;p.screen.height=%d;p.screen.width=%d;p.screen.dpiX=%f;p.screen.dpiY=%f;p.display.resolutionHeight=%d;p.display.resolutionWidth=%d;})(((window.__html5plus__&&__html5plus__.isReady)?__html5plus__:(navigator.plus&&navigator.plus.isReady)?navigator.plus:window.plus));"
...
.method loadFileContent(Lio/dcloud/common/adapter/ui/AdaWebview$IFExecutePreloadJSContentCallBack;)V
    ...
    .line 7
    invoke-virtual {p0, v4, v0}, Lio/dcloud/common/adapter/ui/AdaWebview;->wrapAppendJsFile(Ljava/lang/String;I)Ljava/lang/String;
    ...
    .line 11
    invoke-virtual {p0, v5}, Lio/dcloud/common/adapter/ui/AdaWebview;->loadUrl(Ljava/lang/String;)V

    goto :goto_1

    .line 13
    :cond_2
    iget-object v6, p0, Lio/dcloud/common/adapter/ui/AdaWebview;->mWebViewImpl:Lio/dcloud/common/adapter/ui/webview/DCWebView;

    invoke-interface {v6, v4}, Lio/dcloud/common/adapter/ui/webview/DCWebView;->convertRelPath(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v4

    invoke-interface {p1, v4, v5}, Lio/dcloud/common/adapter/ui/AdaWebview$IFExecutePreloadJSContentCallBack;->callback(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public syncUpdateWebViewData(Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string/jumbo v2, "syncUpdateWebViewData url="
    ...
    const-string/jumbo v2, "try{window.plus.__tag__=\'"
