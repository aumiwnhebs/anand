...
.method protected onResize()V
    ...
    .line 9
    iget v0, v1, Lio/dcloud/common/adapter/ui/RefreshView;->maxPullHeight:I

    .line 10
    iget v1, v1, Lio/dcloud/common/adapter/ui/RefreshView;->changeStateHeight:I
    ...
    .line 19
    iget-object v2, p0, Lio/dcloud/common/adapter/ui/AdaWebViewParent;->mPullReFreshViewImpl:Lio/dcloud/common/adapter/ui/AdaWebViewParent$PullToRefreshWebViewExt;
    ...
    .line 20
    :goto_1
    invoke-virtual {v2, v3}, Lio/dcloud/common/adapter/ui/fresh/PullToRefreshBase;->setHeaderHeight(I)V
    ...
    :goto_2
    invoke-virtual {v2, v0}, Lio/dcloud/common/adapter/ui/fresh/PullToRefreshBase;->setHeaderPullDownMaxHeight(I)V
...
.method parseBounce(Lorg/json/JSONObject;)V
    ...
    .line 2
    iget-object v0, v2, Lio/dcloud/common/adapter/ui/AdaFrameView;->mRefreshView:Lio/dcloud/common/adapter/ui/RefreshView;
    ...
    .line 6
    :cond_0
    iget-object v0, v2, Lio/dcloud/common/adapter/ui/AdaFrameView;->mBounceView:Lio/dcloud/common/adapter/ui/BounceView;

    if-nez v0, :cond_1

    .line 7
    new-instance v0, Lio/dcloud/common/adapter/ui/BounceView;

    iget-object v1, p0, Lio/dcloud/common/adapter/ui/AdaWebViewParent;->mAdaWebview:Lio/dcloud/common/adapter/ui/AdaWebview;

    invoke-direct {v0, v2, v1}, Lio/dcloud/common/adapter/ui/BounceView;-><init>(Lio/dcloud/common/adapter/ui/AdaFrameView;Lio/dcloud/common/adapter/ui/AdaWebview;)V

    iput-object v0, v2, Lio/dcloud/common/adapter/ui/AdaFrameView;->mBounceView:Lio/dcloud/common/adapter/ui/BounceView;
    ...
    .line 12
    iget-object v3, v2, Lio/dcloud/common/adapter/ui/AdaFrameView;->mBounceView:Lio/dcloud/common/adapter/ui/BounceView;
    ...
    invoke-virtual {v0, p1}, Lio/dcloud/common/adapter/ui/BounceView;->parseJsonOption(Lorg/json/JSONObject;)V

    .line 17
    iget-object v0, v2, Lio/dcloud/common/adapter/ui/AdaFrameView;->mBounceView:Lio/dcloud/common/adapter/ui/BounceView;

    iget-object v3, v0, Lio/dcloud/common/adapter/ui/BounceView;->maxPullHeights:[I

    aget v3, v3, v1

    .line 18
    iget-object v0, v0, Lio/dcloud/common/adapter/ui/BounceView;->changeStateHeights:[I
    ...
    iget-object v3, v0, Lio/dcloud/common/adapter/ui/BounceView;->mSupports:[Z
    ...
    .line 22
    invoke-direct {p0, v0, v6, v5}, Lio/dcloud/common/adapter/ui/AdaWebViewParent;->initPullView(Lio/dcloud/common/adapter/ui/fresh/PullToRefreshBase$OnStateChangeListener;II)V
    ...
    .line 26
    :goto_1
    iget-object v1, v2, Lio/dcloud/common/adapter/ui/AdaFrameView;->mBounceView:Lio/dcloud/common/adapter/ui/BounceView;
    ...
    instance-of p1, p1, Lcom/dcloud/android/widget/AbsoluteLayout;

    if-eqz p1, :cond_4

    const-string/jumbo p1, "slideoffset"
    ...
    invoke-virtual {v1}, Lio/dcloud/common/adapter/ui/AdaWebview;->obtainWindowView()Landroid/view/ViewGroup;
    ...
    invoke-virtual {p1, v4, v0, v1}, Lcom/dcloud/android/widget/SlideLayout;->initSlideInfo(Lorg/json/JSONObject;FI)V
