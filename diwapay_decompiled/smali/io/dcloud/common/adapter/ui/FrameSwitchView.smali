...
.method private initScreenData()V
    ...
    invoke-static {v2}, Lio/dcloud/common/util/PdrUtil;->isNavigationBarShow(Landroid/app/Activity;)Z
    ...
    invoke-static {v2}, Lio/dcloud/common/util/PdrUtil;->navigationGestureEnabled(Landroid/content/Context;)Z
...
.method private runingAnimation(Lio/dcloud/common/DHInterface/IWebview;IILjava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v3, p0, v2, p1, p5}, Lio/dcloud/common/adapter/ui/FrameSwitchView$1;-><init>(Lio/dcloud/common/adapter/ui/FrameSwitchView;Landroid/view/View;Lio/dcloud/common/DHInterface/IWebview;Ljava/lang/String;)V

    invoke-direct {p0, v6, p3, p4, v3}, Lio/dcloud/common/adapter/ui/FrameSwitchView;->getAnimation(IIILandroid/view/animation/Animation$AnimationListener;)Landroid/view/animation/TranslateAnimation;
    ...
    invoke-direct {p3, p0, v0}, Lio/dcloud/common/adapter/ui/FrameSwitchView$2;-><init>(Lio/dcloud/common/adapter/ui/FrameSwitchView;Landroid/view/View;)V

    invoke-direct {p0, p2, v6, p1, p3}, Lio/dcloud/common/adapter/ui/FrameSwitchView;->getAnimation(IIILandroid/view/animation/Animation$AnimationListener;)Landroid/view/animation/TranslateAnimation;
    ...
    invoke-direct {v3, p0, v2, p1, p5}, Lio/dcloud/common/adapter/ui/FrameSwitchView$3;-><init>(Lio/dcloud/common/adapter/ui/FrameSwitchView;Landroid/view/View;Lio/dcloud/common/DHInterface/IWebview;Ljava/lang/String;)V

    invoke-direct {p0, p3, v6, p4, v3}, Lio/dcloud/common/adapter/ui/FrameSwitchView;->getAnimation(IIILandroid/view/animation/Animation$AnimationListener;)Landroid/view/animation/TranslateAnimation;
    ...
    invoke-direct {p3, p0, v0}, Lio/dcloud/common/adapter/ui/FrameSwitchView$4;-><init>(Lio/dcloud/common/adapter/ui/FrameSwitchView;Landroid/view/View;)V

    invoke-direct {p0, v6, p2, p1, p3}, Lio/dcloud/common/adapter/ui/FrameSwitchView;->getAnimation(IIILandroid/view/animation/Animation$AnimationListener;)Landroid/view/animation/TranslateAnimation;
    ...
    .line 62
    :cond_4
    const-string/jumbo v3, "slide-in-right"
    ...
    invoke-direct {p4, p0, v2, p1, p5}, Lio/dcloud/common/adapter/ui/FrameSwitchView$5;-><init>(Lio/dcloud/common/adapter/ui/FrameSwitchView;Landroid/view/View;Lio/dcloud/common/DHInterface/IWebview;Ljava/lang/String;)V

    invoke-direct {p0, p2, v6, p3, p4}, Lio/dcloud/common/adapter/ui/FrameSwitchView;->getAnimation(IIILandroid/view/animation/Animation$AnimationListener;)Landroid/view/animation/TranslateAnimation;
    ...
    .line 81
    :cond_6
    const-string/jumbo v3, "slide-out-right"
    ...
    new-instance v0, Lio/dcloud/common/adapter/ui/FrameSwitchView$6;
    ...
    invoke-direct/range {v0 .. v5}, Lio/dcloud/common/adapter/ui/FrameSwitchView$6;-><init>(Lio/dcloud/common/adapter/ui/FrameSwitchView;Landroid/view/View;ILio/dcloud/common/DHInterface/IWebview;Ljava/lang/String;)V

    invoke-direct {p0, v6, p2, p3, v0}, Lio/dcloud/common/adapter/ui/FrameSwitchView;->getAnimation(IIILandroid/view/animation/Animation$AnimationListener;)Landroid/view/animation/TranslateAnimation;
    ...
    .line 101
    :cond_8
    iput-boolean v6, p0, Lio/dcloud/common/adapter/ui/FrameSwitchView;->isRuning:Z
...
.method public startAnimation(Lio/dcloud/common/DHInterface/IWebview;Ljava/lang/String;Ljava/lang/Object;Ljava/lang/String;Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 26
    const-string/jumbo p2, "slide-in-right"
    ...
    .line 28
    const-string/jumbo p2, "slide-out-right"
