...
.method public static dwApp(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lio/dcloud/common/DHInterface/ILoadCallBack;Ljava/lang/String;)V
    ...
    invoke-static {p0}, Lcom/dcloud/android/downloader/DownloadService;->getDownloadManager(Landroid/content/Context;)Lcom/dcloud/android/downloader/callback/DCDownloadManager;
    ...
    .line 10
    :cond_0
    invoke-interface {p0}, Lcom/dcloud/android/downloader/callback/DCDownloadManager;->findAllDownloading()Ljava/util/List;
    ...
    .line 12
    invoke-virtual {v1}, Lcom/dcloud/android/downloader/domain/DownloadInfo;->getUri()Ljava/lang/String;
    ...
    .line 13
    invoke-interface {p0, v1}, Lcom/dcloud/android/downloader/callback/DCDownloadManager;->remove(Lcom/dcloud/android/downloader/domain/DownloadInfo;)V

    goto :goto_0

    .line 16
    :cond_2
    new-instance v0, Lcom/dcloud/android/downloader/domain/DownloadInfo$Builder;

    invoke-direct {v0}, Lcom/dcloud/android/downloader/domain/DownloadInfo$Builder;-><init>()V

    invoke-virtual {v0, p4}, Lcom/dcloud/android/downloader/domain/DownloadInfo$Builder;->setUrl(Ljava/lang/String;)Lcom/dcloud/android/downloader/domain/DownloadInfo$Builder;

    move-result-object p4

    invoke-virtual {p4, p7}, Lcom/dcloud/android/downloader/domain/DownloadInfo$Builder;->setPath(Ljava/lang/String;)Lcom/dcloud/android/downloader/domain/DownloadInfo$Builder;

    move-result-object p4

    invoke-virtual {p4, p1}, Lcom/dcloud/android/downloader/domain/DownloadInfo$Builder;->build(Landroid/content/Context;)Lcom/dcloud/android/downloader/domain/DownloadInfo;
    ...
    .line 18
    invoke-virtual {p7, p6}, Lcom/dcloud/android/downloader/domain/DownloadInfo;->setTag(Ljava/lang/Object;)V

    :cond_3
    move-object p6, p0

    .line 20
    new-instance p0, Lio/dcloud/feature/gg/dcloud/ADSim$5;

    move-object p4, v3

    invoke-direct/range {p0 .. p6}, Lio/dcloud/feature/gg/dcloud/ADSim$5;-><init>(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lcom/dcloud/android/downloader/callback/DCDownloadManager;)V

    invoke-virtual {p7, p0}, Lcom/dcloud/android/downloader/domain/DownloadInfo;->setDownloadListener(Lcom/dcloud/android/downloader/callback/DownloadListener;)V

    .line 70
    invoke-interface {p6, p7}, Lcom/dcloud/android/downloader/callback/DCDownloadManager;->download(Lcom/dcloud/android/downloader/domain/DownloadInfo;)V
...
.method public static openUrl(Landroid/content/Context;Ljava/lang/String;)V
    ...
    .line 2
    new-instance v0, Lio/dcloud/feature/gg/dcloud/AolWebView;

    invoke-direct {v0, p0}, Lio/dcloud/feature/gg/dcloud/AolWebView;-><init>(Landroid/content/Context;)V

    .line 3
    invoke-virtual {v0, p1}, Lio/dcloud/feature/gg/dcloud/AolWebView;->loadUrl(Ljava/lang/String;)V
