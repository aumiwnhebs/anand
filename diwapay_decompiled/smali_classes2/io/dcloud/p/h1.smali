...
.method private a(Lio/dcloud/common/DHInterface/IApp;)Ljava/lang/String;
    ...
    const-string v1, "getUniNViewModules"
    ...
    invoke-virtual {p0, v0, v1, p1}, Lio/dcloud/p/h1;->processEvent(Lio/dcloud/common/DHInterface/IMgr$MgrType;ILjava/lang/Object;)Ljava/lang/Object;
    ...
    const-string v0, ";window.__NATIVE_PLUGINS_REGISTERED__ = true;"
...
.method private a(Lio/dcloud/common/DHInterface/IApp;Lio/dcloud/common/DHInterface/IWebview;)Ljava/lang/String;
    ...
    filled-new-array {v2, v4, v7, v1}, [Ljava/lang/Object;
    ...
    const-string v2, "try{if((window.__html5plus__&&__html5plus__.isReady?__html5plus__:navigator.plus&&navigator.plus.isReady?navigator.plus:window.plus).runtime)var p=window.__html5plus__&&__html5plus__.isReady?__html5plus__:navigator.plus&&navigator.plus.isReady?navigator.plus:window.plus; %s }catch(_){}"
    ...
    invoke-static {v1}, Lio/dcloud/common/util/DataUtil;->utf8ToUnicode(Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v3, "p.runtime.launcher = \'%s\';"
    ...
    const-string v3, "p.runtime.channel = \'%s\';"
    ...
    invoke-static {v1, v4, v3}, Lio/dcloud/common/adapter/util/SP;->getBundleData(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v3, "p.runtime.origin = \'%s\';"
...
.method private a([Ljava/lang/Object;)Ljava/lang/String;
    ...
    invoke-virtual {p0, v1, v5}, Lio/dcloud/p/h1;->b(Ljava/lang/String;Landroid/app/Activity;)Lio/dcloud/common/DHInterface/IFeature;
    ...
    .line 125
    instance-of v1, v5, Lio/dcloud/common/DHInterface/BaseFeature;
    ...
    invoke-virtual {v1}, Lio/dcloud/common/DHInterface/BaseFeature;->isOldMode()Z
    ...
    .line 127
    invoke-virtual {v1, v0, v2, p1}, Lio/dcloud/common/DHInterface/BaseFeature;->execute(Lio/dcloud/common/DHInterface/IWebview;Ljava/lang/String;Lorg/json/JSONArray;)Ljava/lang/String;
    ...
    :cond_2
    :goto_0
    invoke-interface {v5, v0, v2, v4}, Lio/dcloud/common/DHInterface/IFeature;->execute(Lio/dcloud/common/DHInterface/IWebview;Ljava/lang/String;[Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p1, v1}, Lio/dcloud/common/core/permission/PermissionControler;->checkSafePermission(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    sget v3, Lio/dcloud/base/R$string;->dcloud_feature_error_tips:I
    ...
    const-string v5, " feature plugin ; action="
    ...
    invoke-static {v2, p1}, Lio/dcloud/common/adapter/util/Logger;->e(Ljava/lang/String;Ljava/lang/String;)V

    .line 150
    invoke-virtual {p0, v0, v1}, Lio/dcloud/p/h1;->a(Lio/dcloud/common/DHInterface/IWebview;Ljava/lang/String;)V
