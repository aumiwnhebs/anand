...
.method public a(Lorg/json/JSONObject;I)Lio/dcloud/p/t0;
    ...
    .line 23
    :cond_5
    new-instance v10, Lio/dcloud/p/u4$b;

    invoke-direct {v10}, Lio/dcloud/p/u4$b;-><init>()V
    ...
    invoke-virtual {v10, v11}, Lio/dcloud/p/u4$b;->d(Ljava/lang/String;)Lio/dcloud/p/u4$b;
    ...
    invoke-virtual {v10, v11}, Lio/dcloud/p/u4$b;->c(I)Lio/dcloud/p/u4$b;
    ...
    :goto_3
    invoke-virtual {v10, v11}, Lio/dcloud/p/u4$b;->c(Z)Lio/dcloud/p/u4$b;
    ...
    invoke-virtual {v10, v11}, Lio/dcloud/p/u4$b;->f(I)Lio/dcloud/p/u4$b;
    ...
    invoke-virtual {v10, v11}, Lio/dcloud/p/u4$b;->g(I)Lio/dcloud/p/u4$b;
    ...
    invoke-virtual {v10, v11}, Lio/dcloud/p/u4$b;->c(Ljava/lang/String;)Lio/dcloud/p/u4$b;
    ...
    invoke-virtual {v10, v11}, Lio/dcloud/p/u4$b;->i(I)Lio/dcloud/p/u4$b;

    move-result-object v10

    .line 31
    invoke-virtual {v10, v9}, Lio/dcloud/p/u4$b;->j(I)Lio/dcloud/p/u4$b;
    ...
    invoke-virtual {v9, v10}, Lio/dcloud/p/u4$b;->k(I)Lio/dcloud/p/u4$b;

    move-result-object v9

    .line 33
    invoke-virtual {v9, v0}, Lio/dcloud/p/u4$b;->d(I)Lio/dcloud/p/u4$b;
    ...
    .line 34
    invoke-virtual {v9, v10}, Lio/dcloud/p/u4$b;->b(I)Lio/dcloud/p/u4$b;
    ...
    invoke-virtual {v9, v10}, Lio/dcloud/p/u4$b;->a(Ljava/lang/String;)Lio/dcloud/p/u4$b;
    ...
    invoke-virtual {v9, v10}, Lio/dcloud/p/u4$b;->b(Ljava/lang/String;)Lio/dcloud/p/u4$b;
    ...
    invoke-virtual {v9, v10}, Lio/dcloud/p/u4$b;->h(I)Lio/dcloud/p/u4$b;
    ...
    :goto_4
    invoke-virtual {v9, v10}, Lio/dcloud/p/u4$b;->a(Z)Lio/dcloud/p/u4$b;
    ...
    invoke-virtual {v9, v10}, Lio/dcloud/p/u4$b;->a(Lorg/json/JSONObject;)Lio/dcloud/p/u4$b;
    ...
    invoke-virtual {v9, v8}, Lio/dcloud/p/u4$b;->a(I)Lio/dcloud/p/u4$b;
    ...
    .line 41
    invoke-virtual {v8, v9}, Lio/dcloud/p/u4$b;->e(I)Lio/dcloud/p/u4$b;

    move-result-object v8

    iget v9, p0, Lio/dcloud/p/t0;->b:I
    ...
    .line 42
    :goto_5
    invoke-virtual {v8, v9}, Lio/dcloud/p/u4$b;->b(Z)Lio/dcloud/p/u4$b;

    move-result-object v8

    .line 43
    invoke-virtual {v8}, Lio/dcloud/p/u4$b;->a()Lio/dcloud/p/u4;

    move-result-object v8

    .line 45
    invoke-virtual {v8}, Lio/dcloud/p/u4;->l()Ljava/lang/String;
...
.method public b()Ljava/util/List;
    ...
    .line 1
    iget-object v0, p0, Lio/dcloud/p/t0;->i:Ljava/util/List;
