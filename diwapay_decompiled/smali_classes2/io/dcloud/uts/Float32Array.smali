.class public final Lio/dcloud/uts/Float32Array;
...
.field public static final Companion:Lio/dcloud/uts/Float32Array$Companion;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lio/dcloud/uts/Float32Array$Companion;

    const/4 v1, 0x0

    invoke-direct {v0, v1}, Lio/dcloud/uts/Float32Array$Companion;-><init>(Lkotlin/jvm/internal/DefaultConstructorMarker;)V

    sput-object v0, Lio/dcloud/uts/Float32Array;->Companion:Lio/dcloud/uts/Float32Array$Companion;
...
.method public constructor <init>(Lio/dcloud/uts/ArrayBuffer;)V
    ...
    iput-object p1, p0, Lio/dcloud/uts/Float32Array;->BYTES_PER_ELEMENT$1:Ljava/lang/Number;
...
.method public synthetic constructor <init>(Lio/dcloud/uts/ArrayBuffer;Ljava/lang/Number;Ljava/lang/Number;ILkotlin/jvm/internal/DefaultConstructorMarker;)V
    ...
    .line 58
    :cond_1
    invoke-direct {p0, p1, p2, p3}, Lio/dcloud/uts/Float32Array;-><init>(Lio/dcloud/uts/ArrayBuffer;Ljava/lang/Number;Ljava/lang/Number;)V
...
.method public filter(Lkotlin/jvm/functions/Function3;)Lio/dcloud/uts/Float32Array;
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    .line 68
    invoke-virtual {p0}, Lio/dcloud/uts/Float32Array;->size()I
    ...
    .line 70
    invoke-virtual {p0, v2}, Lio/dcloud/uts/Float32Array;->getAuto(I)Ljava/lang/Number;
    ...
    const-string v6, "null cannot be cast to non-null type T of io.dcloud.uts.Float32Array.filter"
    ...
    .line 76
    :cond_1
    new-instance p1, Lio/dcloud/uts/Float32Array;

    check-cast v0, Ljava/util/Collection;

    invoke-direct {p1, v0}, Lio/dcloud/uts/Float32Array;-><init>(Ljava/util/Collection;)V
...
.method public bridge synthetic filter(Lkotlin/jvm/functions/Function3;)Lio/dcloud/uts/TypedArray;
    ...
    .line 5
    invoke-virtual {p0, p1}, Lio/dcloud/uts/Float32Array;->filter(Lkotlin/jvm/functions/Function3;)Lio/dcloud/uts/Float32Array;
...
.method public getAuto(I)Ljava/lang/Number;
    ...
    .line 91
    invoke-virtual {p0}, Lio/dcloud/uts/Float32Array;->getByteBuffer()Ljava/nio/ByteBuffer;

    move-result-object v0

    invoke-virtual {p0}, Lio/dcloud/uts/Float32Array;->getBYTES_PER_ELEMENT()Ljava/lang/Number;
...
.method public getBYTES_PER_ELEMENT()Ljava/lang/Number;
    ...
    .line 6
    iget-object v0, p0, Lio/dcloud/uts/Float32Array;->BYTES_PER_ELEMENT$1:Ljava/lang/Number;
...
.method public iterator()Ljava/util/Iterator;
    ...
    .line 148
    new-instance v0, Lio/dcloud/uts/Float32Array$iterator$1;

    invoke-direct {v0, p0}, Lio/dcloud/uts/Float32Array$iterator$1;-><init>(Lio/dcloud/uts/Float32Array;)V
...
.method public map(Lkotlin/jvm/functions/Function3;)Lio/dcloud/uts/Float32Array;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    const-string v5, "null cannot be cast to non-null type T of io.dcloud.uts.Float32Array.map"
    ...
    invoke-direct {p1, v1}, Lio/dcloud/uts/Float32Array;-><init>(Ljava/util/Collection;)V
...
.method public bridge synthetic map(Lkotlin/jvm/functions/Function3;)Lio/dcloud/uts/TypedArray;
    ...
    .line 5
    invoke-virtual {p0, p1}, Lio/dcloud/uts/Float32Array;->map(Lkotlin/jvm/functions/Function3;)Lio/dcloud/uts/Float32Array;
...
.method public slice(Ljava/lang/Number;Ljava/lang/Number;)Lio/dcloud/uts/Float32Array;
    .locals 2
    ...
    .line 112
    invoke-virtual {p0}, Lio/dcloud/uts/Float32Array;->getLength()Ljava/lang/Number;
    ...
    .line 118
    invoke-virtual {p0, p1}, Lio/dcloud/uts/Float32Array;->getAuto(I)Ljava/lang/Number;
...
.method public bridge synthetic slice(Ljava/lang/Number;Ljava/lang/Number;)Lio/dcloud/uts/TypedArray;
    ...
    .line 5
    invoke-virtual {p0, p1, p2}, Lio/dcloud/uts/Float32Array;->slice(Ljava/lang/Number;Ljava/lang/Number;)Lio/dcloud/uts/Float32Array;
...
.method public subarray(Ljava/lang/Number;Ljava/lang/Number;)Lio/dcloud/uts/Float32Array;
    .locals 4
...
.method public bridge synthetic subarray(Ljava/lang/Number;Ljava/lang/Number;)Lio/dcloud/uts/TypedArray;
    ...
    .line 5
    invoke-virtual {p0, p1, p2}, Lio/dcloud/uts/Float32Array;->subarray(Ljava/lang/Number;Ljava/lang/Number;)Lio/dcloud/uts/Float32Array;
