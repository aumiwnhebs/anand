...
.method constructor <init>(Lio/dcloud/common/DHInterface/IWebview;Landroid/view/ViewGroup;Lorg/json/JSONObject;Ljava/lang/String;IZ)V
    ...
    sget p3, Lcom/taobao/weex/R$string;->dcloud_feature_weex_jsfk_not_found_tips:I
    ...
    const-string p3, "VUE3"

    goto :goto_0

    :cond_3
    const-string p3, "VUE2"
...
.method private render(Ljava/lang/Object;Ljava/util/Map;Ljava/lang/String;)V
    ...
    iget-object v1, p0, Lio/dcloud/feature/weex/WXViewWrapper;->readyJs:Ljava/lang/String;
...
.method private updateDeviceDisplay(FFZZ)V
    ...
    .line 11
    iget-object v4, p0, Lio/dcloud/feature/weex/WXBaseWrapper;->mWXSDKInstance:Lcom/taobao/weex/WXSDKInstance;

    invoke-virtual {v4}, Lcom/taobao/weex/WXSDKInstance;->isOnSizeChangedRender()Z
    ...
    const-string v6, "resolutionHeight"
    ...
    invoke-interface {v4, v5}, Lio/dcloud/common/DHInterface/IWebview;->evalJS(Ljava/lang/String;)V

    .line 33
    iget-boolean v4, p0, Lio/dcloud/feature/weex/WXViewWrapper;->isCompilerWithUniapp:Z
    ...
    invoke-virtual {v4, v0, v3}, Lcom/taobao/weex/WXSDKInstance;->setInstanceViewPortWidth(FZ)V
    ...
    invoke-virtual {v0, v1, v2}, Lcom/taobao/weex/WXSDKInstance;->setDeviceDisplayOfPage(II)V

    .line 39
    iget-object v0, p0, Lio/dcloud/feature/weex/WXBaseWrapper;->mWXSDKInstance:Lcom/taobao/weex/WXSDKInstance;

    invoke-virtual {v0}, Lcom/taobao/weex/WXSDKInstance;->reloadPageLayout()V
    ...
    invoke-virtual/range {v1 .. v6}, Lcom/taobao/weex/bridge/WXBridgeManager;->setDefaultRootSize(Ljava/lang/String;FFZZ)V
