...
.method addEventListener(Ljava/lang/String;Lio/dcloud/common/DHInterface/IWebview;Ljava/lang/String;)V
    ...
    .line 15
    iget-object v2, p0, Lio/dcloud/feature/nativeObj/NativeView$NativeCanvasView;->doEventListenerMap:Ljava/util/HashMap;
...
.method public doTypeEvent(Ljava/lang/String;)Z
    ...
    invoke-virtual {v0}, Lio/dcloud/feature/nativeObj/NativeView;->getEventJSON()Ljava/lang/String;
...
.method protected onDraw(Landroid/graphics/Canvas;)V
    ...
    invoke-direct {v2, v7, v3}, Landroid/graphics/PaintFlagsDrawFilter;-><init>(II)V

    invoke-virtual {v1, v2}, Landroid/graphics/Canvas;->setDrawFilter(Landroid/graphics/DrawFilter;)V

    .line 3
    iget-object v2, v0, Lio/dcloud/feature/nativeObj/NativeView$NativeCanvasView;->this$0:Lio/dcloud/feature/nativeObj/NativeView;

    iget v3, v2, Lio/dcloud/feature/nativeObj/NativeView;->mInnerLeft:I

    iget v4, v2, Lio/dcloud/feature/nativeObj/NativeView;->mInnerTop:I

    iget v5, v2, Lio/dcloud/feature/nativeObj/NativeView;->mInnerRight:I

    iget v2, v2, Lio/dcloud/feature/nativeObj/NativeView;->mInnerBottom:I

    invoke-virtual {v1, v3, v4, v5, v2}, Landroid/graphics/Canvas;->clipRect(IIII)Z

    .line 4
    iget-object v2, v0, Lio/dcloud/feature/nativeObj/NativeView$NativeCanvasView;->this$0:Lio/dcloud/feature/nativeObj/NativeView;

    invoke-virtual {v2}, Lio/dcloud/feature/nativeObj/NativeView;->getViewType()Ljava/lang/String;

    move-result-object v2

    const-string v3, "nativeView"
    ...
    iget v2, v2, Lio/dcloud/feature/nativeObj/NativeView;->mBackGroundColor:I
    ...
    invoke-static {v2}, Lio/dcloud/feature/nativeObj/NativeView;->access$700(Lio/dcloud/feature/nativeObj/NativeView;)Landroid/graphics/RectF;
    ...
    invoke-virtual {v1, v2, v3}, Landroid/graphics/Canvas;->clipRect(Landroid/graphics/RectF;Landroid/graphics/Region$Op;)Z

    .line 12
    :cond_1
    iget-object v2, v0, Lio/dcloud/feature/nativeObj/NativeView$NativeCanvasView;->this$0:Lio/dcloud/feature/nativeObj/NativeView;

    iget-object v2, v2, Lio/dcloud/feature/nativeObj/NativeView;->mOverlays:Ljava/util/ArrayList;
    ...
    check-cast v5, Lio/dcloud/feature/nativeObj/NativeView$Overlay;

    .line 13
    iget-object v6, v5, Lio/dcloud/feature/nativeObj/NativeView$Overlay;->type:Ljava/lang/String;
    ...
    .line 14
    iget-object v5, v5, Lio/dcloud/feature/nativeObj/NativeView$Overlay;->mDestRect:Landroid/graphics/Rect;

    sget-object v6, Landroid/graphics/Region$Op;->DIFFERENCE:Landroid/graphics/Region$Op;

    invoke-virtual {v1, v5, v6}, Landroid/graphics/Canvas;->clipRect(Landroid/graphics/Rect;Landroid/graphics/Region$Op;)Z
    ...
    iget-object v8, v2, Lio/dcloud/feature/nativeObj/NativeView;->mOverlays:Ljava/util/ArrayList;
    ...
    .line 22
    iget-object v2, v6, Lio/dcloud/feature/nativeObj/NativeView$Overlay;->mNativeBitmap:Lio/dcloud/feature/nativeObj/NativeBitmap;
    ...
    invoke-virtual {v2}, Lio/dcloud/feature/nativeObj/NativeBitmap;->isGif()Z
    ...
    iget-object v3, v6, Lio/dcloud/feature/nativeObj/NativeView$Overlay;->mSrcRect:Landroid/graphics/Rect;

    iget-object v4, v6, Lio/dcloud/feature/nativeObj/NativeView$Overlay;->mDestRect:Landroid/graphics/Rect;

    iget-object v5, v0, Lio/dcloud/feature/nativeObj/NativeView$NativeCanvasView;->this$0:Lio/dcloud/feature/nativeObj/NativeView;

    iget-object v5, v5, Lio/dcloud/feature/nativeObj/NativeView;->mPaint:Landroid/graphics/Paint;
    ...
    :cond_5
    :goto_2
    invoke-direct {v0, v6}, Lio/dcloud/feature/nativeObj/NativeView$NativeCanvasView;->initAuto(Lio/dcloud/feature/nativeObj/NativeView$Overlay;)V
    ...
    .line 41
    iget v2, v6, Lio/dcloud/feature/nativeObj/NativeView$Overlay;->mFontColor:I

    if-eqz v2, :cond_7

    .line 42
    iget-object v4, v0, Lio/dcloud/feature/nativeObj/NativeView$NativeCanvasView;->this$0:Lio/dcloud/feature/nativeObj/NativeView;
    ...
    .line 47
    :cond_8
    iget v2, v6, Lio/dcloud/feature/nativeObj/NativeView$Overlay;->mFontSize:F
    ...
    iget-object v2, v2, Lio/dcloud/feature/nativeObj/NativeView;->mApp:Lio/dcloud/common/DHInterface/IApp;

    iget-object v4, v6, Lio/dcloud/feature/nativeObj/NativeView$Overlay;->textTTFPh:Ljava/lang/String;

    invoke-static {v2, v4}, Lio/dcloud/feature/nativeObj/NativeTypefaceFactory;->getTypeface(Lio/dcloud/common/DHInterface/IApp;Ljava/lang/String;)Landroid/graphics/Typeface;
    ...
    .line 53
    :cond_a
    iget-object v2, v6, Lio/dcloud/feature/nativeObj/NativeView$Overlay;->textFamily:Ljava/lang/String;
    ...
    iget-object v4, v6, Lio/dcloud/feature/nativeObj/NativeView$Overlay;->textWeight:Ljava/lang/String;

    sget-object v5, Lio/dcloud/common/adapter/ui/FrameBitmapView;->BOLD:Ljava/lang/String;
    ...
    .line 58
    iget-object v2, v6, Lio/dcloud/feature/nativeObj/NativeView$Overlay;->textStyle:Ljava/lang/String;

    sget-object v4, Lio/dcloud/common/adapter/ui/FrameBitmapView;->ITALIC:Ljava/lang/String;
    ...
    .line 66
    iget-object v4, v6, Lio/dcloud/feature/nativeObj/NativeView$Overlay;->textAlign:Ljava/lang/String;
    ...
    :cond_e
    :goto_5
    iget-object v12, v6, Lio/dcloud/feature/nativeObj/NativeView$Overlay;->mText:Ljava/lang/String;

    .line 74
    iget-object v4, v6, Lio/dcloud/feature/nativeObj/NativeView$Overlay;->textDecoration:Ljava/lang/String;
    ...
    invoke-virtual {v15, v4}, Landroid/graphics/Paint;->set(Landroid/graphics/Paint;)V
    ...
    iget-object v14, v6, Lio/dcloud/feature/nativeObj/NativeView$Overlay;->mDestRect:Landroid/graphics/Rect;
    ...
    iget v3, v6, Lio/dcloud/feature/nativeObj/NativeView$Overlay;->textLineSpacing:F

    const v20, 0x3f666666    # 0.9f

    add-float v16, v3, v20
    ...
    .line 84
    iget-boolean v14, v6, Lio/dcloud/feature/nativeObj/NativeView$Overlay;->textAdapt:Z
    ...
    iget-object v7, v6, Lio/dcloud/feature/nativeObj/NativeView$Overlay;->mDestRect:Landroid/graphics/Rect;
    ...
    .line 89
    iget-object v11, v6, Lio/dcloud/feature/nativeObj/NativeView$Overlay;->textOverflow:Ljava/lang/String;
    ...
    iget v7, v6, Lio/dcloud/feature/nativeObj/NativeView$Overlay;->textLineSpacing:F
    ...
    .line 96
    :goto_9
    iget-object v3, v6, Lio/dcloud/feature/nativeObj/NativeView$Overlay;->mDestRect:Landroid/graphics/Rect;
    ...
    .line 97
    iget-object v3, v6, Lio/dcloud/feature/nativeObj/NativeView$Overlay;->textVerticalAligin:Ljava/lang/String;
    ...
    .line 108
    iget-object v7, v6, Lio/dcloud/feature/nativeObj/NativeView$Overlay;->textOverflow:Ljava/lang/String;
    ...
    invoke-static {v12, v13, v3, v7}, Landroid/text/TextUtils;->ellipsize(Ljava/lang/CharSequence;Landroid/text/TextPaint;FLandroid/text/TextUtils$TruncateAt;)Ljava/lang/CharSequence;
    ...
    .line 115
    iget-object v14, v6, Lio/dcloud/feature/nativeObj/NativeView$Overlay;->textVerticalAligin:Ljava/lang/String;
    ...
    .line 120
    invoke-virtual {v1, v12, v2, v3, v13}, Landroid/graphics/Canvas;->drawText(Ljava/lang/String;FFLandroid/graphics/Paint;)V
    ...
    .line 123
    iget-object v2, v6, Lio/dcloud/feature/nativeObj/NativeView$Overlay;->type:Ljava/lang/String;
    ...
    iget v7, v5, Lio/dcloud/feature/nativeObj/NativeView;->mInnerWidth:I

    iget v5, v5, Lio/dcloud/feature/nativeObj/NativeView;->mInnerLeft:I
    ...
    .line 154
    iget-object v1, v0, Lio/dcloud/feature/nativeObj/NativeView$NativeCanvasView;->this$0:Lio/dcloud/feature/nativeObj/NativeView;
...
.method protected onMeasure(II)V
    ...
    .line 14
    iget-object v2, p0, Lio/dcloud/feature/nativeObj/NativeView$NativeCanvasView;->this$0:Lio/dcloud/feature/nativeObj/NativeView;

    iget-object v2, v2, Lio/dcloud/feature/nativeObj/NativeView;->mWebView:Lio/dcloud/common/DHInterface/IWebview;

    invoke-virtual {v1, v2}, Lio/dcloud/feature/nativeObj/NativeView$Overlay;->parseJson(Lio/dcloud/common/DHInterface/IWebview;)V
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-boolean p1, p1, Lio/dcloud/feature/nativeObj/NativeView;->mIntercept:Z
