...
.method private a(Ljava/lang/String;Lio/dcloud/common/DHInterface/ISysEventListener$SysEventType;Ljava/lang/String;IZ)Z
    ...
    const-string v1, "{keyType:\'%s\',keyCode:%d}"
    ...
    .line 34
    iget-object v1, p0, Lio/dcloud/feature/ui/a;->b:Ljava/util/List;
    ...
    const-string v3, "syncExecBaseEvent windowCount = "
    ...
    .line 38
    iget-object v4, p0, Lio/dcloud/feature/ui/a;->b:Ljava/util/List;
    ...
    .line 39
    iget-object v5, v4, Lio/dcloud/feature/ui/b;->a:Lio/dcloud/feature/ui/c;
    ...
    iget-boolean v5, v4, Lio/dcloud/feature/ui/c;->F:Z

    if-eqz v5, :cond_8

    :cond_0
    iget-object v5, v4, Lio/dcloud/feature/ui/c;->y:Lio/dcloud/common/DHInterface/IFrameView;

    invoke-interface {v5}, Lio/dcloud/common/DHInterface/IFrameView;->getFrameType()I
    ...
    .line 42
    invoke-virtual {v4, p1, v0, p5}, Lio/dcloud/feature/ui/c;->c(Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    .line 46
    :cond_1
    invoke-virtual {v4, p1, v0, p5}, Lio/dcloud/feature/ui/c;->b(Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    .line 50
    :cond_2
    sget-boolean v6, Lio/dcloud/common/util/BaseInfo;->USE_ACTIVITY_HANDLE_KEYEVENT:Z
    ...
    .line 52
    invoke-virtual {v4, p3}, Lio/dcloud/feature/ui/c;->b(Ljava/lang/String;)Z

    move-result v6

    if-nez v6, :cond_7

    sget-object v6, Lio/dcloud/common/DHInterface/ISysEventListener$SysEventType;->onKeyDown:Lio/dcloud/common/DHInterface/ISysEventListener$SysEventType;

    if-ne p2, v6, :cond_8

    .line 54
    invoke-virtual {v4, v5}, Lio/dcloud/feature/ui/c;->b(Ljava/lang/String;)Z
...
.method declared-synchronized b()Ljava/lang/String;
    ...
    .line 5
    iget-object v1, p0, Lio/dcloud/feature/ui/a;->c:Ljava/util/List;
    ...
    .line 7
    invoke-virtual {v3}, Lio/dcloud/feature/ui/c;->r()Lio/dcloud/common/DHInterface/IWebview;
    ...
    invoke-virtual {v3}, Lio/dcloud/feature/ui/c;->p()Z
...
.method declared-synchronized e()Ljava/lang/String;
    ...
    .line 7
    invoke-virtual {v3}, Lio/dcloud/feature/ui/c;->o()Z
...
.method i()V
    ...
    invoke-interface {v0, v4}, Lio/dcloud/common/DHInterface/IApp;->setNeedRefreshApp(Z)V
    ...
    :cond_3
    :goto_1
    invoke-virtual {v6, v6, v4}, Lio/dcloud/feature/ui/c;->a(Lio/dcloud/feature/ui/c;Z)V
...
.method public onExecute(Lio/dcloud/common/DHInterface/ISysEventListener$SysEventType;Ljava/lang/Object;)Z
    ...
    const-string v6, "{keyType:\'%s\',keyCode:%d}"
    ...
    .line 98
    invoke-virtual {v3, v5, p2, v2}, Lio/dcloud/feature/ui/c;->b(Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    .line 100
    iget-object p2, p0, Lio/dcloud/feature/ui/a;->d:Lio/dcloud/common/DHInterface/AbsMgr;

    sget-object v2, Lio/dcloud/common/DHInterface/IMgr$MgrType;->WindowMgr:Lio/dcloud/common/DHInterface/IMgr$MgrType;

    iget-object v5, p0, Lio/dcloud/feature/ui/a;->f:Lio/dcloud/common/DHInterface/IApp;

    const/16 v6, 0x14

    invoke-interface {p2, v2, v6, v5}, Lio/dcloud/common/DHInterface/IMgr;->processEvent(Lio/dcloud/common/DHInterface/IMgr$MgrType;ILjava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-interface {p2, v4, v6, v5}, Lio/dcloud/common/DHInterface/IMgr;->processEvent(Lio/dcloud/common/DHInterface/IMgr$MgrType;ILjava/lang/Object;)Ljava/lang/Object;
    ...
    .line 108
    invoke-interface {p2}, Lio/dcloud/common/DHInterface/IWebview;->canGoBack()Z
    ...
    .line 109
    invoke-interface {p2, v2}, Lio/dcloud/common/DHInterface/IWebview;->goBackOrForward(I)V
    ...
    .line 116
    iget-object p2, p0, Lio/dcloud/feature/ui/a;->c:Ljava/util/List;

    iget-object v2, p0, Lio/dcloud/feature/ui/a;->p:Lio/dcloud/feature/ui/a$a;

    invoke-static {p2, v2}, Ljava/util/Collections;->sort(Ljava/util/List;Ljava/util/Comparator;)V

    .line 117
    iget-object p2, p0, Lio/dcloud/feature/ui/a;->b:Ljava/util/List;
    ...
    iget-object v3, p0, Lio/dcloud/feature/ui/a;->f:Lio/dcloud/common/DHInterface/IApp;
    ...
    invoke-interface {p2, v2, v5, v3}, Lio/dcloud/common/DHInterface/IMgr;->processEvent(Lio/dcloud/common/DHInterface/IMgr$MgrType;ILjava/lang/Object;)Ljava/lang/Object;
    ...
    .line 123
    iget v5, p2, Lio/dcloud/common/adapter/util/AnimOptions;->duration_close:I

    invoke-static {v3, v5}, Lio/dcloud/common/util/PdrUtil;->parseInt(Ljava/lang/String;I)I

    move-result v3

    iput v3, p2, Lio/dcloud/common/adapter/util/AnimOptions;->duration_close:I

    goto :goto_4

    .line 125
    :cond_a
    iget v3, p2, Lio/dcloud/common/adapter/util/AnimOptions;->duration_show:I

    iput v3, p2, Lio/dcloud/common/adapter/util/AnimOptions;->duration_close:I

    .line 127
    :goto_4
    iput-byte v1, p2, Lio/dcloud/common/adapter/util/AnimOptions;->mOption:B
    ...
    :cond_b
    invoke-virtual {p2, v3}, Lio/dcloud/common/adapter/util/AnimOptions;->setCloseAnimType(Ljava/lang/String;)V
    ...
    invoke-interface {p2, v2, v3, v4}, Lio/dcloud/common/DHInterface/IMgr;->processEvent(Lio/dcloud/common/DHInterface/IMgr$MgrType;ILjava/lang/Object;)Ljava/lang/Object;
    ...
    .line 154
    :goto_7
    sget-boolean p1, Lio/dcloud/common/adapter/util/DeviceInfo;->isVolumeButtonEnabled:Z
