...
.method public onExecuting()Ljava/lang/Object;
    ...
    iget-object v2, p0, Lio/dcloud/js/file/FileFeatureImpl$f;->b:Lio/dcloud/common/DHInterface/IWebview;

    invoke-interface {v2}, Lio/dcloud/common/DHInterface/IWebview;->getContext()Landroid/content/Context;

    move-result-object v2

    sget v3, Lio/dcloud/base/R$string;->dcloud_io_write_non_base64:I
    ...
    iget-object v3, p0, Lio/dcloud/js/file/FileFeatureImpl$f;->c:Ljava/lang/String;
    ...
    .line 9
    :cond_0
    iget v2, p0, Lio/dcloud/js/file/FileFeatureImpl$f;->d:I

    iget-object v3, p0, Lio/dcloud/js/file/FileFeatureImpl$f;->e:Ljava/lang/String;

    invoke-static {v0, v2, v3}, Lio/dcloud/common/adapter/io/DHFile;->writeFile([BILjava/lang/String;)V
