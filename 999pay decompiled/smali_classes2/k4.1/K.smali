...
.method static b(Landroid/content/Context;)Landroid/content/Intent;
    ...
    .line 2
    invoke-static {p0, v0}, Lk4/K;->c(Landroid/content/Context;Ljava/util/List;)Landroid/content/Intent;
...
.method static c(Landroid/content/Context;Ljava/util/List;)Landroid/content/Intent;
    .locals 3
    ...
    .line 74
    .line 75
    invoke-static {p0, p1}, Lk4/Q;->a(Landroid/content/Context;Landroid/content/Intent;)Z
    ...
    .line 96
    :cond_4
    invoke-static {}, Lk4/K;->a()Landroid/content/Intent;
...
.method static d(Landroid/content/Context;)Landroid/content/Intent;
    ...
    .line 7
    .line 8
    invoke-static {p0}, Lk4/K;->k(Landroid/content/Context;)Landroid/content/Intent;
    ...
    .line 25
    .line 26
    invoke-static {v0, v1}, Lk4/U;->a(Landroid/content/Intent;Landroid/content/Intent;)Landroid/content/Intent;
...
.method static e(Landroid/content/Context;)Landroid/content/Intent;
    ...
    .line 22
    .line 23
    invoke-static {p0}, Lk4/K;->f(Landroid/content/Context;)Landroid/content/Intent;
    ...
    .line 27
    invoke-static {}, Lk4/S;->d()Ljava/lang/String;
    ...
    .line 57
    .line 58
    invoke-static {v1, v0}, Lk4/U;->a(Landroid/content/Intent;Landroid/content/Intent;)Landroid/content/Intent;
    ...
    :cond_5
    :goto_2
    invoke-static {p0, v2}, Lk4/Q;->a(Landroid/content/Context;Landroid/content/Intent;)Z
    ...
    .line 88
    .line 89
    invoke-static {v1, v2}, Lk4/U;->a(Landroid/content/Intent;Landroid/content/Intent;)Landroid/content/Intent;
...
.method static g(Landroid/content/Context;)Landroid/content/Intent;
    ...
    .line 22
    invoke-static {p0}, Lk4/K;->n(Landroid/content/Context;)Landroid/content/Intent;
...
.method static j(Landroid/content/Context;)Landroid/content/Intent;
    ...
    .line 1
    invoke-static {p0}, Lk4/K;->i(Landroid/content/Context;)Landroid/content/Intent;
...
.method static l(Landroid/content/Context;)Landroid/content/Intent;
    .locals 1

    .line 1
    invoke-static {p0}, Lk4/K;->m(Landroid/content/Context;)Landroid/content/Intent;
...
.method static m(Landroid/content/Context;)Landroid/content/Intent;
    .locals 2
