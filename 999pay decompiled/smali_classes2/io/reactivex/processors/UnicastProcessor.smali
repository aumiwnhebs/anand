...
# virtual methods
.method checkTerminated(ZZZLw5/c;Lio/reactivex/internal/queue/SpscLinkedArrayQueue;)Z
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(ZZZ",
    ...
    .line 33
    .line 34
    invoke-interface {p4, p1}, Lw5/c;->onError(Ljava/lang/Throwable;)V
    ...
    .line 53
    :cond_2
    invoke-interface {p4}, Lw5/c;->onComplete()V
...
.method drain()V
    ...
    invoke-virtual {p0, v0}, Lio/reactivex/processors/UnicastProcessor;->drainFused(Lw5/c;)V

    goto :goto_1

    :cond_1
    invoke-virtual {p0, v0}, Lio/reactivex/processors/UnicastProcessor;->drainRegular(Lw5/c;)V
...
.method drainFused(Lw5/c;)V
    ...
    .line 45
    :cond_2
    invoke-interface {p1, v4}, Lw5/c;->onNext(Ljava/lang/Object;)V
...
.method drainRegular(Lw5/c;)V
    ...
    .line 47
    invoke-virtual/range {v0 .. v5}, Lio/reactivex/processors/UnicastProcessor;->checkTerminated(ZZZLw5/c;Lio/reactivex/internal/queue/SpscLinkedArrayQueue;)Z
    ...
    .line 59
    :cond_2
    invoke-interface {v5, v8}, Lw5/c;->onNext(Ljava/lang/Object;)V
