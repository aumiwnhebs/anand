...
# static fields
.field static final g:Lio/grpc/c$c;
...
.field final e:Lio/grpc/internal/q0;

.field final f:Lio/grpc/internal/M;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lio/grpc/internal/b0$b;->g:Lio/grpc/c$c;
...
.method constructor <init>(Ljava/util/Map;ZII)V
    ...
    invoke-static {p1}, Lio/grpc/internal/u0;->w(Ljava/util/Map;)Ljava/lang/Long;

    move-result-object v0

    iput-object v0, p0, Lio/grpc/internal/b0$b;->a:Ljava/lang/Long;

    invoke-static {p1}, Lio/grpc/internal/u0;->x(Ljava/util/Map;)Ljava/lang/Boolean;

    move-result-object v0

    iput-object v0, p0, Lio/grpc/internal/b0$b;->b:Ljava/lang/Boolean;

    invoke-static {p1}, Lio/grpc/internal/u0;->l(Ljava/util/Map;)Ljava/lang/Integer;
    ...
    :cond_1
    invoke-static {p1}, Lio/grpc/internal/u0;->k(Ljava/util/Map;)Ljava/lang/Integer;
    ...
    invoke-static {p1}, Lio/grpc/internal/u0;->r(Ljava/util/Map;)Ljava/util/Map;
    ...
    :cond_5
    invoke-static {v1, p3}, Lio/grpc/internal/b0$b;->b(Ljava/util/Map;I)Lio/grpc/internal/q0;

    move-result-object p3

    :goto_3
    iput-object p3, p0, Lio/grpc/internal/b0$b;->e:Lio/grpc/internal/q0;

    if-eqz p2, :cond_6

    invoke-static {p1}, Lio/grpc/internal/u0;->d(Ljava/util/Map;)Ljava/util/Map;
    ...
    :cond_7
    invoke-static {p1, p4}, Lio/grpc/internal/b0$b;->a(Ljava/util/Map;I)Lio/grpc/internal/M;

    move-result-object v0

    :goto_5
    iput-object v0, p0, Lio/grpc/internal/b0$b;->f:Lio/grpc/internal/M;

    return-void
.end method

.method private static a(Ljava/util/Map;I)Lio/grpc/internal/M;
    .locals 7

    .line 1
    invoke-static {p0}, Lio/grpc/internal/u0;->h(Ljava/util/Map;)Ljava/lang/Integer;
    ...
    invoke-static {p0}, Lio/grpc/internal/u0;->c(Ljava/util/Map;)Ljava/lang/Long;
    ...
    invoke-static {p0}, Lio/grpc/internal/u0;->p(Ljava/util/Map;)Ljava/util/Set;

    move-result-object p0

    invoke-direct {v2, p1, v0, v1, p0}, Lio/grpc/internal/M;-><init>(IJLjava/util/Set;)V

    return-object v2
.end method

.method private static b(Ljava/util/Map;I)Lio/grpc/internal/q0;
    .locals 15

    .line 1
    invoke-static {p0}, Lio/grpc/internal/u0;->i(Ljava/util/Map;)Ljava/lang/Integer;
    ...
    invoke-static {p0}, Lio/grpc/internal/u0;->e(Ljava/util/Map;)Ljava/lang/Long;
    ...
    invoke-static {p0}, Lio/grpc/internal/u0;->j(Ljava/util/Map;)Ljava/lang/Long;
    ...
    invoke-static {p0}, Lio/grpc/internal/u0;->a(Ljava/util/Map;)Ljava/lang/Double;
    ...
    invoke-static {p0}, Lio/grpc/internal/u0;->q(Ljava/util/Map;)Ljava/lang/Long;
    ...
    invoke-static {p0}, Lio/grpc/internal/u0;->s(Ljava/util/Map;)Ljava/util/Set;
    ...
    invoke-direct/range {v4 .. v13}, Lio/grpc/internal/q0;-><init>(IJJDLjava/lang/Long;Ljava/util/Set;)V
...
.method public equals(Ljava/lang/Object;)Z
    ...
    iget-object v0, p0, Lio/grpc/internal/b0$b;->e:Lio/grpc/internal/q0;

    iget-object v2, p1, Lio/grpc/internal/b0$b;->e:Lio/grpc/internal/q0;
    ...
    iget-object v0, p0, Lio/grpc/internal/b0$b;->f:Lio/grpc/internal/M;

    iget-object p1, p1, Lio/grpc/internal/b0$b;->f:Lio/grpc/internal/M;
...
.method public hashCode()I
    ...
    iget-object v4, p0, Lio/grpc/internal/b0$b;->e:Lio/grpc/internal/q0;

    iget-object v5, p0, Lio/grpc/internal/b0$b;->f:Lio/grpc/internal/M;
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v2, p0, Lio/grpc/internal/b0$b;->e:Lio/grpc/internal/q0;
    ...
    iget-object v2, p0, Lio/grpc/internal/b0$b;->f:Lio/grpc/internal/M;
