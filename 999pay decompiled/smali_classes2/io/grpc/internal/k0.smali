...
.field private static final e:Lio/grpc/internal/k0$c;

.field private static final f:Lcom/google/common/base/t;


# instance fields
.field private final a:Lcom/google/common/base/t;

.field private final b:Lio/grpc/internal/k0$c;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lio/grpc/internal/k0$a;

    invoke-direct {v0}, Lio/grpc/internal/k0$a;-><init>()V

    sput-object v0, Lio/grpc/internal/k0;->e:Lio/grpc/internal/k0$c;

    new-instance v0, Lio/grpc/internal/k0$b;

    invoke-direct {v0}, Lio/grpc/internal/k0$b;-><init>()V

    sput-object v0, Lio/grpc/internal/k0;->f:Lcom/google/common/base/t;
...
.method public constructor <init>()V
    ...
    .line 1
    sget-object v0, Lio/grpc/internal/k0;->f:Lcom/google/common/base/t;

    sget-object v1, Lio/grpc/internal/k0;->e:Lio/grpc/internal/k0$c;
    ...
    invoke-direct {p0, v0, v1, v2}, Lio/grpc/internal/k0;-><init>(Lcom/google/common/base/t;Lio/grpc/internal/k0$c;Ljava/lang/String;)V

    return-void
.end method

.method constructor <init>(Lcom/google/common/base/t;Lio/grpc/internal/k0$c;Ljava/lang/String;)V
    .locals 0
    ...
    iput-object p1, p0, Lio/grpc/internal/k0;->a:Lcom/google/common/base/t;

    invoke-static {p2}, Lcom/google/common/base/o;->r(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object p1

    check-cast p1, Lio/grpc/internal/k0$c;

    iput-object p1, p0, Lio/grpc/internal/k0;->b:Lio/grpc/internal/k0$c;

    if-eqz p3, :cond_0

    invoke-static {p3}, Lio/grpc/internal/k0;->d(Ljava/lang/String;)Ljava/net/InetSocketAddress;

    move-result-object p1

    :goto_0
    iput-object p1, p0, Lio/grpc/internal/k0;->c:Ljava/net/InetSocketAddress;
...
.method static synthetic b()Ljava/util/logging/Logger;
    ...
    .line 1
    sget-object v0, Lio/grpc/internal/k0;->d:Ljava/util/logging/Logger;
...
.method private c(Ljava/net/InetSocketAddress;)Lio/grpc/ProxiedSocketAddress;
    ...
    iget-object v1, p0, Lio/grpc/internal/k0;->a:Lcom/google/common/base/t;
    ...
    sget-object p1, Lio/grpc/internal/k0;->d:Ljava/util/logging/Logger;
    ...
    iget-object v2, p0, Lio/grpc/internal/k0;->b:Lio/grpc/internal/k0$c;
    ...
    invoke-interface/range {v2 .. v8}, Lio/grpc/internal/k0$c;->a(Ljava/lang/String;Ljava/net/InetAddress;ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/net/PasswordAuthentication;
    ...
    sget-object v1, Lio/grpc/internal/k0;->d:Ljava/util/logging/Logger;
...
.method public a(Ljava/net/SocketAddress;)Lio/grpc/ProxiedSocketAddress;
    ...
    :cond_0
    iget-object v0, p0, Lio/grpc/internal/k0;->c:Ljava/net/InetSocketAddress;
    ...
    iget-object v1, p0, Lio/grpc/internal/k0;->c:Ljava/net/InetSocketAddress;
    ...
    invoke-direct {p0, p1}, Lio/grpc/internal/k0;->c(Ljava/net/InetSocketAddress;)Lio/grpc/ProxiedSocketAddress;
