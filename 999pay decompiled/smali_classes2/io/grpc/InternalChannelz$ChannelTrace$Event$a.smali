...
.field private d:Lio/grpc/G;

.field private e:Lio/grpc/G;
...
.method public a()Lio/grpc/InternalChannelz$ChannelTrace$Event;
    ...
    iget-object v0, p0, Lio/grpc/InternalChannelz$ChannelTrace$Event$a;->d:Lio/grpc/G;

    if-eqz v0, :cond_1

    iget-object v0, p0, Lio/grpc/InternalChannelz$ChannelTrace$Event$a;->e:Lio/grpc/G;
    ...
    iget-object v7, p0, Lio/grpc/InternalChannelz$ChannelTrace$Event$a;->d:Lio/grpc/G;

    iget-object v8, p0, Lio/grpc/InternalChannelz$ChannelTrace$Event$a;->e:Lio/grpc/G;

    const/4 v9, 0x0

    move-object v2, v0

    invoke-direct/range {v2 .. v9}, Lio/grpc/InternalChannelz$ChannelTrace$Event;-><init>(Ljava/lang/String;Lio/grpc/InternalChannelz$ChannelTrace$Event$Severity;JLio/grpc/G;Lio/grpc/G;Lio/grpc/InternalChannelz$a;)V
...
.method public d(Lio/grpc/G;)Lio/grpc/InternalChannelz$ChannelTrace$Event$a;
    .locals 0

    .line 1
    iput-object p1, p0, Lio/grpc/InternalChannelz$ChannelTrace$Event$a;->e:Lio/grpc/G;
