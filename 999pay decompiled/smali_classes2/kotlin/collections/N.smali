...
.method public static i(Ljava/util/Map;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {p0, p1}, Lkotlin/collections/L;->a(Ljava/util/Map;Ljava/lang/Object;)Ljava/lang/Object;
...
.method public static final j(Ljava/util/Map;)Ljava/util/Map;
    ...
    :cond_0
    invoke-static {p0}, Lkotlin/collections/M;->g(Ljava/util/Map;)Ljava/util/Map;
...
.method public static k(Ljava/util/Map;Lkotlin/Pair;)Ljava/util/Map;
    ...
    invoke-static {p1}, Lkotlin/collections/M;->f(Lkotlin/Pair;)Ljava/util/Map;
...
.method public static m(Ljava/lang/Iterable;)Ljava/util/Map;
    ...
    invoke-static {p0, v1}, Lkotlin/collections/N;->n(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;
    ...
    :goto_1
    invoke-static {p0}, Lkotlin/collections/M;->f(Lkotlin/Pair;)Ljava/util/Map;
    ...
    invoke-static {p0, v0}, Lkotlin/collections/N;->n(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;

    move-result-object p0

    invoke-static {p0}, Lkotlin/collections/N;->j(Ljava/util/Map;)Ljava/util/Map;
...
.method public static final n(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;
    ...
    invoke-static {p1, p0}, Lkotlin/collections/N;->l(Ljava/util/Map;Ljava/lang/Iterable;)V
...
.method public static o(Ljava/util/Map;)Ljava/util/Map;
    ...
    invoke-static {p0}, Lkotlin/collections/N;->p(Ljava/util/Map;)Ljava/util/Map;
