...
.method static clearCache(Landroid/content/Context;I)V
    ...
    const-string v0, "Starting cache prune, deleting files older than %d days"
...
.method public static createImageFile(Landroid/content/Context;)Ljava/io/File;
    ...
    invoke-static {p0, v1, v0}, Lcom/just/agentweb/AgentWebUtils;->createFileByName(Landroid/content/Context;Ljava/lang/String;Z)Ljava/io/File;
...
.method static getDiskExternalCacheDir(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-static {p0}, Landroidx/core/os/g;->a(Ljava/io/File;)Ljava/lang/String;
...
.method private static getRealPathBelowVersion(Landroid/content/Context;Landroid/net/Uri;)Ljava/lang/String;
    ...
    invoke-virtual {v8}, Landroidx/loader/content/b;->w()Landroid/database/Cursor;
...
.method public static hasPermission(Landroid/content/Context;Ljava/util/List;)Z
    ...
    :cond_2
    invoke-static {v0}, Landroidx/core/app/e;->d(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p0, v0, v1}, Landroidx/core/app/e;->b(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)I
...
.method static show(Landroid/view/View;Ljava/lang/CharSequence;IIILjava/lang/CharSequence;ILandroid/view/View$OnClickListener;)V
    ...
    invoke-static {p0, v0, p2}, Lcom/google/android/material/snackbar/Snackbar;->d0(Landroid/view/View;Ljava/lang/CharSequence;I)Lcom/google/android/material/snackbar/Snackbar;
    ...
    invoke-virtual {p0, p6}, Lcom/google/android/material/snackbar/Snackbar;->g0(I)Lcom/google/android/material/snackbar/Snackbar;

    invoke-virtual {p0, p5, p7}, Lcom/google/android/material/snackbar/Snackbar;->f0(Ljava/lang/CharSequence;Landroid/view/View$OnClickListener;)Lcom/google/android/material/snackbar/Snackbar;
...
.method public static showFileChooserCompat(Landroid/app/Activity;Landroid/webkit/WebView;Landroid/webkit/ValueCallback;Landroid/webkit/WebChromeClient$FileChooserParams;Lcom/just/agentweb/PermissionInterceptor;Landroid/webkit/ValueCallback;Ljava/lang/String;Landroid/os/Handler$Callback;)Z
    ...
    :try_start_0
    const-class v4, Lcom/just/agentweb/filechooser/FileChooser;

    sget v5, Lcom/just/agentweb/filechooser/FileChooser;->REQUEST_CODE:I
    ...
    :try_start_1
    const-string v4, "setUriValueCallbacks"
    ...
    const-string v4, "setFileChooserParams"

    new-array v5, v1, [Ljava/lang/Class;

    const-class v6, Landroid/webkit/WebChromeClient$FileChooserParams;
    ...
    invoke-interface {p5, v3}, Landroid/webkit/ValueCallback;->onReceiveValue(Ljava/lang/Object;)V
