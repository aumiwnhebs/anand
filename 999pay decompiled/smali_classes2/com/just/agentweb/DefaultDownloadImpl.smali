...
.method protected createResourceRequest(Ljava/lang/String;)Lcom/download/library/w;
    ...
    invoke-virtual {v0, p1}, Lcom/download/library/d;->h(Ljava/lang/String;)Lcom/download/library/w;
...
.method protected forceDownload(Ljava/lang/String;)V
    ...
    check-cast v0, Lcom/download/library/w;

    const/4 v1, 0x1

    invoke-virtual {v0, v1}, Lcom/download/library/w;->i(Z)Lcom/download/library/w;
...
.method protected isForceRequest(Ljava/lang/String;)Z
    ...
    check-cast p1, Lcom/download/library/w;

    if-eqz p1, :cond_0

    invoke-virtual {p1}, Lcom/download/library/w;->d()Lcom/download/library/DownloadTask;

    move-result-object p1

    invoke-virtual {p1}, Lcom/download/library/Extra;->isForceDownload()Z
...
.method protected onDownloadStartInternal(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;J)V
    ...
    :cond_1
    invoke-virtual {p0, p1}, Lcom/just/agentweb/DefaultDownloadImpl;->createResourceRequest(Ljava/lang/String;)Lcom/download/library/w;
...
.method protected performDownload(Ljava/lang/String;)V
    ...
    invoke-static {v2}, Lcom/download/library/d;->d(Landroid/content/Context;)Lcom/download/library/d;

    move-result-object v2

    invoke-virtual {v2, p1}, Lcom/download/library/d;->c(Ljava/lang/String;)Z
    ...
    invoke-virtual {v0, p1}, Lcom/download/library/d;->c(Ljava/lang/String;)Z
    ...
    invoke-virtual {v0, v1, p1}, Lcom/download/library/w;->a(Ljava/lang/String;Ljava/lang/String;)Lcom/download/library/w;

    invoke-virtual {p0, v0}, Lcom/just/agentweb/DefaultDownloadImpl;->taskEnqueue(Lcom/download/library/w;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
