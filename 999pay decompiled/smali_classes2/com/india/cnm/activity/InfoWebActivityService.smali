.class public Lcom/india/cnm/activity/InfoWebActivityService;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/india/cnm/activity/InfoWebActivityService$WebChromeClient;
    }
.end annotation


# static fields
.field public static final TAG:Ljava/lang/String; = "InfoWebActivityService"
...
.method public constructor <init>()V
    ...
    iput v0, p0, Lcom/india/cnm/activity/InfoWebActivityService;->from:I

    const-string v0, ""

    iput-object v0, p0, Lcom/india/cnm/activity/InfoWebActivityService;->ldyUrl:Ljava/lang/String;

    iput-object v0, p0, Lcom/india/cnm/activity/InfoWebActivityService;->title:Ljava/lang/String;

    new-instance v0, Lcom/india/cnm/activity/InfoWebActivityService$1;

    invoke-direct {v0, p0}, Lcom/india/cnm/activity/InfoWebActivityService$1;-><init>(Lcom/india/cnm/activity/InfoWebActivityService;)V

    iput-object v0, p0, Lcom/india/cnm/activity/InfoWebActivityService;->mWebViewClient:Lcom/just/agentweb/WebViewClient;

    new-instance v0, Lcom/india/cnm/activity/InfoWebActivityService$2;

    invoke-direct {v0, p0}, Lcom/india/cnm/activity/InfoWebActivityService$2;-><init>(Lcom/india/cnm/activity/InfoWebActivityService;)V

    iput-object v0, p0, Lcom/india/cnm/activity/InfoWebActivityService;->mWebChromeClient:Lcom/just/agentweb/WebChromeClient;

    return-void
.end method

.method static synthetic access$000(Lcom/india/cnm/activity/InfoWebActivityService;)Landroid/app/Activity;
    .locals 0
...
.method static synthetic access$100(Lcom/india/cnm/activity/InfoWebActivityService;)Landroid/app/Activity;
    .locals 0
...
.method static synthetic access$200(Lcom/india/cnm/activity/InfoWebActivityService;)Landroid/app/Activity;
    .locals 0
...
.method static synthetic access$300(Lcom/india/cnm/activity/InfoWebActivityService;)Landroid/app/Activity;
    .locals 0
...
.method static bridge synthetic k(Lcom/india/cnm/activity/InfoWebActivityService;Ljava/lang/String;)Ljava/io/File;
    .locals 0

    .line 1
    invoke-direct {p0, p1}, Lcom/india/cnm/activity/InfoWebActivityService;->getLocalFontFile(Ljava/lang/String;)Ljava/io/File;
...
.method static bridge synthetic l(Lcom/india/cnm/activity/InfoWebActivityService;Ljava/lang/String;)Z
    .locals 0

    .line 1
    invoke-direct {p0, p1}, Lcom/india/cnm/activity/InfoWebActivityService;->isAutoGeneratedHashName(Ljava/lang/String;)Z
...
.method static bridge synthetic m(Lcom/india/cnm/activity/InfoWebActivityService;Ljava/lang/String;)Z
    .locals 0

    .line 1
    invoke-direct {p0, p1}, Lcom/india/cnm/activity/InfoWebActivityService;->isFontRequest(Ljava/lang/String;)Z
...
.method static bridge synthetic n(Lcom/india/cnm/activity/InfoWebActivityService;Ljava/lang/String;)Z
    .locals 0

    .line 1
    invoke-direct {p0, p1}, Lcom/india/cnm/activity/InfoWebActivityService;->isImageRequest(Ljava/lang/String;)Z
...
.method static bridge synthetic o(Lcom/india/cnm/activity/InfoWebActivityService;Ljava/lang/String;)Ljava/lang/String;
    .locals 0

    .line 1
    invoke-direct {p0, p1}, Lcom/india/cnm/activity/InfoWebActivityService;->normalizePath(Ljava/lang/String;)Ljava/lang/String;
...
.method public static start(Landroid/content/Context;I)V
    ...
    const-class v1, Lcom/india/cnm/activity/InfoWebActivityService;
...
.method protected getMiddlewareWebClient()Lcom/just/agentweb/MiddlewareWebClientBase;
    ...
    new-instance v0, Lcom/india/cnm/activity/InfoWebActivityService$3;

    invoke-direct {v0, p0}, Lcom/india/cnm/activity/InfoWebActivityService$3;-><init>(Lcom/india/cnm/activity/InfoWebActivityService;)V

    iput-object v0, p0, Lcom/india/cnm/activity/InfoWebActivityService;->mMiddleWareWebClient:Lcom/just/agentweb/MiddlewareWebClientBase;
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    iput p1, p0, Lcom/india/cnm/activity/InfoWebActivityService;->from:I

    invoke-static {}, Lcom/india/cnm/utils/SP;->getUserAgent()Ljava/lang/String;

    move-result-object p1

    iput-object p1, p0, Lcom/india/cnm/activity/InfoWebActivityService;->mUserAgent:Ljava/lang/String;
    ...
    iput-object p1, p0, Lcom/india/cnm/activity/InfoWebActivityService;->ldyUrl:Ljava/lang/String;
    ...
    iput-object p1, p0, Lcom/india/cnm/activity/InfoWebActivityService;->title:Ljava/lang/String;

    new-instance p1, Ljava/lang/StringBuilder;

    invoke-direct {p1}, Ljava/lang/StringBuilder;-><init>()V

    const-string v0, "onCrea22te: "

    invoke-virtual {p1, v0}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v0, p0, Lcom/india/cnm/activity/InfoWebActivityService;->ldyUrl:Ljava/lang/String;
    ...
    const-string v3, "\u5ba2\u670d\u54a8\u8be2"

    packed-switch p1, :pswitch_data_0

    iget-object p1, p0, Lcom/india/cnm/activity/InfoWebActivityService;->tvTitle:Landroid/widget/TextView;

    iget-object v0, p0, Lcom/india/cnm/activity/InfoWebActivityService;->title:Ljava/lang/String;
    ...
    iget-object v0, p0, Lcom/india/cnm/activity/InfoWebActivityService;->mLinearLayout:Landroid/widget/LinearLayout;
    ...
    iget-object v0, p0, Lcom/india/cnm/activity/InfoWebActivityService;->mWebChromeClient:Lcom/just/agentweb/WebChromeClient;
    ...
    iget-object v0, p0, Lcom/india/cnm/activity/InfoWebActivityService;->mWebViewClient:Lcom/just/agentweb/WebViewClient;
    ...
    invoke-virtual {p0}, Lcom/india/cnm/activity/InfoWebActivityService;->getMiddlewareWebClient()Lcom/just/agentweb/MiddlewareWebClientBase;
    ...
    iput-object p1, p0, Lcom/india/cnm/activity/InfoWebActivityService;->mAgentWeb:Lcom/just/agentweb/AgentWeb;
    ...
    iget-object p1, p0, Lcom/india/cnm/activity/InfoWebActivityService;->mAgentWeb:Lcom/just/agentweb/AgentWeb;
    ...
    iget-object v3, p0, Lcom/india/cnm/activity/InfoWebActivityService;->mUserAgent:Ljava/lang/String;
    ...
    iget-object v2, p0, Lcom/india/cnm/activity/InfoWebActivityService;->mUserAgent:Ljava/lang/String;
...
.method protected onDestroy()V
    ...
    iget-object v0, p0, Lcom/india/cnm/activity/InfoWebActivityService;->mAgentWeb:Lcom/just/agentweb/AgentWeb;
