...
.method constructor <init>(Landroidx/recyclerview/widget/e$b;Ljava/util/List;[I[IZ)V
    ...
    invoke-virtual {p1}, Landroidx/recyclerview/widget/e$b;->getOldListSize()I

    move-result p2

    iput p2, p0, Landroidx/recyclerview/widget/e$c;->e:I

    invoke-virtual {p1}, Landroidx/recyclerview/widget/e$b;->getNewListSize()I
    ...
    invoke-direct {p0}, Landroidx/recyclerview/widget/e$c;->g()V
...
.method private b(Ljava/util/List;Landroidx/recyclerview/widget/m;III)V
    ...
    invoke-interface {p2, p3, p4}, Landroidx/recyclerview/widget/m;->onInserted(II)V
    ...
    invoke-static {p1, v1, v0}, Landroidx/recyclerview/widget/e$c;->i(Ljava/util/List;IZ)Landroidx/recyclerview/widget/e$d;

    move-result-object v5

    iget v5, v5, Landroidx/recyclerview/widget/e$d;->b:I

    invoke-interface {p2, v5, p3}, Landroidx/recyclerview/widget/m;->onMoved(II)V

    if-ne v3, v4, :cond_4

    iget-object v3, p0, Landroidx/recyclerview/widget/e$c;->d:Landroidx/recyclerview/widget/e$b;

    invoke-virtual {v3, v1, v2}, Landroidx/recyclerview/widget/e$b;->getChangePayload(II)Ljava/lang/Object;

    move-result-object v1

    invoke-interface {p2, p3, v0, v1}, Landroidx/recyclerview/widget/m;->onChanged(IILjava/lang/Object;)V

    goto :goto_2

    :cond_3
    invoke-interface {p2, p3, v0}, Landroidx/recyclerview/widget/m;->onInserted(II)V
...
.method private c(Ljava/util/List;Landroidx/recyclerview/widget/m;III)V
    .locals 8
    ...
    invoke-interface {p2, p3, p4}, Landroidx/recyclerview/widget/m;->onRemoved(II)V
    ...
    invoke-static {p1, v1, v5}, Landroidx/recyclerview/widget/e$c;->i(Ljava/util/List;IZ)Landroidx/recyclerview/widget/e$d;
    ...
    invoke-interface {p2, v6, v7}, Landroidx/recyclerview/widget/m;->onMoved(II)V

    if-ne v3, v4, :cond_4

    iget v3, v5, Landroidx/recyclerview/widget/e$d;->b:I

    sub-int/2addr v3, v0

    iget-object v4, p0, Landroidx/recyclerview/widget/e$c;->d:Landroidx/recyclerview/widget/e$b;

    invoke-virtual {v4, v2, v1}, Landroidx/recyclerview/widget/e$b;->getChangePayload(II)Ljava/lang/Object;

    move-result-object v1

    invoke-interface {p2, v3, v0, v1}, Landroidx/recyclerview/widget/m;->onChanged(IILjava/lang/Object;)V
    ...
    invoke-interface {p2, v1, v0}, Landroidx/recyclerview/widget/m;->onRemoved(II)V
...
.method private e(III)V
    ...
    invoke-direct {p0, p1, p2, p3, v0}, Landroidx/recyclerview/widget/e$c;->f(IIIZ)Z
...
.method private f(IIIZ)Z
    ...
    invoke-virtual {p2, v1, v0}, Landroidx/recyclerview/widget/e$b;->areItemsTheSame(II)Z
    ...
    invoke-virtual {p1, v1, v0}, Landroidx/recyclerview/widget/e$b;->areContentsTheSame(II)Z
    ...
    invoke-virtual {v1, v0, p2}, Landroidx/recyclerview/widget/e$b;->areItemsTheSame(II)Z
    ...
    invoke-virtual {p3, v0, p2}, Landroidx/recyclerview/widget/e$b;->areContentsTheSame(II)Z
...
.method private g()V
    ...
    invoke-direct {p0, v0, v1, v2}, Landroidx/recyclerview/widget/e$c;->e(III)V
    ...
    invoke-direct {p0, v0, v1, v2}, Landroidx/recyclerview/widget/e$c;->h(III)V
    ...
    invoke-virtual {v6, v1, v5}, Landroidx/recyclerview/widget/e$b;->areContentsTheSame(II)Z
...
.method private static i(Ljava/util/List;IZ)Landroidx/recyclerview/widget/e$d;
    .locals 5
...
.method public d(Landroidx/recyclerview/widget/m;)V
    ...
    invoke-direct {v0, p1}, Landroidx/recyclerview/widget/b;-><init>(Landroidx/recyclerview/widget/m;)V
    ...
    invoke-direct/range {v1 .. v6}, Landroidx/recyclerview/widget/e$c;->c(Ljava/util/List;Landroidx/recyclerview/widget/m;III)V
    ...
    invoke-direct/range {v1 .. v6}, Landroidx/recyclerview/widget/e$c;->b(Ljava/util/List;Landroidx/recyclerview/widget/m;III)V
    ...
    invoke-virtual {v3, v2, v4}, Landroidx/recyclerview/widget/e$b;->getChangePayload(II)Ljava/lang/Object;

    move-result-object v2

    invoke-virtual {p1, v1, v7, v2}, Landroidx/recyclerview/widget/b;->onChanged(IILjava/lang/Object;)V
