...
.method private H(Landroidx/recyclerview/widget/RecyclerView$C;IIJ)Z
    ...
    invoke-virtual {p4, p1, p2}, Landroidx/recyclerview/widget/RecyclerView$g;->bindViewHolder(Landroidx/recyclerview/widget/RecyclerView$C;I)V
    ...
    invoke-direct {p0, p1}, Landroidx/recyclerview/widget/RecyclerView$v;->b(Landroidx/recyclerview/widget/RecyclerView$C;)V
    ...
    iput p3, p1, Landroidx/recyclerview/widget/RecyclerView$C;->mPreLayoutPosition:I
...
.method private b(Landroidx/recyclerview/widget/RecyclerView$C;)V
    ...
    invoke-static {p1}, Landroidx/core/view/N;->C(Landroid/view/View;)I
    ...
    invoke-static {p1, v0}, Landroidx/core/view/N;->E0(Landroid/view/View;I)V
    ...
    :cond_1
    invoke-virtual {v0}, Landroidx/recyclerview/widget/r;->n()Landroidx/core/view/a;
...
.method public B(Landroid/view/View;)V
    ...
    :cond_2
    :goto_0
    invoke-virtual {p0, v0}, Landroidx/recyclerview/widget/RecyclerView$v;->C(Landroidx/recyclerview/widget/RecyclerView$C;)V
...
.method C(Landroidx/recyclerview/widget/RecyclerView$C;)V
    ...
    invoke-virtual {v3, p1}, Landroidx/recyclerview/widget/RecyclerView$g;->onFailedToRecycleView(Landroidx/recyclerview/widget/RecyclerView$C;)Z
    ...
    invoke-virtual {p1, v3}, Landroidx/recyclerview/widget/RecyclerView$C;->hasAnyOfTheFlags(I)Z
    ...
    iget v5, p1, Landroidx/recyclerview/widget/RecyclerView$C;->mPosition:I
    ...
    iget v4, v4, Landroidx/recyclerview/widget/RecyclerView$C;->mPosition:I
    ...
    invoke-virtual {v3, p1}, Landroidx/recyclerview/widget/w;->q(Landroidx/recyclerview/widget/RecyclerView$C;)V
...
.method D(Landroid/view/View;)V
    ...
    invoke-virtual {p1, p0, v0}, Landroidx/recyclerview/widget/RecyclerView$C;->setScrapContainer(Landroidx/recyclerview/widget/RecyclerView$v;Z)V
...
.method I(IZJ)Landroidx/recyclerview/widget/RecyclerView$C;
    ...
    invoke-virtual/range {p0 .. p1}, Landroidx/recyclerview/widget/RecyclerView$v;->h(I)Landroidx/recyclerview/widget/RecyclerView$C;
    ...
    invoke-virtual/range {p0 .. p2}, Landroidx/recyclerview/widget/RecyclerView$v;->m(IZ)Landroidx/recyclerview/widget/RecyclerView$C;

    move-result-object v1

    if-eqz v1, :cond_6

    invoke-virtual {v6, v1}, Landroidx/recyclerview/widget/RecyclerView$v;->L(Landroidx/recyclerview/widget/RecyclerView$C;)Z
    ...
    invoke-virtual {v1, v5}, Landroidx/recyclerview/widget/RecyclerView$C;->addFlags(I)V

    invoke-virtual {v1}, Landroidx/recyclerview/widget/RecyclerView$C;->isScrap()Z
    ...
    iget-object v9, v1, Landroidx/recyclerview/widget/RecyclerView$C;->itemView:Landroid/view/View;

    invoke-virtual {v5, v9, v8}, Landroidx/recyclerview/widget/RecyclerView;->removeDetachedView(Landroid/view/View;Z)V

    invoke-virtual {v1}, Landroidx/recyclerview/widget/RecyclerView$C;->unScrap()V

    goto :goto_1

    :cond_2
    invoke-virtual {v1}, Landroidx/recyclerview/widget/RecyclerView$C;->wasReturnedFromScrap()Z

    move-result v5

    if-eqz v5, :cond_3

    invoke-virtual {v1}, Landroidx/recyclerview/widget/RecyclerView$C;->clearReturnedFromScrapFlag()V

    :cond_3
    :goto_1
    invoke-virtual {v6, v1}, Landroidx/recyclerview/widget/RecyclerView$v;->C(Landroidx/recyclerview/widget/RecyclerView$C;)V
    ...
    invoke-virtual {v6, v10, v11, v9, v0}, Landroidx/recyclerview/widget/RecyclerView$v;->l(JIZ)Landroidx/recyclerview/widget/RecyclerView$C;

    move-result-object v1

    if-eqz v1, :cond_7

    iput v5, v1, Landroidx/recyclerview/widget/RecyclerView$C;->mPosition:I
    ...
    invoke-virtual {v0, v9}, Landroidx/recyclerview/widget/RecyclerView$u;->f(I)Landroidx/recyclerview/widget/RecyclerView$C;

    move-result-object v0

    if-eqz v0, :cond_8

    invoke-virtual {v0}, Landroidx/recyclerview/widget/RecyclerView$C;->resetInternal()V

    sget-boolean v1, Landroidx/recyclerview/widget/RecyclerView;->FORCE_INVALIDATE_DISPLAY_LIST:Z

    if-eqz v1, :cond_8

    invoke-direct {v6, v0}, Landroidx/recyclerview/widget/RecyclerView$v;->r(Landroidx/recyclerview/widget/RecyclerView$C;)V
    ...
    invoke-virtual {v5, v2, v9}, Landroidx/recyclerview/widget/RecyclerView$g;->createViewHolder(Landroid/view/ViewGroup;I)Landroidx/recyclerview/widget/RecyclerView$C;
    ...
    iput-object v10, v2, Landroidx/recyclerview/widget/RecyclerView$C;->mNestedRecyclerView:Ljava/lang/ref/WeakReference;
    ...
    invoke-virtual {v9, v0}, Landroidx/recyclerview/widget/RecyclerView$C;->hasAnyOfTheFlags(I)Z

    move-result v1

    if-eqz v1, :cond_e

    invoke-virtual {v9, v8, v0}, Landroidx/recyclerview/widget/RecyclerView$C;->setFlags(II)V
    ...
    invoke-static {v9}, Landroidx/recyclerview/widget/RecyclerView$l;->e(Landroidx/recyclerview/widget/RecyclerView$C;)I
    ...
    invoke-virtual {v9}, Landroidx/recyclerview/widget/RecyclerView$C;->getUnmodifiedPayloads()Ljava/util/List;

    move-result-object v4

    invoke-virtual {v2, v1, v9, v0, v4}, Landroidx/recyclerview/widget/RecyclerView$l;->t(Landroidx/recyclerview/widget/RecyclerView$z;Landroidx/recyclerview/widget/RecyclerView$C;ILjava/util/List;)Landroidx/recyclerview/widget/RecyclerView$l$b;

    move-result-object v0

    iget-object v1, v6, Landroidx/recyclerview/widget/RecyclerView$v;->h:Landroidx/recyclerview/widget/RecyclerView;

    invoke-virtual {v1, v9, v0}, Landroidx/recyclerview/widget/RecyclerView;->recordAnimationInfoIfBouncedHiddenView(Landroidx/recyclerview/widget/RecyclerView$C;Landroidx/recyclerview/widget/RecyclerView$l$b;)V
    ...
    invoke-virtual {v9}, Landroidx/recyclerview/widget/RecyclerView$C;->isBound()Z

    move-result v0

    if-eqz v0, :cond_f

    iput v3, v9, Landroidx/recyclerview/widget/RecyclerView$C;->mPreLayoutPosition:I
    ...
    invoke-virtual {v9}, Landroidx/recyclerview/widget/RecyclerView$C;->needsUpdate()Z

    move-result v0

    if-nez v0, :cond_11

    invoke-virtual {v9}, Landroidx/recyclerview/widget/RecyclerView$C;->isInvalid()Z
    ...
    invoke-direct/range {v0 .. v5}, Landroidx/recyclerview/widget/RecyclerView$v;->H(Landroidx/recyclerview/widget/RecyclerView$C;IIJ)Z

    move-result v0

    :goto_7
    iget-object v1, v9, Landroidx/recyclerview/widget/RecyclerView$C;->itemView:Landroid/view/View;
    ...
    iget-object v2, v9, Landroidx/recyclerview/widget/RecyclerView$C;->itemView:Landroid/view/View;
    ...
    :goto_9
    iput-object v9, v1, Landroidx/recyclerview/widget/RecyclerView$p;->a:Landroidx/recyclerview/widget/RecyclerView$C;
...
.method J(Landroidx/recyclerview/widget/RecyclerView$C;)V
    ...
    iput-object v0, p1, Landroidx/recyclerview/widget/RecyclerView$C;->mScrapContainer:Landroidx/recyclerview/widget/RecyclerView$v;
...
.method L(Landroidx/recyclerview/widget/RecyclerView$C;)Z
    ...
    :cond_0
    iget v0, p1, Landroidx/recyclerview/widget/RecyclerView$C;->mPosition:I
    ...
    iget v2, p1, Landroidx/recyclerview/widget/RecyclerView$C;->mPosition:I
...
.method M(II)V
    ...
    :cond_0
    iget v2, v1, Landroidx/recyclerview/widget/RecyclerView$C;->mPosition:I
...
.method a(Landroidx/recyclerview/widget/RecyclerView$C;Z)V
    ...
    invoke-virtual {v1}, Landroidx/recyclerview/widget/r;->n()Landroidx/core/view/a;
    ...
    invoke-virtual {v1, v0}, Landroidx/recyclerview/widget/r$a;->n(Landroid/view/View;)Landroidx/core/view/a;
    ...
    :goto_0
    invoke-static {v0, v1}, Landroidx/core/view/N;->t0(Landroid/view/View;Landroidx/core/view/a;)V

    :cond_1
    if-eqz p2, :cond_2

    invoke-virtual {p0, p1}, Landroidx/recyclerview/widget/RecyclerView$v;->g(Landroidx/recyclerview/widget/RecyclerView$C;)V

    :cond_2
    iput-object v2, p1, Landroidx/recyclerview/widget/RecyclerView$C;->mOwnerRecyclerView:Landroidx/recyclerview/widget/RecyclerView;

    invoke-virtual {p0}, Landroidx/recyclerview/widget/RecyclerView$v;->i()Landroidx/recyclerview/widget/RecyclerView$u;

    move-result-object p2

    invoke-virtual {p2, p1}, Landroidx/recyclerview/widget/RecyclerView$u;->i(Landroidx/recyclerview/widget/RecyclerView$C;)V
...
.method d()V
    ...
    invoke-virtual {v3}, Landroidx/recyclerview/widget/RecyclerView$C;->clearOldPosition()V
...
.method g(Landroidx/recyclerview/widget/RecyclerView$C;)V
    ...
    invoke-virtual {v0, p1}, Landroidx/recyclerview/widget/RecyclerView$g;->onViewRecycled(Landroidx/recyclerview/widget/RecyclerView$C;)V
    ...
    invoke-virtual {v0, p1}, Landroidx/recyclerview/widget/w;->q(Landroidx/recyclerview/widget/RecyclerView$C;)V
...
.method h(I)Landroidx/recyclerview/widget/RecyclerView$C;
    ...
    invoke-virtual {v5}, Landroidx/recyclerview/widget/RecyclerView$C;->wasReturnedFromScrap()Z
    ...
    invoke-virtual {v5, v4}, Landroidx/recyclerview/widget/RecyclerView$C;->addFlags(I)V
    ...
    invoke-virtual {p1}, Landroidx/recyclerview/widget/RecyclerView$C;->wasReturnedFromScrap()Z
    ...
    invoke-virtual {p1, v4}, Landroidx/recyclerview/widget/RecyclerView$C;->addFlags(I)V
...
.method l(JIZ)Landroidx/recyclerview/widget/RecyclerView$C;
    ...
    invoke-virtual {v1}, Landroidx/recyclerview/widget/RecyclerView$C;->getItemViewType()I
    ...
    invoke-virtual {v1, p1}, Landroidx/recyclerview/widget/RecyclerView$C;->addFlags(I)V
    ...
    invoke-virtual {v1, p1, p2}, Landroidx/recyclerview/widget/RecyclerView$C;->setFlags(II)V
    ...
    invoke-virtual {v2}, Landroidx/recyclerview/widget/RecyclerView$C;->getItemId()J
    ...
    invoke-virtual {v2}, Landroidx/recyclerview/widget/RecyclerView$C;->isAttachedToTransitionOverlay()Z

    move-result v3

    if-nez v3, :cond_6

    invoke-virtual {v2}, Landroidx/recyclerview/widget/RecyclerView$C;->getItemViewType()I
...
.method m(IZ)Landroidx/recyclerview/widget/RecyclerView$C;
    ...
    invoke-virtual {v3}, Landroidx/recyclerview/widget/RecyclerView$C;->wasReturnedFromScrap()Z
    ...
    invoke-virtual {v3, p1}, Landroidx/recyclerview/widget/RecyclerView$C;->addFlags(I)V
    ...
    invoke-static {v0}, Landroidx/recyclerview/widget/RecyclerView;->getChildViewHolderInt(Landroid/view/View;)Landroidx/recyclerview/widget/RecyclerView$C;
    ...
    invoke-virtual {p1, p2}, Landroidx/recyclerview/widget/RecyclerView$C;->addFlags(I)V
    ...
    invoke-virtual {v2}, Landroidx/recyclerview/widget/RecyclerView$C;->getLayoutPosition()I
...
.method p(IZ)Landroid/view/View;
    ...
    invoke-virtual {p0, p1, p2, v0, v1}, Landroidx/recyclerview/widget/RecyclerView$v;->I(IZJ)Landroidx/recyclerview/widget/RecyclerView$C;
...
.method t()V
    ...
    invoke-virtual {v2, v3}, Landroidx/recyclerview/widget/RecyclerView$C;->addChangePayload(Ljava/lang/Object;)V
...
.method u(II)V
    ...
    iget v3, v2, Landroidx/recyclerview/widget/RecyclerView$C;->mPosition:I

    if-lt v3, p1, :cond_0

    const/4 v3, 0x1

    invoke-virtual {v2, p2, v3}, Landroidx/recyclerview/widget/RecyclerView$C;->offsetPosition(IZ)V
...
.method v(II)V
    ...
    invoke-virtual {v6, v7, v4}, Landroidx/recyclerview/widget/RecyclerView$C;->offsetPosition(IZ)V

    goto :goto_2

    :cond_2
    invoke-virtual {v6, v0, v4}, Landroidx/recyclerview/widget/RecyclerView$C;->offsetPosition(IZ)V
...
.method w(IIZ)V
    ...
    invoke-virtual {v2, v3, p3}, Landroidx/recyclerview/widget/RecyclerView$C;->offsetPosition(IZ)V
...
.method y(Landroid/view/View;)V
    ...
    invoke-virtual {p0, p1}, Landroidx/recyclerview/widget/RecyclerView$v;->C(Landroidx/recyclerview/widget/RecyclerView$C;)V
