...
.method static a(Landroid/content/Context;Landroidx/work/impl/F;)Landroidx/work/impl/t;
    .locals 3
    ...
    new-instance v0, Landroidx/work/impl/background/systemjob/m;

    invoke-direct {v0, p0, p1}, Landroidx/work/impl/background/systemjob/m;-><init>(Landroid/content/Context;Landroidx/work/impl/F;)V

    const-class p1, Landroidx/work/impl/background/systemjob/SystemJobService;

    invoke-static {p0, p1, v2}, LV/r;->a(Landroid/content/Context;Ljava/lang/Class;Z)V
...
.method public static b(Landroidx/work/a;Landroidx/work/impl/WorkDatabase;Ljava/util/List;)V
    ...
    invoke-interface {v0, p0}, LU/w;->g(I)Ljava/util/List;

    move-result-object p0

    const/16 v1, 0xc8

    invoke-interface {v0, v1}, LU/w;->t(I)Ljava/util/List;
    ...
    invoke-interface {v0, v5, v2, v3}, LU/w;->d(Ljava/lang/String;J)I
    ...
    invoke-interface {v0}, Landroidx/work/impl/t;->b()Z

    move-result v2

    if-eqz v2, :cond_2

    invoke-interface {v0, p0}, Landroidx/work/impl/t;->d([LU/v;)V
    ...
    invoke-interface {p2}, Landroidx/work/impl/t;->b()Z

    move-result v0

    if-nez v0, :cond_4

    invoke-interface {p2, p0}, Landroidx/work/impl/t;->d([LU/v;)V
