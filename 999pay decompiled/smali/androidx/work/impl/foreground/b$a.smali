...
.method public run()V
    ...
    invoke-static {v0}, Landroidx/work/impl/foreground/b;->b(Landroidx/work/impl/foreground/b;)Landroidx/work/impl/F;
    ...
    invoke-virtual {v0, v1}, Landroidx/work/impl/r;->h(Ljava/lang/String;)LU/v;

    move-result-object v0

    if-eqz v0, :cond_0

    invoke-virtual {v0}, LU/v;->h()Z
    ...
    iget-object v2, v0, Landroidx/work/impl/foreground/b;->m:LR/d;

    iget-object v0, v0, Landroidx/work/impl/foreground/b;->j:Ljava/util/Set;

    invoke-interface {v2, v0}, LR/d;->a(Ljava/lang/Iterable;)V
