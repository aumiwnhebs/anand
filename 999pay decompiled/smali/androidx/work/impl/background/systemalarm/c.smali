...
.method constructor <init>(Landroid/content/Context;ILandroidx/work/impl/background/systemalarm/g;)V
    ...
    invoke-direct {p2, p1, p3}, LR/e;-><init>(LT/n;LR/c;)V

    iput-object p2, p0, Landroidx/work/impl/background/systemalarm/c;->d:LR/e;
...
.method a()V
    ...
    invoke-virtual {v0}, Landroidx/work/impl/background/systemalarm/g;->g()Landroidx/work/impl/F;
    ...
    invoke-interface {v0}, LU/w;->i()Ljava/util/List;
    ...
    iget-object v1, p0, Landroidx/work/impl/background/systemalarm/c;->d:LR/e;

    invoke-virtual {v1, v0}, LR/e;->a(Ljava/lang/Iterable;)V
    ...
    iget-object v5, v4, LU/v;->a:Ljava/lang/String;
    ...
    iget-object v6, p0, Landroidx/work/impl/background/systemalarm/c;->d:LR/e;

    invoke-virtual {v6, v5}, LR/e;->d(Ljava/lang/String;)Z
    ...
    iget-object v2, v1, LU/v;->a:Ljava/lang/String;

    iget-object v3, p0, Landroidx/work/impl/background/systemalarm/c;->a:Landroid/content/Context;

    invoke-static {v1}, LU/y;->a(LU/v;)LU/m;

    move-result-object v1

    invoke-static {v3, v1}, Landroidx/work/impl/background/systemalarm/b;->b(Landroid/content/Context;LU/m;)Landroid/content/Intent;
    ...
    invoke-virtual {v2}, Landroidx/work/impl/background/systemalarm/g;->e()LW/c;
    ...
    :cond_3
    iget-object v0, p0, Landroidx/work/impl/background/systemalarm/c;->d:LR/e;

    invoke-virtual {v0}, LR/e;->reset()V
