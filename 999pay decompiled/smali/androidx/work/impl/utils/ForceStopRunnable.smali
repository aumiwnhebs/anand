...
.method public constructor <init>(Landroid/content/Context;Landroidx/work/impl/F;)V
    ...
    iput-object p2, p0, Landroidx/work/impl/utils/ForceStopRunnable;->b:Landroidx/work/impl/F;

    invoke-virtual {p2}, Landroidx/work/impl/F;->m()LV/s;

    move-result-object p1

    iput-object p1, p0, Landroidx/work/impl/utils/ForceStopRunnable;->c:LV/s;
...
.method public a()Z
    ...
    iget-object v1, p0, Landroidx/work/impl/utils/ForceStopRunnable;->b:Landroidx/work/impl/F;

    invoke-static {v0, v1}, Landroidx/work/impl/background/systemjob/m;->i(Landroid/content/Context;Landroidx/work/impl/F;)Z
    ...
    :try_start_0
    invoke-interface {v3}, LU/w;->k()Ljava/util/List;
    ...
    iget-object v10, v8, LU/v;->a:Ljava/lang/String;

    invoke-interface {v3, v9, v10}, LU/w;->h(Landroidx/work/WorkInfo$State;Ljava/lang/String;)I

    iget-object v8, v8, LU/v;->a:Ljava/lang/String;

    const-wide/16 v9, -0x1

    invoke-interface {v3, v8, v9, v10}, LU/w;->d(Ljava/lang/String;J)I

    goto :goto_2

    :cond_2
    invoke-interface {v4}, LU/r;->c()V
...
.method public b()V
    ...
    iget-object v0, p0, Landroidx/work/impl/utils/ForceStopRunnable;->b:Landroidx/work/impl/F;

    invoke-virtual {v0}, Landroidx/work/impl/F;->u()V

    iget-object v0, p0, Landroidx/work/impl/utils/ForceStopRunnable;->b:Landroidx/work/impl/F;

    invoke-virtual {v0}, Landroidx/work/impl/F;->m()LV/s;

    move-result-object v0

    const/4 v1, 0x0

    invoke-virtual {v0, v1}, LV/s;->e(Z)V
    ...
    iget-object v0, p0, Landroidx/work/impl/utils/ForceStopRunnable;->c:LV/s;

    invoke-static {}, Ljava/lang/System;->currentTimeMillis()J

    move-result-wide v1

    invoke-virtual {v0, v1, v2}, LV/s;->d(J)V
    ...
    iget-object v2, p0, Landroidx/work/impl/utils/ForceStopRunnable;->b:Landroidx/work/impl/F;

    invoke-virtual {v2}, Landroidx/work/impl/F;->o()Ljava/util/List;
...
.method public e()Z
    ...
    invoke-static {v1, v2, v4, v4}, LV/e;->a(Landroid/app/ActivityManager;Ljava/lang/String;II)Ljava/util/List;
    ...
    iget-object v2, p0, Landroidx/work/impl/utils/ForceStopRunnable;->c:LV/s;
    ...
    invoke-static {v6}, LV/f;->a(Ljava/lang/Object;)Landroid/app/ApplicationExitInfo;

    move-result-object v6

    invoke-static {v6}, LV/g;->a(Landroid/app/ApplicationExitInfo;)I
    ...
    invoke-static {v6}, LV/h;->a(Landroid/app/ApplicationExitInfo;)J
...
.method public run()V
    ...
    invoke-virtual {v0}, Landroidx/work/impl/F;->t()V
    ...
    invoke-virtual {v1}, Landroidx/work/impl/F;->t()V
