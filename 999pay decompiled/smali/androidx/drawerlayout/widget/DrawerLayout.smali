...
.field private final W:Landroidx/core/view/accessibility/K;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v2, p0, Landroidx/drawerlayout/widget/DrawerLayout;->W:Landroidx/core/view/accessibility/K;
    ...
    iput-object v1, p0, Landroidx/drawerlayout/widget/DrawerLayout;->n:Landroidx/drawerlayout/widget/DrawerLayout$g;

    const/high16 v4, 0x3f800000    # 1.0f

    invoke-static {p0, v4, v3}, Lx/c;->o(Landroid/view/ViewGroup;FLx/c$c;)Lx/c;

    move-result-object v5

    iput-object v5, p0, Landroidx/drawerlayout/widget/DrawerLayout;->g:Lx/c;

    invoke-virtual {v5, v0}, Lx/c;->N(I)V

    invoke-virtual {v5, v2}, Lx/c;->O(F)V

    invoke-virtual {v3, v5}, Landroidx/drawerlayout/widget/DrawerLayout$g;->q(Lx/c;)V

    invoke-static {p0, v4, v1}, Lx/c;->o(Landroid/view/ViewGroup;FLx/c$c;)Lx/c;

    move-result-object v3

    iput-object v3, p0, Landroidx/drawerlayout/widget/DrawerLayout;->j:Lx/c;

    const/4 v4, 0x2

    invoke-virtual {v3, v4}, Lx/c;->N(I)V

    invoke-virtual {v3, v2}, Lx/c;->O(F)V

    invoke-virtual {v1, v3}, Landroidx/drawerlayout/widget/DrawerLayout$g;->q(Lx/c;)V
...
.method private O(Landroid/view/View;)V
    ...
    .line 1
    sget-object v0, Landroidx/core/view/accessibility/H$a;->y:Landroidx/core/view/accessibility/H$a;

    invoke-virtual {v0}, Landroidx/core/view/accessibility/H$a;->b()I

    move-result v1

    invoke-static {p1, v1}, Landroidx/core/view/N;->n0(Landroid/view/View;I)V
    ...
    iget-object v2, p0, Landroidx/drawerlayout/widget/DrawerLayout;->W:Landroidx/core/view/accessibility/K;

    invoke-static {p1, v0, v1, v2}, Landroidx/core/view/N;->p0(Landroid/view/View;Landroidx/core/view/accessibility/H$a;Ljava/lang/CharSequence;Landroidx/core/view/accessibility/K;)V
...
.method private P(Landroid/view/View;Z)V
    ...
    :goto_1
    invoke-static {v2, v3}, Landroidx/core/view/N;->E0(Landroid/view/View;I)V
...
.method public H(Landroid/view/View;Z)V
    ...
    invoke-direct {p0, p1}, Landroidx/drawerlayout/widget/DrawerLayout;->O(Landroid/view/View;)V
    ...
    iget-object p2, p0, Landroidx/drawerlayout/widget/DrawerLayout;->g:Lx/c;

    invoke-virtual {p1}, Landroid/view/View;->getTop()I

    move-result v0

    invoke-virtual {p2, p1, v1, v0}, Lx/c;->R(Landroid/view/View;II)Z

    goto :goto_0

    :cond_1
    iget-object p2, p0, Landroidx/drawerlayout/widget/DrawerLayout;->j:Lx/c;
    ...
    invoke-virtual {p2, p1, v0, v1}, Lx/c;->R(Landroid/view/View;II)Z
    ...
    invoke-virtual {p0, v1, p1}, Landroidx/drawerlayout/widget/DrawerLayout;->Q(ILandroid/view/View;)V
...
.method public M(II)V
    ...
    invoke-static {p2, v0}, Landroidx/core/view/p;->b(II)I
...
.method Q(ILandroid/view/View;)V
    .locals 4

    .line 1
    iget-object v0, p0, Landroidx/drawerlayout/widget/DrawerLayout;->g:Lx/c;

    invoke-virtual {v0}, Lx/c;->B()I

    move-result v0

    iget-object v1, p0, Landroidx/drawerlayout/widget/DrawerLayout;->j:Lx/c;
...
.method public computeScroll()V
    ...
    invoke-virtual {v0, v1}, Lx/c;->n(Z)Z

    move-result v0

    iget-object v2, p0, Landroidx/drawerlayout/widget/DrawerLayout;->j:Lx/c;

    invoke-virtual {v2, v1}, Lx/c;->n(Z)Z
...
.method protected drawChild(Landroid/graphics/Canvas;Landroid/view/View;J)Z
    ...
    :cond_5
    iget-object v3, v0, Landroidx/drawerlayout/widget/DrawerLayout;->J:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v8, v0, Landroidx/drawerlayout/widget/DrawerLayout;->g:Lx/c;

    invoke-virtual {v8}, Lx/c;->y()I
    ...
    iget-object v6, v0, Landroidx/drawerlayout/widget/DrawerLayout;->J:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v2, v0, Landroidx/drawerlayout/widget/DrawerLayout;->J:Landroid/graphics/drawable/Drawable;
    ...
    :cond_6
    iget-object v3, v0, Landroidx/drawerlayout/widget/DrawerLayout;->K:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v10, v0, Landroidx/drawerlayout/widget/DrawerLayout;->j:Lx/c;

    invoke-virtual {v10}, Lx/c;->y()I
    ...
    iget-object v6, v0, Landroidx/drawerlayout/widget/DrawerLayout;->K:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v2, v0, Landroidx/drawerlayout/widget/DrawerLayout;->K:Landroid/graphics/drawable/Drawable;
...
.method public e(Landroid/view/View;Z)V
    ...
    invoke-virtual {p0, v2, p1}, Landroidx/drawerlayout/widget/DrawerLayout;->Q(ILandroid/view/View;)V
...
.method g(Z)V
    ...
    iget-object v7, p0, Landroidx/drawerlayout/widget/DrawerLayout;->g:Lx/c;
    ...
    invoke-virtual {v7, v4, v6, v8}, Lx/c;->R(Landroid/view/View;II)Z
    ...
    :cond_1
    iget-object v6, p0, Landroidx/drawerlayout/widget/DrawerLayout;->j:Lx/c;
    ...
    invoke-virtual {v6, v4, v7, v8}, Lx/c;->R(Landroid/view/View;II)Z
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v1, p0, Landroidx/drawerlayout/widget/DrawerLayout;->g:Lx/c;

    invoke-virtual {v1, p1}, Lx/c;->Q(Landroid/view/MotionEvent;)Z

    move-result v1

    iget-object v2, p0, Landroidx/drawerlayout/widget/DrawerLayout;->j:Lx/c;

    invoke-virtual {v2, p1}, Lx/c;->Q(Landroid/view/MotionEvent;)Z
    ...
    :cond_0
    iget-object p1, p0, Landroidx/drawerlayout/widget/DrawerLayout;->g:Lx/c;

    invoke-virtual {p1, v4}, Lx/c;->e(I)Z
    ...
    iget-object v4, p0, Landroidx/drawerlayout/widget/DrawerLayout;->g:Lx/c;

    float-to-int v0, v0

    float-to-int p1, p1

    invoke-virtual {v4, v0, p1}, Lx/c;->u(II)Landroid/view/View;
...
.method protected onLayout(ZIIII)V
    ...
    invoke-static/range {p0 .. p0}, Lz/a;->a(Landroidx/drawerlayout/widget/DrawerLayout;)Landroid/view/WindowInsets;

    move-result-object v1

    if-eqz v1, :cond_c

    invoke-static {v1}, Landroidx/core/view/Z;->w(Landroid/view/WindowInsets;)Landroidx/core/view/Z;

    move-result-object v1

    invoke-virtual {v1}, Landroidx/core/view/Z;->h()Landroidx/core/graphics/b;

    move-result-object v1

    iget-object v2, v0, Landroidx/drawerlayout/widget/DrawerLayout;->g:Lx/c;

    invoke-virtual {v2}, Lx/c;->x()I
    ...
    invoke-virtual {v2, v3}, Lx/c;->M(I)V

    iget-object v2, v0, Landroidx/drawerlayout/widget/DrawerLayout;->j:Lx/c;
    ...
    invoke-virtual {v2, v1}, Lx/c;->M(I)V
...
.method protected onMeasure(II)V
    ...
    invoke-static {v15, v7}, Landroidx/core/view/p;->b(II)I

    move-result v15

    invoke-static {v12}, Landroidx/core/view/N;->B(Landroid/view/View;)Z
    ...
    invoke-static {v12}, Landroidx/core/view/N;->y(Landroid/view/View;)F
    ...
    invoke-static {v12, v14}, Landroidx/core/view/N;->B0(Landroid/view/View;F)V
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v0, p1}, Lx/c;->G(Landroid/view/MotionEvent;)V

    iget-object v0, p0, Landroidx/drawerlayout/widget/DrawerLayout;->j:Lx/c;
    ...
    iget-object v3, p0, Landroidx/drawerlayout/widget/DrawerLayout;->g:Lx/c;

    float-to-int v4, v0

    float-to-int v5, p1

    invoke-virtual {v3, v4, v5}, Lx/c;->u(II)Landroid/view/View;
...
.method public setDrawerElevation(F)V
    ...
    invoke-static {v0, v1}, Landroidx/core/view/N;->B0(Landroid/view/View;F)V
