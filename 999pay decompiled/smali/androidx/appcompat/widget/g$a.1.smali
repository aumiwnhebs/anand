...
# interfaces
.implements Landroidx/appcompat/widget/J$f;
...
.method private h(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, v2}, Landroidx/appcompat/widget/N;->c(Landroid/content/Context;I)I

    move-result v2

    sget v3, Ld/a;->u:I

    invoke-static {p1, v3}, Landroidx/appcompat/widget/N;->b(Landroid/content/Context;I)I

    move-result p1

    sget-object v3, Landroidx/appcompat/widget/N;->b:[I
    ...
    sget-object p1, Landroidx/appcompat/widget/N;->e:[I
    ...
    sget-object p1, Landroidx/appcompat/widget/N;->c:[I
    ...
    sget-object p1, Landroidx/appcompat/widget/N;->i:[I
...
.method private i(Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, v0}, Landroidx/appcompat/widget/N;->c(Landroid/content/Context;I)I
...
.method private k(Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, v2}, Landroidx/appcompat/widget/N;->e(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    sget-object v2, Landroidx/appcompat/widget/N;->b:[I
    ...
    sget-object v2, Landroidx/appcompat/widget/N;->f:[I
    ...
    invoke-static {p1, v2}, Landroidx/appcompat/widget/N;->b(Landroid/content/Context;I)I

    move-result v3

    aput v3, v0, v6

    sget-object v3, Landroidx/appcompat/widget/N;->f:[I

    aput-object v3, v1, v5

    sget v3, Ld/a;->v:I

    invoke-static {p1, v3}, Landroidx/appcompat/widget/N;->c(Landroid/content/Context;I)I

    move-result v3

    aput v3, v0, v5

    sget-object v3, Landroidx/appcompat/widget/N;->i:[I
...
.method private l(Landroidx/appcompat/widget/J;Landroid/content/Context;I)Landroid/graphics/drawable/LayerDrawable;
    ...
    invoke-virtual {p1, p2, v2}, Landroidx/appcompat/widget/J;->j(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;

    move-result-object v2

    sget v3, Ld/e;->G:I

    invoke-virtual {p1, p2, v3}, Landroidx/appcompat/widget/J;->j(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
...
.method private m(Landroid/graphics/drawable/Drawable;ILandroid/graphics/PorterDuff$Mode;)V
    ...
    .line 1
    invoke-static {p1}, Landroidx/appcompat/widget/D;->a(Landroid/graphics/drawable/Drawable;)Z
...
.method public a(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Z
    ...
    invoke-static {p3}, Landroidx/appcompat/widget/D;->a(Landroid/graphics/drawable/Drawable;)Z
    ...
    :cond_5
    invoke-static {p1, p2}, Landroidx/appcompat/widget/N;->c(Landroid/content/Context;I)I
...
.method public c(Landroidx/appcompat/widget/J;Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p1, p2, v0}, Landroidx/appcompat/widget/J;->j(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;

    move-result-object v0

    sget v1, Ld/e;->k:I

    invoke-virtual {p1, p2, v1}, Landroidx/appcompat/widget/J;->j(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
...
.method public d(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, p2}, Landroidx/appcompat/widget/N;->e(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
...
.method public e(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Z
    ...
    invoke-static {p1, p3}, Landroidx/appcompat/widget/N;->c(Landroid/content/Context;I)I
    ...
    invoke-static {p1, v0}, Landroidx/appcompat/widget/N;->b(Landroid/content/Context;I)I
