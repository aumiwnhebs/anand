...
.field private K:Landroidx/appcompat/view/menu/m$a;
...
.field private final s:Landroidx/appcompat/widget/I;
...
.method static constructor <clinit>()V
    ...
    sput v0, Landroidx/appcompat/view/menu/d;->O:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/view/View;IIZ)V
    ...
    iput-object v0, p0, Landroidx/appcompat/view/menu/d;->s:Landroidx/appcompat/widget/I;
    ...
    iput-object p2, p0, Landroidx/appcompat/view/menu/d;->v:Landroid/view/View;
    ...
    iput-boolean v0, p0, Landroidx/appcompat/view/menu/d;->I:Z

    invoke-direct {p0}, Landroidx/appcompat/view/menu/d;->E()I

    move-result p2

    iput p2, p0, Landroidx/appcompat/view/menu/d;->x:I
...
.method private A()Landroidx/appcompat/widget/MenuPopupWindow;
    ...
    iget-object v1, p0, Landroidx/appcompat/view/menu/d;->s:Landroidx/appcompat/widget/I;

    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/MenuPopupWindow;->S(Landroidx/appcompat/widget/I;)V

    invoke-virtual {v0, p0}, Landroidx/appcompat/widget/H;->K(Landroid/widget/AdapterView$OnItemClickListener;)V

    invoke-virtual {v0, p0}, Landroidx/appcompat/widget/H;->J(Landroid/widget/PopupWindow$OnDismissListener;)V

    iget-object v1, p0, Landroidx/appcompat/view/menu/d;->v:Landroid/view/View;

    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/H;->C(Landroid/view/View;)V

    iget v1, p0, Landroidx/appcompat/view/menu/d;->u:I

    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/H;->F(I)V

    const/4 v1, 0x1

    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/H;->I(Z)V

    const/4 v1, 0x2

    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/H;->H(I)V
...
.method private F(I)I
    ...
    iget-object v4, p0, Landroidx/appcompat/view/menu/d;->w:Landroid/view/View;

    invoke-virtual {v4, v3}, Landroid/view/View;->getWindowVisibleDisplayFrame(Landroid/graphics/Rect;)V

    iget v4, p0, Landroidx/appcompat/view/menu/d;->x:I
...
.method private G(Landroidx/appcompat/view/menu/g;)V
    ...
    sget v3, Landroidx/appcompat/view/menu/d;->O:I
    ...
    invoke-direct {p0}, Landroidx/appcompat/view/menu/d;->A()Landroidx/appcompat/widget/MenuPopupWindow;

    move-result-object v4

    invoke-virtual {v4, v1}, Landroidx/appcompat/widget/H;->o(Landroid/widget/ListAdapter;)V

    invoke-virtual {v4, v2}, Landroidx/appcompat/widget/H;->E(I)V

    iget v1, p0, Landroidx/appcompat/view/menu/d;->u:I

    invoke-virtual {v4, v1}, Landroidx/appcompat/widget/H;->F(I)V
    ...
    :goto_2
    iput v8, p0, Landroidx/appcompat/view/menu/d;->x:I
    ...
    invoke-virtual {v4, v6}, Landroidx/appcompat/widget/H;->C(Landroid/view/View;)V
    ...
    iget-object v12, p0, Landroidx/appcompat/view/menu/d;->v:Landroid/view/View;
    ...
    iget v12, p0, Landroidx/appcompat/view/menu/d;->u:I
    ...
    iget-object v13, p0, Landroidx/appcompat/view/menu/d;->v:Landroid/view/View;
    ...
    :goto_3
    iget v10, p0, Landroidx/appcompat/view/menu/d;->u:I
    ...
    :goto_5
    invoke-virtual {v4, v12}, Landroidx/appcompat/widget/H;->e(I)V

    invoke-virtual {v4, v3}, Landroidx/appcompat/widget/H;->L(Z)V

    invoke-virtual {v4, v8}, Landroidx/appcompat/widget/H;->k(I)V
    ...
    iget v2, p0, Landroidx/appcompat/view/menu/d;->C:I
    ...
    invoke-virtual {v4, v2}, Landroidx/appcompat/widget/H;->k(I)V
    ...
    invoke-virtual {v4, v2}, Landroidx/appcompat/widget/H;->G(Landroid/graphics/Rect;)V

    :goto_6
    new-instance v2, Landroidx/appcompat/view/menu/d$d;

    iget v3, p0, Landroidx/appcompat/view/menu/d;->x:I
    ...
    invoke-virtual {v4}, Landroidx/appcompat/widget/H;->show()V

    invoke-virtual {v4}, Landroidx/appcompat/widget/H;->j()Landroid/widget/ListView;
...
.method public b(Landroidx/appcompat/view/menu/g;Z)V
    ...
    invoke-virtual {v1, v3}, Landroidx/appcompat/widget/H;->D(I)V
    ...
    :goto_0
    iput v1, p0, Landroidx/appcompat/view/menu/d;->x:I
    ...
    iget-object p2, p0, Landroidx/appcompat/view/menu/d;->K:Landroidx/appcompat/view/menu/m$a;
    ...
    :cond_4
    iget-object p1, p0, Landroidx/appcompat/view/menu/d;->L:Landroid/view/ViewTreeObserver;
    ...
    :cond_5
    iput-object v2, p0, Landroidx/appcompat/view/menu/d;->L:Landroid/view/ViewTreeObserver;

    :cond_6
    iget-object p1, p0, Landroidx/appcompat/view/menu/d;->w:Landroid/view/View;
    ...
    iget-object p1, p0, Landroidx/appcompat/view/menu/d;->M:Landroid/widget/PopupWindow$OnDismissListener;
...
.method public dismiss()V
    ...
    invoke-virtual {v3}, Landroidx/appcompat/widget/H;->a()Z
    ...
    invoke-virtual {v2}, Landroidx/appcompat/widget/H;->dismiss()V
...
.method public g(Landroidx/appcompat/view/menu/m$a;)V
    ...
    .line 1
    iput-object p1, p0, Landroidx/appcompat/view/menu/d;->K:Landroidx/appcompat/view/menu/m$a;
...
.method public k(Landroidx/appcompat/view/menu/r;)Z
    ...
    invoke-virtual {p0, p1}, Landroidx/appcompat/view/menu/d;->m(Landroidx/appcompat/view/menu/g;)V

    iget-object v0, p0, Landroidx/appcompat/view/menu/d;->K:Landroidx/appcompat/view/menu/m$a;
...
.method public onDismiss()V
    ...
    invoke-virtual {v4}, Landroidx/appcompat/widget/H;->a()Z
...
.method public q(Landroid/view/View;)V
    ...
    iput-object p1, p0, Landroidx/appcompat/view/menu/d;->v:Landroid/view/View;

    iget v0, p0, Landroidx/appcompat/view/menu/d;->t:I
...
.method public show()V
    ...
    iput-object v0, p0, Landroidx/appcompat/view/menu/d;->w:Landroid/view/View;

    if-eqz v0, :cond_4

    iget-object v1, p0, Landroidx/appcompat/view/menu/d;->L:Landroid/view/ViewTreeObserver;
    ...
    iput-object v0, p0, Landroidx/appcompat/view/menu/d;->L:Landroid/view/ViewTreeObserver;
    ...
    :cond_3
    iget-object v0, p0, Landroidx/appcompat/view/menu/d;->w:Landroid/view/View;
