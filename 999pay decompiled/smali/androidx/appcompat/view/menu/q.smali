...
.field w:Landroid/view/ViewTreeObserver;
...
.method static constructor <clinit>()V
    ...
    sput v0, Landroidx/appcompat/view/menu/q;->I:I
...
.method public constructor <init>(Landroid/content/Context;Landroidx/appcompat/view/menu/g;Landroid/view/View;IIZ)V
    ...
    iput v0, p0, Landroidx/appcompat/view/menu/q;->C:I
    ...
    sget v2, Landroidx/appcompat/view/menu/q;->I:I
    ...
    iput-object p3, p0, Landroidx/appcompat/view/menu/q;->t:Landroid/view/View;
    ...
    iput-object p3, p0, Landroidx/appcompat/view/menu/q;->m:Landroidx/appcompat/widget/MenuPopupWindow;
...
.method private A()Z
    ...
    :cond_1
    iput-object v0, p0, Landroidx/appcompat/view/menu/q;->u:Landroid/view/View;

    iget-object v0, p0, Landroidx/appcompat/view/menu/q;->m:Landroidx/appcompat/widget/MenuPopupWindow;
    ...
    iget-object v3, p0, Landroidx/appcompat/view/menu/q;->w:Landroid/view/ViewTreeObserver;
    ...
    iput-object v4, p0, Landroidx/appcompat/view/menu/q;->w:Landroid/view/ViewTreeObserver;
    ...
    iget-object v3, p0, Landroidx/appcompat/view/menu/q;->m:Landroidx/appcompat/widget/MenuPopupWindow;

    invoke-virtual {v3, v0}, Landroidx/appcompat/widget/H;->C(Landroid/view/View;)V

    iget-object v0, p0, Landroidx/appcompat/view/menu/q;->m:Landroidx/appcompat/widget/MenuPopupWindow;

    iget v3, p0, Landroidx/appcompat/view/menu/q;->C:I

    invoke-virtual {v0, v3}, Landroidx/appcompat/widget/H;->F(I)V
    ...
    iput-boolean v1, p0, Landroidx/appcompat/view/menu/q;->y:Z
    ...
    invoke-virtual {v0, v4}, Landroidx/appcompat/widget/H;->E(I)V

    iget-object v0, p0, Landroidx/appcompat/view/menu/q;->m:Landroidx/appcompat/widget/MenuPopupWindow;

    const/4 v4, 0x2

    invoke-virtual {v0, v4}, Landroidx/appcompat/widget/H;->H(I)V
    ...
    invoke-virtual {v0, v4}, Landroidx/appcompat/widget/H;->G(Landroid/graphics/Rect;)V
    ...
    invoke-virtual {v0}, Landroidx/appcompat/widget/H;->j()Landroid/widget/ListView;

    move-result-object v0

    invoke-virtual {v0, p0}, Landroid/view/View;->setOnKeyListener(Landroid/view/View$OnKeyListener;)V

    iget-boolean v4, p0, Landroidx/appcompat/view/menu/q;->H:Z
    ...
    invoke-virtual {v0, v2}, Landroidx/appcompat/widget/H;->o(Landroid/widget/ListAdapter;)V
...
.method public b(Landroidx/appcompat/view/menu/g;Z)V
    ...
    iget-object v0, p0, Landroidx/appcompat/view/menu/q;->v:Landroidx/appcompat/view/menu/m$a;
...
.method public g(Landroidx/appcompat/view/menu/m$a;)V
    ...
    .line 1
    iput-object p1, p0, Landroidx/appcompat/view/menu/q;->v:Landroidx/appcompat/view/menu/m$a;
...
.method public k(Landroidx/appcompat/view/menu/r;)Z
    ...
    iget-object v5, p0, Landroidx/appcompat/view/menu/q;->u:Landroid/view/View;
    ...
    iget-object v2, p0, Landroidx/appcompat/view/menu/q;->v:Landroidx/appcompat/view/menu/m$a;
    ...
    iget-object v2, p0, Landroidx/appcompat/view/menu/q;->s:Landroid/widget/PopupWindow$OnDismissListener;

    invoke-virtual {v0, v2}, Landroidx/appcompat/view/menu/l;->i(Landroid/widget/PopupWindow$OnDismissListener;)V

    const/4 v2, 0x0

    iput-object v2, p0, Landroidx/appcompat/view/menu/q;->s:Landroid/widget/PopupWindow$OnDismissListener;
    ...
    iget-object v2, p0, Landroidx/appcompat/view/menu/q;->m:Landroidx/appcompat/widget/MenuPopupWindow;

    invoke-virtual {v2}, Landroidx/appcompat/widget/H;->c()I

    move-result v2

    iget-object v3, p0, Landroidx/appcompat/view/menu/q;->m:Landroidx/appcompat/widget/MenuPopupWindow;

    invoke-virtual {v3}, Landroidx/appcompat/widget/H;->n()I

    move-result v3

    iget v4, p0, Landroidx/appcompat/view/menu/q;->C:I

    iget-object v5, p0, Landroidx/appcompat/view/menu/q;->t:Landroid/view/View;

    invoke-static {v5}, Landroidx/core/view/N;->E(Landroid/view/View;)I
    ...
    iget-object v4, p0, Landroidx/appcompat/view/menu/q;->t:Landroid/view/View;
...
.method public onDismiss()V
    ...
    iput-boolean v0, p0, Landroidx/appcompat/view/menu/q;->x:Z

    iget-object v0, p0, Landroidx/appcompat/view/menu/q;->c:Landroidx/appcompat/view/menu/g;

    invoke-virtual {v0}, Landroidx/appcompat/view/menu/g;->close()V

    iget-object v0, p0, Landroidx/appcompat/view/menu/q;->w:Landroid/view/ViewTreeObserver;
    ...
    iput-object v0, p0, Landroidx/appcompat/view/menu/q;->w:Landroid/view/ViewTreeObserver;
    ...
    iget-object v0, p0, Landroidx/appcompat/view/menu/q;->s:Landroid/widget/PopupWindow$OnDismissListener;
...
.method public q(Landroid/view/View;)V
    ...
    .line 1
    iput-object p1, p0, Landroidx/appcompat/view/menu/q;->t:Landroid/view/View;
...
.method public show()V
    ...
    invoke-direct {p0}, Landroidx/appcompat/view/menu/q;->A()Z
...
.method public t(I)V
    ...
    .line 1
    iput p1, p0, Landroidx/appcompat/view/menu/q;->C:I
...
.method public u(I)V
    ...
    invoke-virtual {v0, p1}, Landroidx/appcompat/widget/H;->e(I)V
...
.method public v(Landroid/widget/PopupWindow$OnDismissListener;)V
    ...
    .line 1
    iput-object p1, p0, Landroidx/appcompat/view/menu/q;->s:Landroid/widget/PopupWindow$OnDismissListener;
...
.method public x(I)V
    ...
    invoke-virtual {v0, p1}, Landroidx/appcompat/widget/H;->k(I)V
