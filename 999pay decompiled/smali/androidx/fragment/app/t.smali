...
.method protected static d(Ljava/util/List;Landroid/view/View;)V
    ...
    invoke-static {p0, p1, v0}, Landroidx/fragment/app/t;->h(Ljava/util/List;Landroid/view/View;I)Z
    ...
    :cond_0
    invoke-static {p1}, Landroidx/core/view/N;->N(Landroid/view/View;)Ljava/lang/String;
    ...
    invoke-static {p0, v4, v0}, Landroidx/fragment/app/t;->h(Ljava/util/List;Landroid/view/View;I)Z

    move-result v5

    if-nez v5, :cond_2

    invoke-static {v4}, Landroidx/core/view/N;->N(Landroid/view/View;)Ljava/lang/String;
...
.method f(Ljava/util/ArrayList;Landroid/view/View;)V
    ...
    invoke-static {p2}, Landroidx/core/view/Q;->a(Landroid/view/ViewGroup;)Z
    ...
    invoke-virtual {p0, p1, v2}, Landroidx/fragment/app/t;->f(Ljava/util/ArrayList;Landroid/view/View;)V
...
.method j(Ljava/util/Map;Landroid/view/View;)V
    ...
    invoke-virtual {p0, p1, v2}, Landroidx/fragment/app/t;->j(Ljava/util/Map;Landroid/view/View;)V
...
.method o(Ljava/util/ArrayList;)Ljava/util/ArrayList;
    ...
    invoke-static {v3}, Landroidx/core/view/N;->N(Landroid/view/View;)Ljava/lang/String;
    ...
    invoke-static {v3, v4}, Landroidx/core/view/N;->N0(Landroid/view/View;Ljava/lang/String;)V
...
.method s(Landroid/view/ViewGroup;Ljava/util/ArrayList;Ljava/util/Map;)V
    ...
    .line 1
    new-instance v0, Landroidx/fragment/app/t$c;

    invoke-direct {v0, p0, p2, p3}, Landroidx/fragment/app/t$c;-><init>(Landroidx/fragment/app/t;Ljava/util/ArrayList;Ljava/util/Map;)V

    invoke-static {p1, v0}, Landroidx/core/view/I;->a(Landroid/view/View;Ljava/lang/Runnable;)Landroidx/core/view/I;
...
.method x(Landroid/view/View;Ljava/util/ArrayList;Ljava/util/Map;)V
    ...
    invoke-direct {v0, p0, p2, p3}, Landroidx/fragment/app/t$b;-><init>(Landroidx/fragment/app/t;Ljava/util/ArrayList;Ljava/util/Map;)V
...
.method y(Landroid/view/View;Ljava/util/ArrayList;Ljava/util/ArrayList;Ljava/util/ArrayList;Ljava/util/Map;)V
    ...
    invoke-static {v3, v5}, Landroidx/core/view/N;->N0(Landroid/view/View;Ljava/lang/String;)V
    ...
    invoke-static {p1, p5}, Landroidx/core/view/I;->a(Landroid/view/View;Ljava/lang/Runnable;)Landroidx/core/view/I;
