...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/vectordrawable/graphics/drawable/h;->p:Landroid/graphics/PorterDuff$Mode;
...
.method constructor <init>()V
    ...
    iput-object v0, p0, Landroidx/vectordrawable/graphics/drawable/h;->j:[F

    new-instance v0, Landroid/graphics/Matrix;

    invoke-direct {v0}, Landroid/graphics/Matrix;-><init>()V

    iput-object v0, p0, Landroidx/vectordrawable/graphics/drawable/h;->m:Landroid/graphics/Matrix;

    new-instance v0, Landroid/graphics/Rect;

    invoke-direct {v0}, Landroid/graphics/Rect;-><init>()V

    iput-object v0, p0, Landroidx/vectordrawable/graphics/drawable/h;->n:Landroid/graphics/Rect;
...
.method private e(Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)V
    ...
    iget-object v6, v1, Landroidx/vectordrawable/graphics/drawable/h$g;->p:Lm/a;
    ...
    iget-object v7, v1, Landroidx/vectordrawable/graphics/drawable/h$g;->p:Lm/a;
...
.method private i(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Landroid/content/res/Resources$Theme;)V
    ...
    iget-object p2, v1, Landroidx/vectordrawable/graphics/drawable/h$g;->p:Lm/a;
...
.method d(Ljava/lang/String;)Ljava/lang/Object;
    ...
    iget-object v0, v0, Landroidx/vectordrawable/graphics/drawable/h$g;->p:Lm/a;
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    :cond_0
    iget-object v0, p0, Landroidx/vectordrawable/graphics/drawable/h;->n:Landroid/graphics/Rect;
    ...
    :cond_2
    iget-object v1, p0, Landroidx/vectordrawable/graphics/drawable/h;->m:Landroid/graphics/Matrix;

    invoke-virtual {p1, v1}, Landroid/graphics/Canvas;->getMatrix(Landroid/graphics/Matrix;)V

    iget-object v1, p0, Landroidx/vectordrawable/graphics/drawable/h;->m:Landroid/graphics/Matrix;

    iget-object v2, p0, Landroidx/vectordrawable/graphics/drawable/h;->j:[F

    invoke-virtual {v1, v2}, Landroid/graphics/Matrix;->getValues([F)V

    iget-object v1, p0, Landroidx/vectordrawable/graphics/drawable/h;->j:[F
    ...
    iget-object v3, p0, Landroidx/vectordrawable/graphics/drawable/h;->j:[F
    ...
    iget-object v4, p0, Landroidx/vectordrawable/graphics/drawable/h;->j:[F
    ...
    iget-object v5, p0, Landroidx/vectordrawable/graphics/drawable/h;->j:[F
    ...
    :cond_4
    iget-object v4, p0, Landroidx/vectordrawable/graphics/drawable/h;->n:Landroid/graphics/Rect;
    ...
    iget-object v5, p0, Landroidx/vectordrawable/graphics/drawable/h;->n:Landroid/graphics/Rect;
    ...
    iget-object v2, p0, Landroidx/vectordrawable/graphics/drawable/h;->n:Landroid/graphics/Rect;
