...
# static fields
.field private static final M:Lcom/bumptech/glide/load/engine/j$c;
...
.field I:Lcom/bumptech/glide/load/engine/n;

.field private J:Lcom/bumptech/glide/load/engine/DecodeJob;
...
.field private final m:LF0/a;

.field private final n:LF0/a;

.field private final p:Ljava/util/concurrent/atomic/AtomicInteger;

.field private s:LD0/b;
...
.field y:Lcom/bumptech/glide/load/DataSource;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/bumptech/glide/load/engine/j;->M:Lcom/bumptech/glide/load/engine/j$c;

    return-void
.end method

.method constructor <init>(LF0/a;LF0/a;LF0/a;LF0/a;Lcom/bumptech/glide/load/engine/k;Lcom/bumptech/glide/load/engine/n$a;Landroidx/core/util/e;)V
    .locals 9

    .line 1
    sget-object v8, Lcom/bumptech/glide/load/engine/j;->M:Lcom/bumptech/glide/load/engine/j$c;
    ...
    invoke-direct/range {v0 .. v8}, Lcom/bumptech/glide/load/engine/j;-><init>(LF0/a;LF0/a;LF0/a;LF0/a;Lcom/bumptech/glide/load/engine/k;Lcom/bumptech/glide/load/engine/n$a;Landroidx/core/util/e;Lcom/bumptech/glide/load/engine/j$c;)V

    return-void
.end method

.method constructor <init>(LF0/a;LF0/a;LF0/a;LF0/a;Lcom/bumptech/glide/load/engine/k;Lcom/bumptech/glide/load/engine/n$a;Landroidx/core/util/e;Lcom/bumptech/glide/load/engine/j$c;)V
    .locals 1
    ...
    iput-object v0, p0, Lcom/bumptech/glide/load/engine/j;->b:LT0/c;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-direct {v0}, Ljava/util/concurrent/atomic/AtomicInteger;-><init>()V

    iput-object v0, p0, Lcom/bumptech/glide/load/engine/j;->p:Ljava/util/concurrent/atomic/AtomicInteger;

    iput-object p1, p0, Lcom/bumptech/glide/load/engine/j;->g:LF0/a;

    iput-object p2, p0, Lcom/bumptech/glide/load/engine/j;->j:LF0/a;

    iput-object p3, p0, Lcom/bumptech/glide/load/engine/j;->m:LF0/a;

    iput-object p4, p0, Lcom/bumptech/glide/load/engine/j;->n:LF0/a;
...
.method private j()LF0/a;
    ...
    .line 4
    .line 5
    iget-object v0, p0, Lcom/bumptech/glide/load/engine/j;->m:LF0/a;
    ...
    .line 11
    .line 12
    iget-object v0, p0, Lcom/bumptech/glide/load/engine/j;->n:LF0/a;
    ...
    .line 15
    :cond_1
    iget-object v0, p0, Lcom/bumptech/glide/load/engine/j;->j:LF0/a;
...
.method private m()Z
    ...
    iget-boolean v0, p0, Lcom/bumptech/glide/load/engine/j;->K:Z
...
.method private declared-synchronized q()V
    ...
    :try_start_0
    iget-object v0, p0, Lcom/bumptech/glide/load/engine/j;->s:LD0/b;
    ...
    iput-object v0, p0, Lcom/bumptech/glide/load/engine/j;->s:LD0/b;

    iput-object v0, p0, Lcom/bumptech/glide/load/engine/j;->I:Lcom/bumptech/glide/load/engine/n;

    iput-object v0, p0, Lcom/bumptech/glide/load/engine/j;->x:Lcom/bumptech/glide/load/engine/s;

    const/4 v1, 0x0

    iput-boolean v1, p0, Lcom/bumptech/glide/load/engine/j;->H:Z

    iput-boolean v1, p0, Lcom/bumptech/glide/load/engine/j;->K:Z

    iput-boolean v1, p0, Lcom/bumptech/glide/load/engine/j;->z:Z

    iput-boolean v1, p0, Lcom/bumptech/glide/load/engine/j;->L:Z

    iget-object v2, p0, Lcom/bumptech/glide/load/engine/j;->J:Lcom/bumptech/glide/load/engine/DecodeJob;

    invoke-virtual {v2, v1}, Lcom/bumptech/glide/load/engine/DecodeJob;->y(Z)V

    iput-object v0, p0, Lcom/bumptech/glide/load/engine/j;->J:Lcom/bumptech/glide/load/engine/DecodeJob;

    iput-object v0, p0, Lcom/bumptech/glide/load/engine/j;->C:Lcom/bumptech/glide/load/engine/GlideException;

    iput-object v0, p0, Lcom/bumptech/glide/load/engine/j;->y:Lcom/bumptech/glide/load/DataSource;
...
.method declared-synchronized b(Lcom/bumptech/glide/request/h;Ljava/util/concurrent/Executor;)V
    .locals 2
    ...
    :try_start_0
    iget-object v0, p0, Lcom/bumptech/glide/load/engine/j;->b:LT0/c;
    ...
    :cond_1
    iget-boolean p1, p0, Lcom/bumptech/glide/load/engine/j;->K:Z
...
.method public c(Lcom/bumptech/glide/load/engine/s;Lcom/bumptech/glide/load/DataSource;Z)V
    ...
    :try_start_0
    iput-object p1, p0, Lcom/bumptech/glide/load/engine/j;->x:Lcom/bumptech/glide/load/engine/s;

    iput-object p2, p0, Lcom/bumptech/glide/load/engine/j;->y:Lcom/bumptech/glide/load/DataSource;
...
.method public d(Lcom/bumptech/glide/load/engine/DecodeJob;)V
    ...
    .line 1
    invoke-direct {p0}, Lcom/bumptech/glide/load/engine/j;->j()LF0/a;
...
.method g(Lcom/bumptech/glide/request/h;)V
    .locals 3

    .line 1
    :try_start_0
    iget-object v0, p0, Lcom/bumptech/glide/load/engine/j;->I:Lcom/bumptech/glide/load/engine/n;

    iget-object v1, p0, Lcom/bumptech/glide/load/engine/j;->y:Lcom/bumptech/glide/load/DataSource;

    iget-boolean v2, p0, Lcom/bumptech/glide/load/engine/j;->L:Z

    invoke-interface {p1, v0, v1, v2}, Lcom/bumptech/glide/request/h;->c(Lcom/bumptech/glide/load/engine/s;Lcom/bumptech/glide/load/DataSource;Z)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method h()V
    ...
    iput-boolean v0, p0, Lcom/bumptech/glide/load/engine/j;->K:Z

    iget-object v0, p0, Lcom/bumptech/glide/load/engine/j;->J:Lcom/bumptech/glide/load/engine/DecodeJob;

    invoke-virtual {v0}, Lcom/bumptech/glide/load/engine/DecodeJob;->g()V

    iget-object v0, p0, Lcom/bumptech/glide/load/engine/j;->f:Lcom/bumptech/glide/load/engine/k;

    iget-object v1, p0, Lcom/bumptech/glide/load/engine/j;->s:LD0/b;

    invoke-interface {v0, p0, v1}, Lcom/bumptech/glide/load/engine/k;->d(Lcom/bumptech/glide/load/engine/j;LD0/b;)V
...
.method i()V
    ...
    iget-object v0, p0, Lcom/bumptech/glide/load/engine/j;->p:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method declared-synchronized k(I)V
    ...
    iget-object p1, p0, Lcom/bumptech/glide/load/engine/j;->I:Lcom/bumptech/glide/load/engine/n;
...
.method declared-synchronized l(LD0/b;ZZZZ)Lcom/bumptech/glide/load/engine/j;
    .locals 0
    ...
    .line 2
    :try_start_0
    iput-object p1, p0, Lcom/bumptech/glide/load/engine/j;->s:LD0/b;

    .line 3
    .line 4
    iput-boolean p2, p0, Lcom/bumptech/glide/load/engine/j;->t:Z
    ...
    .line 7
    .line 8
    iput-boolean p4, p0, Lcom/bumptech/glide/load/engine/j;->v:Z

    .line 9
    .line 10
    iput-boolean p5, p0, Lcom/bumptech/glide/load/engine/j;->w:Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method n()V
    ...
    invoke-interface {v0, p0, v1, v3}, Lcom/bumptech/glide/load/engine/k;->c(Lcom/bumptech/glide/load/engine/j;LD0/b;Lcom/bumptech/glide/load/engine/n;)V
...
.method o()V
    ...
    iget-object v0, p0, Lcom/bumptech/glide/load/engine/j;->x:Lcom/bumptech/glide/load/engine/s;
    ...
    iget-object v1, p0, Lcom/bumptech/glide/load/engine/j;->x:Lcom/bumptech/glide/load/engine/s;

    iget-boolean v2, p0, Lcom/bumptech/glide/load/engine/j;->t:Z

    iget-object v3, p0, Lcom/bumptech/glide/load/engine/j;->s:LD0/b;

    iget-object v4, p0, Lcom/bumptech/glide/load/engine/j;->c:Lcom/bumptech/glide/load/engine/n$a;

    invoke-virtual {v0, v1, v2, v3, v4}, Lcom/bumptech/glide/load/engine/j$c;->a(Lcom/bumptech/glide/load/engine/s;ZLD0/b;Lcom/bumptech/glide/load/engine/n$a;)Lcom/bumptech/glide/load/engine/n;
    ...
    iget-object v2, p0, Lcom/bumptech/glide/load/engine/j;->I:Lcom/bumptech/glide/load/engine/n;
    ...
    invoke-interface {v3, p0, v0, v2}, Lcom/bumptech/glide/load/engine/k;->c(Lcom/bumptech/glide/load/engine/j;LD0/b;Lcom/bumptech/glide/load/engine/n;)V
...
.method declared-synchronized r(Lcom/bumptech/glide/request/h;)V
    .locals 1
    ...
    :cond_0
    :goto_0
    iget-object p1, p0, Lcom/bumptech/glide/load/engine/j;->p:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method public declared-synchronized s(Lcom/bumptech/glide/load/engine/DecodeJob;)V
    ...
    :try_start_0
    iput-object p1, p0, Lcom/bumptech/glide/load/engine/j;->J:Lcom/bumptech/glide/load/engine/DecodeJob;
    ...
    iget-object v0, p0, Lcom/bumptech/glide/load/engine/j;->g:LF0/a;
