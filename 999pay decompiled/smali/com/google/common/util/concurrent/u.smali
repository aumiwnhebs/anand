...
.method static synthetic a(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    ...
    .line 1
    invoke-static {p0, p1}, Lcom/google/common/util/concurrent/u;->d(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
...
.method private static c(Lcom/google/common/util/concurrent/u;)Ljava/util/concurrent/ThreadFactory;
    .locals 9
    ...
    iget-object p0, p0, Lcom/google/common/util/concurrent/u;->e:Ljava/util/concurrent/ThreadFactory;
    ...
    :goto_3
    new-instance p0, Lcom/google/common/util/concurrent/u$a;

    move-object v0, p0

    invoke-direct/range {v0 .. v6}, Lcom/google/common/util/concurrent/u$a;-><init>(Ljava/util/concurrent/ThreadFactory;Ljava/lang/String;Ljava/util/concurrent/atomic/AtomicLong;Ljava/lang/Boolean;Ljava/lang/Integer;Ljava/lang/Thread$UncaughtExceptionHandler;)V
...
.method public b()Ljava/util/concurrent/ThreadFactory;
    ...
    .line 1
    invoke-static {p0}, Lcom/google/common/util/concurrent/u;->c(Lcom/google/common/util/concurrent/u;)Ljava/util/concurrent/ThreadFactory;
...
.method public e(Z)Lcom/google/common/util/concurrent/u;
    .locals 0
    ...
    iput-object p1, p0, Lcom/google/common/util/concurrent/u;->b:Ljava/lang/Boolean;

    return-object p0
.end method

.method public f(Ljava/lang/String;)Lcom/google/common/util/concurrent/u;
    .locals 3
    ...
    invoke-static {p1, v2}, Lcom/google/common/util/concurrent/u;->d(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
