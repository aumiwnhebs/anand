...
.method public l(Landroid/app/Activity;IILandroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    ...
    invoke-static {p1, v0, p3}, Lr2/t;->b(Landroid/app/Activity;Landroid/content/Intent;I)Lr2/t;

    move-result-object p3

    invoke-virtual {p0, p1, p2, p3, p4}, Lcom/google/android/gms/common/a;->q(Landroid/content/Context;ILr2/t;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
...
.method final q(Landroid/content/Context;ILr2/t;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    .locals 5
    ...
    .line 52
    :cond_2
    invoke-static {p1, p2}, Lr2/q;->d(Landroid/content/Context;I)Ljava/lang/String;
    ...
    .line 64
    :cond_3
    invoke-static {p1, p2}, Lr2/q;->c(Landroid/content/Context;I)Ljava/lang/String;
    ...
    .line 73
    :cond_4
    invoke-static {p1, p2}, Lr2/q;->g(Landroid/content/Context;I)Ljava/lang/String;
...
.method public final r(Landroid/app/Activity;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    ...
    invoke-static {p1, v0}, Lr2/q;->d(Landroid/content/Context;I)Ljava/lang/String;
...
.method public final s(Landroid/content/Context;Lp2/o;)Lcom/google/android/gms/common/api/internal/zabx;
    .locals 2
    ...
    .line 14
    .line 15
    invoke-direct {v1, p2}, Lcom/google/android/gms/common/api/internal/zabx;-><init>(Lp2/o;)V
...
.method final t(Landroid/app/Activity;Landroid/app/Dialog;Ljava/lang/String;Landroid/content/DialogInterface$OnCancelListener;)V
    ...
    invoke-static {p2, p4}, Lo2/g;->l(Landroid/app/Dialog;Landroid/content/DialogInterface$OnCancelListener;)Lo2/g;

    move-result-object p2

    invoke-virtual {p2, p1, p3}, Lo2/g;->show(Landroidx/fragment/app/FragmentManager;Ljava/lang/String;)V
...
.method final u(Landroid/content/Context;ILjava/lang/String;Landroid/app/PendingIntent;)V
    ...
    :cond_1
    invoke-static {p1, p2}, Lr2/q;->f(Landroid/content/Context;I)Ljava/lang/String;

    move-result-object p3

    invoke-static {p1, p2}, Lr2/q;->e(Landroid/content/Context;I)Ljava/lang/String;
    ...
    new-instance v6, Landroidx/core/app/n$e;

    invoke-direct {v6, p1}, Landroidx/core/app/n$e;-><init>(Landroid/content/Context;)V

    invoke-virtual {v6, v3}, Landroidx/core/app/n$e;->s(Z)Landroidx/core/app/n$e;

    move-result-object v6

    invoke-virtual {v6, v3}, Landroidx/core/app/n$e;->h(Z)Landroidx/core/app/n$e;

    move-result-object v6

    invoke-virtual {v6, p3}, Landroidx/core/app/n$e;->m(Ljava/lang/CharSequence;)Landroidx/core/app/n$e;
    ...
    invoke-virtual {v6, v1}, Landroidx/core/app/n$c;->h(Ljava/lang/CharSequence;)Landroidx/core/app/n$c;

    move-result-object v6

    invoke-virtual {p3, v6}, Landroidx/core/app/n$e;->z(Landroidx/core/app/n$f;)Landroidx/core/app/n$e;

    move-result-object p3

    invoke-static {p1}, Lw2/h;->c(Landroid/content/Context;)Z

    move-result v6

    if-eqz v6, :cond_3

    invoke-static {}, Lw2/m;->e()Z

    move-result v1

    invoke-static {v1}, Lr2/g;->l(Z)V
    ...
    invoke-virtual {p3, v1}, Landroidx/core/app/n$e;->x(I)Landroidx/core/app/n$e;

    move-result-object v1

    invoke-virtual {v1, v0}, Landroidx/core/app/n$e;->u(I)Landroidx/core/app/n$e;

    invoke-static {p1}, Lw2/h;->d(Landroid/content/Context;)Z
    ...
    invoke-virtual {p3, v1, v4, p4}, Landroidx/core/app/n$e;->a(ILjava/lang/CharSequence;Landroid/app/PendingIntent;)Landroidx/core/app/n$e;

    goto :goto_0

    :cond_2
    invoke-virtual {p3, p4}, Landroidx/core/app/n$e;->k(Landroid/app/PendingIntent;)Landroidx/core/app/n$e;
    ...
    invoke-virtual {p3, v6}, Landroidx/core/app/n$e;->x(I)Landroidx/core/app/n$e;
    ...
    invoke-virtual {v6, v4}, Landroidx/core/app/n$e;->A(Ljava/lang/CharSequence;)Landroidx/core/app/n$e;
    ...
    invoke-virtual {v4, v6, v7}, Landroidx/core/app/n$e;->D(J)Landroidx/core/app/n$e;

    move-result-object v4

    invoke-virtual {v4, p4}, Landroidx/core/app/n$e;->k(Landroid/app/PendingIntent;)Landroidx/core/app/n$e;

    move-result-object p4

    invoke-virtual {p4, v1}, Landroidx/core/app/n$e;->l(Ljava/lang/CharSequence;)Landroidx/core/app/n$e;

    :goto_0
    invoke-static {}, Lw2/m;->h()Z
    ...
    invoke-static {v5, v1}, Lo2/c;->a(Landroid/app/NotificationManager;Ljava/lang/String;)Landroid/app/NotificationChannel;

    move-result-object p4

    invoke-static {p1}, Lr2/q;->b(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-static {v1, p1, p4}, Lcom/download/library/k;->a(Ljava/lang/String;Ljava/lang/CharSequence;I)Landroid/app/NotificationChannel;

    move-result-object p1

    invoke-static {v5, p1}, Lcom/download/library/g;->a(Landroid/app/NotificationManager;Landroid/app/NotificationChannel;)V

    goto :goto_1

    :cond_5
    invoke-static {p4}, Lo2/d;->a(Landroid/app/NotificationChannel;)Ljava/lang/CharSequence;
    ...
    invoke-static {p4, p1}, Lo2/e;->a(Landroid/app/NotificationChannel;Ljava/lang/CharSequence;)V

    invoke-static {v5, p4}, Lcom/download/library/g;->a(Landroid/app/NotificationManager;Landroid/app/NotificationChannel;)V

    :cond_6
    :goto_1
    invoke-virtual {p3, v1}, Landroidx/core/app/n$e;->i(Ljava/lang/String;)Landroidx/core/app/n$e;

    :goto_2
    invoke-virtual {p3}, Landroidx/core/app/n$e;->c()Landroid/app/Notification;
...
.method public final w(Landroid/app/Activity;Lp2/e;IILandroid/content/DialogInterface$OnCancelListener;)Z
    .locals 1
    ...
    .line 8
    invoke-static {p2, p4, v0}, Lr2/t;->c(Lp2/e;Landroid/content/Intent;I)Lr2/t;
    ...
    .line 12
    invoke-virtual {p0, p1, p3, p2, p5}, Lcom/google/android/gms/common/a;->q(Landroid/content/Context;ILr2/t;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
...
.method public final x(Landroid/content/Context;Lcom/google/android/gms/common/ConnectionResult;I)Z
    ...
    .line 1
    invoke-static {p1}, Ly2/b;->a(Landroid/content/Context;)Z
    ...
    invoke-static {p1, v1, p3, v0}, LB2/f;->a(Landroid/content/Context;ILandroid/content/Intent;I)Landroid/app/PendingIntent;
