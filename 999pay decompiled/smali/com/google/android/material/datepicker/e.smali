...
# direct methods
.method static a(Ljava/lang/Long;Ljava/lang/Long;)Landroidx/core/util/d;
    .locals 1

    .line 1
    const/4 v0, 0x0

    invoke-static {p0, p1, v0}, Lcom/google/android/material/datepicker/e;->b(Ljava/lang/Long;Ljava/lang/Long;Ljava/text/SimpleDateFormat;)Landroidx/core/util/d;
...
.method static b(Ljava/lang/Long;Ljava/lang/Long;Ljava/text/SimpleDateFormat;)Landroidx/core/util/d;
    .locals 5
    ...
    invoke-static {v0, v0}, Landroidx/core/util/d;->a(Ljava/lang/Object;Ljava/lang/Object;)Landroidx/core/util/d;
    ...
    invoke-static {p0, v0}, Landroidx/core/util/d;->a(Ljava/lang/Object;Ljava/lang/Object;)Landroidx/core/util/d;
    ...
    invoke-static {}, Lcom/google/android/material/datepicker/r;->q()Ljava/util/Calendar;
    ...
    invoke-static {p0, p1}, Landroidx/core/util/d;->a(Ljava/lang/Object;Ljava/lang/Object;)Landroidx/core/util/d;
...
.method static f(JLjava/util/Locale;)Ljava/lang/String;
    ...
    invoke-static {p2}, Lcom/google/android/material/datepicker/r;->c(Ljava/util/Locale;)Landroid/icu/text/DateFormat;
    ...
    :cond_0
    invoke-static {p2}, Lcom/google/android/material/datepicker/r;->j(Ljava/util/Locale;)Ljava/text/DateFormat;
...
.method static h(JLjava/util/Locale;)Ljava/lang/String;
    ...
    invoke-static {p2}, Lcom/google/android/material/datepicker/r;->d(Ljava/util/Locale;)Landroid/icu/text/DateFormat;
    ...
    :cond_0
    invoke-static {p2}, Lcom/google/android/material/datepicker/r;->h(Ljava/util/Locale;)Ljava/text/DateFormat;
...
.method static k(JLjava/util/Locale;)Ljava/lang/String;
    ...
    invoke-static {p2}, Lcom/google/android/material/datepicker/r;->s(Ljava/util/Locale;)Landroid/icu/text/DateFormat;
    ...
    :cond_0
    invoke-static {p2}, Lcom/google/android/material/datepicker/r;->i(Ljava/util/Locale;)Ljava/text/DateFormat;
...
.method static m(JLjava/util/Locale;)Ljava/lang/String;
    ...
    invoke-static {p2}, Lcom/google/android/material/datepicker/r;->t(Ljava/util/Locale;)Landroid/icu/text/DateFormat;
