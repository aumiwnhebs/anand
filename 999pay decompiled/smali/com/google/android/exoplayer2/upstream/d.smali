...
.field private final i:Lg2/p;

.field private final j:Lg2/p;

.field private final k:Z

.field private l:Lcom/google/common/base/p;
...
# direct methods
.method private constructor <init>(Ljava/lang/String;IIZLg2/p;Lcom/google/common/base/p;Z)V
    .locals 1
    ...
    iput-object p5, p0, Lcom/google/android/exoplayer2/upstream/d;->i:Lg2/p;

    iput-object p6, p0, Lcom/google/android/exoplayer2/upstream/d;->l:Lcom/google/common/base/p;

    new-instance p1, Lg2/p;

    invoke-direct {p1}, Lg2/p;-><init>()V

    iput-object p1, p0, Lcom/google/android/exoplayer2/upstream/d;->j:Lg2/p;
...
.method synthetic constructor <init>(Ljava/lang/String;IIZLg2/p;Lcom/google/common/base/p;ZLcom/google/android/exoplayer2/upstream/d$a;)V
    .locals 0

    .line 2
    invoke-direct/range {p0 .. p7}, Lcom/google/android/exoplayer2/upstream/d;-><init>(Ljava/lang/String;IIZLg2/p;Lcom/google/common/base/p;Z)V
...
.method private B(Lcom/google/android/exoplayer2/upstream/b;)Ljava/net/HttpURLConnection;
    .locals 25
    ...
    iget-wide v13, v12, Lcom/google/android/exoplayer2/upstream/b;->g:J

    iget-wide v9, v12, Lcom/google/android/exoplayer2/upstream/b;->h:J

    const/4 v15, 0x1

    invoke-virtual {v12, v15}, Lcom/google/android/exoplayer2/upstream/b;->d(I)Z
    ...
    invoke-direct/range {v0 .. v10}, Lcom/google/android/exoplayer2/upstream/d;->C(Ljava/net/URL;I[BJJZZLjava/util/Map;)Ljava/net/HttpURLConnection;
    ...
    :goto_1
    invoke-direct {v11, v1, v2, v12}, Lcom/google/android/exoplayer2/upstream/d;->z(Ljava/net/URL;Ljava/lang/String;Lcom/google/android/exoplayer2/upstream/b;)Ljava/net/URL;
...
.method private C(Ljava/net/URL;I[BJJZZLjava/util/Map;)Ljava/net/HttpURLConnection;
    ...
    .line 1
    invoke-virtual {p0, p1}, Lcom/google/android/exoplayer2/upstream/d;->E(Ljava/net/URL;)Ljava/net/HttpURLConnection;
    ...
    iget-object v1, p0, Lcom/google/android/exoplayer2/upstream/d;->i:Lg2/p;

    if-eqz v1, :cond_0

    invoke-virtual {v1}, Lg2/p;->b()Ljava/util/Map;
    ...
    :cond_0
    iget-object v1, p0, Lcom/google/android/exoplayer2/upstream/d;->j:Lg2/p;
    ...
    :cond_1
    invoke-static {p4, p5, p6, p7}, Lg2/q;->a(JJ)Ljava/lang/String;
    ...
    invoke-static {p2}, Lcom/google/android/exoplayer2/upstream/b;->c(I)Ljava/lang/String;
...
.method private G(JLcom/google/android/exoplayer2/upstream/b;)V
    .locals 7
    ...
    invoke-static {v4}, Lcom/google/android/exoplayer2/util/W;->j(Ljava/lang/Object;)Ljava/lang/Object;
...
.method private z(Ljava/net/URL;Ljava/lang/String;Lcom/google/android/exoplayer2/upstream/b;)Ljava/net/URL;
    .locals 5
    ...
    invoke-direct {p1, p2, p3, v1, v0}, Lcom/google/android/exoplayer2/upstream/HttpDataSource$HttpDataSourceException;-><init>(Ljava/lang/String;Lcom/google/android/exoplayer2/upstream/b;II)V
    ...
    invoke-direct {v2, p1, p3, v1, v0}, Lcom/google/android/exoplayer2/upstream/HttpDataSource$HttpDataSourceException;-><init>(Ljava/lang/String;Lcom/google/android/exoplayer2/upstream/b;II)V
    ...
    invoke-direct {p2, p1, p3, v1, v0}, Lcom/google/android/exoplayer2/upstream/HttpDataSource$HttpDataSourceException;-><init>(Ljava/io/IOException;Lcom/google/android/exoplayer2/upstream/b;II)V
...
.method public b(Lcom/google/android/exoplayer2/upstream/b;)J
    ...
    .line 1
    iput-object p1, p0, Lcom/google/android/exoplayer2/upstream/d;->m:Lcom/google/android/exoplayer2/upstream/b;
    ...
    :try_start_0
    invoke-direct {p0, p1}, Lcom/google/android/exoplayer2/upstream/d;->B(Lcom/google/android/exoplayer2/upstream/b;)Ljava/net/HttpURLConnection;
    ...
    iget-object v7, p0, Lcom/google/android/exoplayer2/upstream/d;->l:Lcom/google/common/base/p;
    ...
    :cond_1
    invoke-direct {p0}, Lcom/google/android/exoplayer2/upstream/d;->y()V
    ...
    :cond_3
    invoke-static {v3}, Lcom/google/android/exoplayer2/upstream/d;->A(Ljava/net/HttpURLConnection;)Z
    ...
    invoke-static {v6, v5}, Lg2/q;->b(Ljava/lang/String;Ljava/lang/String;)J
    ...
    :try_start_2
    invoke-direct {p0, v0, v1, p1}, Lcom/google/android/exoplayer2/upstream/d;->G(JLcom/google/android/exoplayer2/upstream/b;)V
    :try_end_2
    ...
    invoke-direct {v1, v0, p1, v5, v2}, Lcom/google/android/exoplayer2/upstream/HttpDataSource$HttpDataSourceException;-><init>(Ljava/io/IOException;Lcom/google/android/exoplayer2/upstream/b;II)V
    ...
    invoke-static {v5}, Lg2/q;->c(Ljava/lang/String;)J

    move-result-wide v5

    iget-wide v11, p1, Lcom/google/android/exoplayer2/upstream/b;->g:J
    ...
    :try_start_3
    invoke-static {v0}, Lcom/google/android/exoplayer2/util/W;->V0(Ljava/io/InputStream;)[B
    ...
    :cond_c
    sget-object v0, Lcom/google/android/exoplayer2/util/W;->f:[B
    :try_end_3
    ...
    invoke-direct/range {v5 .. v11}, Lcom/google/android/exoplayer2/upstream/HttpDataSource$InvalidResponseCodeException;-><init>(ILjava/lang/String;Ljava/io/IOException;Ljava/util/Map;Lcom/google/android/exoplayer2/upstream/b;[B)V
    ...
    invoke-static {v0, p1, v2}, Lcom/google/android/exoplayer2/upstream/HttpDataSource$HttpDataSourceException;->createForIOException(Ljava/io/IOException;Lcom/google/android/exoplayer2/upstream/b;I)Lcom/google/android/exoplayer2/upstream/HttpDataSource$HttpDataSourceException;
...
.method public close()V
    ...
    invoke-static {v3, v5, v6}, Lcom/google/android/exoplayer2/upstream/d;->D(Ljava/net/HttpURLConnection;J)V
    :try_end_0
    ...
    check-cast v4, Lcom/google/android/exoplayer2/upstream/b;
...
.method public d([BII)I
    ...
    .line 1
    :try_start_0
    invoke-direct {p0, p1, p2, p3}, Lcom/google/android/exoplayer2/upstream/d;->F([BII)I
    ...
    iget-object p2, p0, Lcom/google/android/exoplayer2/upstream/d;->m:Lcom/google/android/exoplayer2/upstream/b;

    invoke-static {p2}, Lcom/google/android/exoplayer2/util/W;->j(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {p1, p2, p3}, Lcom/google/android/exoplayer2/upstream/HttpDataSource$HttpDataSourceException;->createForIOException(Ljava/io/IOException;Lcom/google/android/exoplayer2/upstream/b;I)Lcom/google/android/exoplayer2/upstream/HttpDataSource$HttpDataSourceException;
