...
.method private static a(Landroid/opengl/EGLDisplay;)Landroid/opengl/EGLConfig;
    ...
    sget-object v2, Lcom/google/android/exoplayer2/util/EGLSurfaceTexture;->g:[I
    ...
    invoke-static {p0, v5}, Lcom/google/android/exoplayer2/util/W;->B(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
...
.method private static c(Landroid/opengl/EGLDisplay;Landroid/opengl/EGLConfig;Landroid/opengl/EGLContext;I)Landroid/opengl/EGLSurface;
    ...
    invoke-direct {p0, p1, v3}, Lcom/google/android/exoplayer2/util/EGLSurfaceTexture$GlException;-><init>(Ljava/lang/String;Lcom/google/android/exoplayer2/util/EGLSurfaceTexture$a;)V
...
.method public h(I)V
    ...
    iput-object v0, p0, Lcom/google/android/exoplayer2/util/EGLSurfaceTexture;->c:Landroid/opengl/EGLDisplay;
    ...
    iget-object v1, p0, Lcom/google/android/exoplayer2/util/EGLSurfaceTexture;->c:Landroid/opengl/EGLDisplay;
    ...
    iput-object v1, p0, Lcom/google/android/exoplayer2/util/EGLSurfaceTexture;->d:Landroid/opengl/EGLContext;

    iget-object v2, p0, Lcom/google/android/exoplayer2/util/EGLSurfaceTexture;->c:Landroid/opengl/EGLDisplay;
    ...
    iput-object p1, p0, Lcom/google/android/exoplayer2/util/EGLSurfaceTexture;->e:Landroid/opengl/EGLSurface;
    ...
    iput-object p1, p0, Lcom/google/android/exoplayer2/util/EGLSurfaceTexture;->f:Landroid/graphics/SurfaceTexture;
...
.method public i()V
    ...
    :try_start_0
    iget-object v2, p0, Lcom/google/android/exoplayer2/util/EGLSurfaceTexture;->f:Landroid/graphics/SurfaceTexture;
    ...
    :cond_1
    iget-object v2, p0, Lcom/google/android/exoplayer2/util/EGLSurfaceTexture;->e:Landroid/opengl/EGLSurface;
    ...
    iget-object v3, p0, Lcom/google/android/exoplayer2/util/EGLSurfaceTexture;->e:Landroid/opengl/EGLSurface;

    invoke-static {v2, v3}, Landroid/opengl/EGL14;->eglDestroySurface(Landroid/opengl/EGLDisplay;Landroid/opengl/EGLSurface;)Z

    :cond_2
    iget-object v2, p0, Lcom/google/android/exoplayer2/util/EGLSurfaceTexture;->d:Landroid/opengl/EGLContext;

    if-eqz v2, :cond_3

    iget-object v3, p0, Lcom/google/android/exoplayer2/util/EGLSurfaceTexture;->c:Landroid/opengl/EGLDisplay;
    ...
    :cond_4
    iget-object v0, p0, Lcom/google/android/exoplayer2/util/EGLSurfaceTexture;->c:Landroid/opengl/EGLDisplay;
    ...
    :cond_5
    iput-object v1, p0, Lcom/google/android/exoplayer2/util/EGLSurfaceTexture;->c:Landroid/opengl/EGLDisplay;

    iput-object v1, p0, Lcom/google/android/exoplayer2/util/EGLSurfaceTexture;->d:Landroid/opengl/EGLContext;

    iput-object v1, p0, Lcom/google/android/exoplayer2/util/EGLSurfaceTexture;->e:Landroid/opengl/EGLSurface;

    iput-object v1, p0, Lcom/google/android/exoplayer2/util/EGLSurfaceTexture;->f:Landroid/graphics/SurfaceTexture;
    ...
    iget-object v4, p0, Lcom/google/android/exoplayer2/util/EGLSurfaceTexture;->e:Landroid/opengl/EGLSurface;

    invoke-static {v3, v4}, Landroid/opengl/EGL14;->eglDestroySurface(Landroid/opengl/EGLDisplay;Landroid/opengl/EGLSurface;)Z

    :cond_7
    iget-object v3, p0, Lcom/google/android/exoplayer2/util/EGLSurfaceTexture;->d:Landroid/opengl/EGLContext;

    if-eqz v3, :cond_8

    iget-object v4, p0, Lcom/google/android/exoplayer2/util/EGLSurfaceTexture;->c:Landroid/opengl/EGLDisplay;
