...
.method public static a(Ljava/lang/Object;)Landroid/support/v4/media/MediaDescriptionCompat;
    ...
    invoke-static {p0}, Landroid/support/v4/media/f;->a(Ljava/lang/Object;)Landroid/net/Uri;
...
.method public b()Ljava/lang/Object;
    ...
    invoke-static {v1, v2}, Landroid/support/v4/media/c$a;->g(Ljava/lang/Object;Ljava/lang/String;)V

    iget-object v2, p0, Landroid/support/v4/media/MediaDescriptionCompat;->b:Ljava/lang/CharSequence;

    invoke-static {v1, v2}, Landroid/support/v4/media/c$a;->i(Ljava/lang/Object;Ljava/lang/CharSequence;)V

    iget-object v2, p0, Landroid/support/v4/media/MediaDescriptionCompat;->c:Ljava/lang/CharSequence;

    invoke-static {v1, v2}, Landroid/support/v4/media/c$a;->h(Ljava/lang/Object;Ljava/lang/CharSequence;)V

    iget-object v2, p0, Landroid/support/v4/media/MediaDescriptionCompat;->d:Ljava/lang/CharSequence;

    invoke-static {v1, v2}, Landroid/support/v4/media/c$a;->c(Ljava/lang/Object;Ljava/lang/CharSequence;)V

    iget-object v2, p0, Landroid/support/v4/media/MediaDescriptionCompat;->e:Landroid/graphics/Bitmap;

    invoke-static {v1, v2}, Landroid/support/v4/media/c$a;->e(Ljava/lang/Object;Landroid/graphics/Bitmap;)V

    iget-object v2, p0, Landroid/support/v4/media/MediaDescriptionCompat;->f:Landroid/net/Uri;

    invoke-static {v1, v2}, Landroid/support/v4/media/c$a;->f(Ljava/lang/Object;Landroid/net/Uri;)V
    ...
    :cond_1
    invoke-static {v1, v2}, Landroid/support/v4/media/c$a;->d(Ljava/lang/Object;Landroid/os/Bundle;)V

    if-lt v0, v3, :cond_2

    iget-object v0, p0, Landroid/support/v4/media/MediaDescriptionCompat;->j:Landroid/net/Uri;

    invoke-static {v1, v0}, Landroid/support/v4/media/f$a;->a(Ljava/lang/Object;Landroid/net/Uri;)V
