...
.method private final cancelOnRejection(Lkotlin/coroutines/CoroutineContext;Ljava/lang/Runnable;)V
    ...
    invoke-static {p1, v0}, Lkotlinx/coroutines/o1;->cancel(Lkotlin/coroutines/CoroutineContext;Ljava/util/concurrent/CancellationException;)V

    invoke-static {}, Lkotlinx/coroutines/t0;->getIO()Lkotlinx/coroutines/CoroutineDispatcher;
...
.method public bridge synthetic getImmediate()Lkotlinx/coroutines/android/d;
    .locals 1
...
.method public bridge synthetic getImmediate()Lkotlinx/coroutines/v1;
    .locals 1
...
.method public invokeOnTimeout(JLjava/lang/Runnable;Lkotlin/coroutines/CoroutineContext;)Lkotlinx/coroutines/u0;
    ...
    invoke-static {p1, p2, v1, v2}, Ln0/s;->coerceAtMost(JJ)J
...
.method public scheduleResumeAfterDelay(JLkotlinx/coroutines/n;)V
    ...
    invoke-direct {v0, p3, p0}, Lkotlinx/coroutines/android/HandlerContext$a;-><init>(Lkotlinx/coroutines/n;Lkotlinx/coroutines/android/HandlerContext;)V

    iget-object v1, p0, Lkotlinx/coroutines/android/HandlerContext;->handler:Landroid/os/Handler;

    const-wide v2, 0x3fffffffffffffffL    # 1.9999999999999998

    invoke-static {p1, p2, v2, v3}, Ln0/s;->coerceAtMost(JJ)J
    ...
    invoke-interface {p3, p1}, Lkotlinx/coroutines/n;->invokeOnCancellation(Lj0/l;)V

    goto :goto_0

    :cond_0
    invoke-interface {p3}, Lkotlinx/coroutines/n;->getContext()Lkotlin/coroutines/CoroutineContext;
...
.method public toString()Ljava/lang/String;
    ...
    invoke-virtual {p0}, Lkotlinx/coroutines/v1;->toStringInternalImpl()Ljava/lang/String;
