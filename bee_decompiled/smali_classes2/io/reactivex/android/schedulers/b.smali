...
.method constructor <init>(Landroid/os/Handler;Z)V
    ...
    iput-object p1, p0, Lio/reactivex/android/schedulers/b;->handler:Landroid/os/Handler;

    iput-boolean p2, p0, Lio/reactivex/android/schedulers/b;->async:Z
...
.method public createWorker()Lio/reactivex/h0$c;
    ...
    iget-object v1, p0, Lio/reactivex/android/schedulers/b;->handler:Landroid/os/Handler;

    iget-boolean v2, p0, Lio/reactivex/android/schedulers/b;->async:Z
...
.method public scheduleDirect(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Lio/reactivex/disposables/b;
    ...
    iget-object p1, p0, Lio/reactivex/android/schedulers/b;->handler:Landroid/os/Handler;

    invoke-static {p1, v0}, Landroid/os/Message;->obtain(Landroid/os/Handler;Ljava/lang/Runnable;)Landroid/os/Message;

    move-result-object p1

    iget-boolean v1, p0, Lio/reactivex/android/schedulers/b;->async:Z
