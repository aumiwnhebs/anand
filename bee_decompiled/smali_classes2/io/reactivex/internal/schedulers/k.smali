...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lio/reactivex/internal/schedulers/k;->SHUTDOWN:Ljava/util/concurrent/ScheduledExecutorService;
    ...
    sput-object v2, Lio/reactivex/internal/schedulers/k;->SINGLE_THREAD_FACTORY:Lio/reactivex/internal/schedulers/RxThreadFactory;
...
.method public constructor <init>()V
    ...
    .line 1
    sget-object v0, Lio/reactivex/internal/schedulers/k;->SINGLE_THREAD_FACTORY:Lio/reactivex/internal/schedulers/RxThreadFactory;
...
.method public constructor <init>(Ljava/util/concurrent/ThreadFactory;)V
    ...
    iput-object v0, p0, Lio/reactivex/internal/schedulers/k;->executor:Ljava/util/concurrent/atomic/AtomicReference;

    .line 4
    iput-object p1, p0, Lio/reactivex/internal/schedulers/k;->threadFactory:Ljava/util/concurrent/ThreadFactory;

    .line 5
    invoke-static {p1}, Lio/reactivex/internal/schedulers/k;->createExecutor(Ljava/util/concurrent/ThreadFactory;)Ljava/util/concurrent/ScheduledExecutorService;
...
.method static createExecutor(Ljava/util/concurrent/ThreadFactory;)Ljava/util/concurrent/ScheduledExecutorService;
    ...
    invoke-static {p0}, Lio/reactivex/internal/schedulers/j;->create(Ljava/util/concurrent/ThreadFactory;)Ljava/util/concurrent/ScheduledExecutorService;
...
.method public createWorker()Lio/reactivex/h0$c;
    ...
    iget-object v1, p0, Lio/reactivex/internal/schedulers/k;->executor:Ljava/util/concurrent/atomic/AtomicReference;
...
.method public scheduleDirect(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Lio/reactivex/disposables/b;
    ...
    :try_start_0
    iget-object p1, p0, Lio/reactivex/internal/schedulers/k;->executor:Ljava/util/concurrent/atomic/AtomicReference;
...
.method public schedulePeriodicallyDirect(Ljava/lang/Runnable;JJLjava/util/concurrent/TimeUnit;)Lio/reactivex/disposables/b;
    ...
    iget-object p4, p0, Lio/reactivex/internal/schedulers/k;->executor:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    :goto_0
    invoke-virtual {p5, p1}, Lio/reactivex/internal/schedulers/d;->setFirst(Ljava/util/concurrent/Future;)V
    :try_end_0
    .catch Ljava/util/concurrent/RejectedExecutionException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public shutdown()V
    ...
    iget-object v0, p0, Lio/reactivex/internal/schedulers/k;->executor:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    sget-object v1, Lio/reactivex/internal/schedulers/k;->SHUTDOWN:Ljava/util/concurrent/ScheduledExecutorService;
...
.method public start()V
    ...
    sget-object v2, Lio/reactivex/internal/schedulers/k;->SHUTDOWN:Ljava/util/concurrent/ScheduledExecutorService;
    ...
    iget-object v0, p0, Lio/reactivex/internal/schedulers/k;->threadFactory:Ljava/util/concurrent/ThreadFactory;

    invoke-static {v0}, Lio/reactivex/internal/schedulers/k;->createExecutor(Ljava/util/concurrent/ThreadFactory;)Ljava/util/concurrent/ScheduledExecutorService;

    move-result-object v0

    :cond_3
    iget-object v2, p0, Lio/reactivex/internal/schedulers/k;->executor:Ljava/util/concurrent/atomic/AtomicReference;
