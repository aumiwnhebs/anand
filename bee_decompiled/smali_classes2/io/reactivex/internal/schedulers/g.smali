...
.method public constructor <init>(Ljava/util/concurrent/ThreadFactory;)V
    ...
    invoke-static {p1}, Lio/reactivex/internal/schedulers/j;->create(Ljava/util/concurrent/ThreadFactory;)Ljava/util/concurrent/ScheduledExecutorService;

    move-result-object p1

    iput-object p1, p0, Lio/reactivex/internal/schedulers/g;->executor:Ljava/util/concurrent/ScheduledExecutorService;
...
.method public dispose()V
    ...
    iget-boolean v0, p0, Lio/reactivex/internal/schedulers/g;->disposed:Z

    if-nez v0, :cond_0

    const/4 v0, 0x1

    iput-boolean v0, p0, Lio/reactivex/internal/schedulers/g;->disposed:Z

    iget-object v0, p0, Lio/reactivex/internal/schedulers/g;->executor:Ljava/util/concurrent/ScheduledExecutorService;
...
.method public schedule(Ljava/lang/Runnable;)Lio/reactivex/disposables/b;
    ...
    .line 1
    invoke-virtual {p0, p1, v0, v1, v2}, Lio/reactivex/internal/schedulers/g;->schedule(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Lio/reactivex/disposables/b;
...
.method public scheduleActual(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;Lio/reactivex/internal/disposables/a;)Lio/reactivex/internal/schedulers/ScheduledRunnable;
    .locals 3
    ...
    invoke-interface {p5, v0}, Lio/reactivex/internal/disposables/a;->add(Lio/reactivex/disposables/b;)Z
    ...
    :try_start_0
    iget-object p1, p0, Lio/reactivex/internal/schedulers/g;->executor:Ljava/util/concurrent/ScheduledExecutorService;
    ...
    invoke-interface {p5, v0}, Lio/reactivex/internal/disposables/a;->remove(Lio/reactivex/disposables/b;)Z
...
.method public schedulePeriodicallyDirect(Ljava/lang/Runnable;JJLjava/util/concurrent/TimeUnit;)Lio/reactivex/disposables/b;
    ...
    iget-object p5, p0, Lio/reactivex/internal/schedulers/g;->executor:Ljava/util/concurrent/ScheduledExecutorService;
    ...
    :goto_0
    invoke-virtual {p4, p1}, Lio/reactivex/internal/schedulers/d;->setFirst(Ljava/util/concurrent/Future;)V
    :try_end_0
    .catch Ljava/util/concurrent/RejectedExecutionException; {:try_start_0 .. :try_end_0} :catch_0
