...
.method final drainLoop()V
    ...
    :cond_3
    iget-object v13, v0, Lio/reactivex/internal/subscriptions/SubscriptionArbiter;->actual:Lk1/d;
    ...
    invoke-interface {v13}, Lk1/d;->cancel()V

    iput-object v4, v0, Lio/reactivex/internal/subscriptions/SubscriptionArbiter;->actual:Lk1/d;

    :cond_4
    if-eqz v8, :cond_a

    invoke-interface {v8}, Lk1/d;->cancel()V
    ...
    :cond_8
    iput-object v8, v0, Lio/reactivex/internal/subscriptions/SubscriptionArbiter;->actual:Lk1/d;

    cmp-long v9, v14, v2

    if-eqz v9, :cond_a

    invoke-static {v5, v6, v14, v15}, Lio/reactivex/internal/util/b;->addCap(JJ)J
    ...
    invoke-static {v5, v6, v9, v10}, Lio/reactivex/internal/util/b;->addCap(JJ)J
    ...
    invoke-interface {v7, v5, v6}, Lk1/d;->request(J)V
...
.method public final request(J)V
    ...
    :cond_1
    iget-object v0, p0, Lio/reactivex/internal/subscriptions/SubscriptionArbiter;->actual:Lk1/d;
...
.method public final setSubscription(Lk1/d;)V
    .locals 4
    ...
    :cond_1
    iput-object p1, p0, Lio/reactivex/internal/subscriptions/SubscriptionArbiter;->actual:Lk1/d;
