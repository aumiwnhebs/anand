...
.method constructor <init>(Lio/reactivex/b0;)V
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/observable/ObservableCreate$SerializedEmitter;->emitter:Lio/reactivex/b0;
...
.method drainLoop()V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/ObservableCreate$SerializedEmitter;->emitter:Lio/reactivex/b0;
    ...
    :cond_0
    :goto_0
    invoke-interface {v0}, Lio/reactivex/b0;->isDisposed()Z
    ...
    invoke-interface {v0, v1}, Lio/reactivex/b0;->onError(Ljava/lang/Throwable;)V
    ...
    invoke-interface {v0}, Lio/reactivex/b0;->onComplete()V
    ...
    :cond_5
    invoke-interface {v0, v6}, Lio/reactivex/b0;->onNext(Ljava/lang/Object;)V
...
.method public onNext(Ljava/lang/Object;)V
    ...
    invoke-interface {v0, p1}, Lio/reactivex/b0;->onNext(Ljava/lang/Object;)V
...
.method public setCancellable(Lz/f;)V
    .locals 1

    iget-object v0, p0, Lio/reactivex/internal/operators/observable/ObservableCreate$SerializedEmitter;->emitter:Lio/reactivex/b0;

    invoke-interface {v0, p1}, Lio/reactivex/b0;->setCancellable(Lz/f;)V
...
.method public setDisposable(Lio/reactivex/disposables/b;)V
    ...
    invoke-interface {v0, p1}, Lio/reactivex/b0;->setDisposable(Lio/reactivex/disposables/b;)V
