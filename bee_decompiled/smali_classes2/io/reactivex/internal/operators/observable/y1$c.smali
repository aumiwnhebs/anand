...
# direct methods
.method constructor <init>(Lio/reactivex/g0;Lio/reactivex/e0;Lz/o;I)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/observable/y1$c;->boundary:Ljava/util/concurrent/atomic/AtomicReference;

    new-instance p1, Ljava/util/concurrent/atomic/AtomicLong;

    invoke-direct {p1}, Ljava/util/concurrent/atomic/AtomicLong;-><init>()V

    iput-object p1, p0, Lio/reactivex/internal/operators/observable/y1$c;->windows:Ljava/util/concurrent/atomic/AtomicLong;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>()V

    iput-object v0, p0, Lio/reactivex/internal/operators/observable/y1$c;->stopWindows:Ljava/util/concurrent/atomic/AtomicBoolean;

    iput-object p2, p0, Lio/reactivex/internal/operators/observable/y1$c;->open:Lio/reactivex/e0;

    iput-object p3, p0, Lio/reactivex/internal/operators/observable/y1$c;->close:Lz/o;

    iput p4, p0, Lio/reactivex/internal/operators/observable/y1$c;->bufferSize:I

    new-instance p2, Lio/reactivex/disposables/a;

    invoke-direct {p2}, Lio/reactivex/disposables/a;-><init>()V

    iput-object p2, p0, Lio/reactivex/internal/operators/observable/y1$c;->resources:Lio/reactivex/disposables/a;

    new-instance p2, Ljava/util/ArrayList;

    invoke-direct {p2}, Ljava/util/ArrayList;-><init>()V

    iput-object p2, p0, Lio/reactivex/internal/operators/observable/y1$c;->ws:Ljava/util/List;
...
.method close(Lio/reactivex/internal/operators/observable/y1$a;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/y1$c;->resources:Lio/reactivex/disposables/a;
    ...
    iget-object p1, p1, Lio/reactivex/internal/operators/observable/y1$a;->w:Lio/reactivex/subjects/UnicastSubject;
    ...
    invoke-virtual {p0}, Lio/reactivex/internal/operators/observable/y1$c;->drainLoop()V
...
.method public dispose()V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/y1$c;->stopWindows:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/y1$c;->boundary:Ljava/util/concurrent/atomic/AtomicReference;

    invoke-static {v0}, Lio/reactivex/internal/disposables/DisposableHelper;->dispose(Ljava/util/concurrent/atomic/AtomicReference;)Z

    iget-object v0, p0, Lio/reactivex/internal/operators/observable/y1$c;->windows:Ljava/util/concurrent/atomic/AtomicLong;
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/y1$c;->upstream:Lio/reactivex/disposables/b;
...
.method drainLoop()V
    ...
    iget-object v2, p0, Lio/reactivex/internal/operators/observable/y1$c;->ws:Ljava/util/List;
    ...
    invoke-virtual {p0}, Lio/reactivex/internal/operators/observable/y1$c;->disposeBoundary()V
    ...
    iget-object v5, v6, Lio/reactivex/internal/operators/observable/y1$d;->w:Lio/reactivex/subjects/UnicastSubject;
    ...
    iget-object v5, p0, Lio/reactivex/internal/operators/observable/y1$c;->windows:Ljava/util/concurrent/atomic/AtomicLong;
    ...
    :cond_6
    iget-object v5, p0, Lio/reactivex/internal/operators/observable/y1$c;->stopWindows:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    :cond_7
    iget v5, p0, Lio/reactivex/internal/operators/observable/y1$c;->bufferSize:I
    ...
    :try_start_0
    iget-object v7, p0, Lio/reactivex/internal/operators/observable/y1$c;->close:Lz/o;

    iget-object v6, v6, Lio/reactivex/internal/operators/observable/y1$d;->open:Ljava/lang/Object;
    ...
    iget-object v5, p0, Lio/reactivex/internal/operators/observable/y1$c;->resources:Lio/reactivex/disposables/a;
    ...
    iget-object v6, p0, Lio/reactivex/internal/operators/observable/y1$c;->stopWindows:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public onNext(Ljava/lang/Object;)V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/y1$c;->ws:Ljava/util/List;
...
.method public onSubscribe(Lio/reactivex/disposables/b;)V
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/observable/y1$c;->upstream:Lio/reactivex/disposables/b;

    iget-object p1, p0, Lio/reactivex/internal/observers/k;->downstream:Lio/reactivex/g0;

    invoke-interface {p1, p0}, Lio/reactivex/g0;->onSubscribe(Lio/reactivex/disposables/b;)V

    iget-object p1, p0, Lio/reactivex/internal/operators/observable/y1$c;->stopWindows:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/y1$c;->open:Lio/reactivex/e0;
