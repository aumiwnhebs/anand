...
# direct methods
.method constructor <init>(Lk1/c;II)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {p0, p1, p2, p3}, Lio/reactivex/internal/operators/parallel/ParallelJoin$JoinSubscriptionBase;-><init>(Lk1/c;II)V
...
.method drainLoop()V
    ...
    iget-object v3, v0, Lio/reactivex/internal/operators/parallel/ParallelJoin$JoinSubscriptionBase;->downstream:Lk1/c;
    ...
    invoke-interface {v3, v12}, Lk1/c;->onError(Ljava/lang/Throwable;)V
    ...
    iget-object v13, v4, Lio/reactivex/internal/operators/parallel/ParallelJoin$JoinInnerSubscriber;->queue:La0/n;

    if-eqz v13, :cond_5

    invoke-interface {v13}, La0/n;->poll()Ljava/lang/Object;

    move-result-object v13

    if-eqz v13, :cond_5

    invoke-interface {v3, v13}, Lk1/c;->onNext(Ljava/lang/Object;)V
    ...
    invoke-interface {v3, v4}, Lk1/c;->onError(Ljava/lang/Throwable;)V
    ...
    iget-object v13, v13, Lio/reactivex/internal/operators/parallel/ParallelJoin$JoinInnerSubscriber;->queue:La0/n;

    if-eqz v13, :cond_c

    invoke-interface {v13}, La0/o;->isEmpty()Z
...
.method public onNext(Lio/reactivex/internal/operators/parallel/ParallelJoin$JoinInnerSubscriber;Ljava/lang/Object;)V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/parallel/ParallelJoin$JoinSubscriptionBase;->downstream:Lk1/c;
    ...
    :cond_1
    invoke-virtual {p1}, Lio/reactivex/internal/operators/parallel/ParallelJoin$JoinInnerSubscriber;->getQueue()La0/n;

    move-result-object p1

    invoke-interface {p1, p2}, La0/n;->offer(Ljava/lang/Object;)Z
    ...
    iget-object p2, p0, Lio/reactivex/internal/operators/parallel/ParallelJoin$JoinSubscriptionBase;->downstream:Lk1/c;
