...
# direct methods
.method constructor <init>(La0/a;Lz/o;Lz/c;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/parallel/h$b;->downstream:La0/a;

    iput-object p2, p0, Lio/reactivex/internal/operators/parallel/h$b;->mapper:Lz/o;

    iput-object p3, p0, Lio/reactivex/internal/operators/parallel/h$b;->errorHandler:Lz/c;
...
.method public cancel()V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/parallel/h$b;->upstream:Lk1/d;
...
.method public onComplete()V
    ...
    iget-boolean v0, p0, Lio/reactivex/internal/operators/parallel/h$b;->done:Z
    ...
    iput-boolean v0, p0, Lio/reactivex/internal/operators/parallel/h$b;->done:Z

    iget-object v0, p0, Lio/reactivex/internal/operators/parallel/h$b;->downstream:La0/a;
...
.method public onNext(Ljava/lang/Object;)V
    ...
    iget-boolean p1, p0, Lio/reactivex/internal/operators/parallel/h$b;->done:Z

    if-nez p1, :cond_0

    iget-object p1, p0, Lio/reactivex/internal/operators/parallel/h$b;->upstream:Lk1/d;
...
.method public onSubscribe(Lk1/d;)V
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/parallel/h$b;->upstream:Lk1/d;

    iget-object p1, p0, Lio/reactivex/internal/operators/parallel/h$b;->downstream:La0/a;
...
.method public tryOnNext(Ljava/lang/Object;)Z
    ...
    :cond_1
    :try_start_0
    iget-object v0, p0, Lio/reactivex/internal/operators/parallel/h$b;->mapper:Lz/o;
    ...
    :try_start_1
    iget-object v4, p0, Lio/reactivex/internal/operators/parallel/h$b;->errorHandler:Lz/c;
    ...
    sget-object v5, Lio/reactivex/internal/operators/parallel/h$a;->$SwitchMap$io$reactivex$parallel$ParallelFailureHandling:[I
