...
# direct methods
.method constructor <init>(La0/a;ILio/reactivex/internal/queue/SpscArrayQueue;Lio/reactivex/h0$c;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/parallel/ParallelRunOn$RunOnConditionalSubscriber;->downstream:La0/a;
...
.method public onSubscribe(Lk1/d;)V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/parallel/ParallelRunOn$BaseRunOnSubscriber;->upstream:Lk1/d;
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/parallel/ParallelRunOn$BaseRunOnSubscriber;->upstream:Lk1/d;

    iget-object v0, p0, Lio/reactivex/internal/operators/parallel/ParallelRunOn$RunOnConditionalSubscriber;->downstream:La0/a;
...
.method public run()V
    ...
    iget-object v3, v0, Lio/reactivex/internal/operators/parallel/ParallelRunOn$RunOnConditionalSubscriber;->downstream:La0/a;
    ...
    invoke-interface {v3, v15}, La0/a;->onError(Ljava/lang/Throwable;)V

    iget-object v1, v0, Lio/reactivex/internal/operators/parallel/ParallelRunOn$BaseRunOnSubscriber;->worker:Lio/reactivex/h0$c;
    ...
    invoke-interface {v3}, La0/a;->onComplete()V
    ...
    :cond_6
    invoke-interface {v3, v15}, La0/a;->tryOnNext(Ljava/lang/Object;)Z
    ...
    iget-object v13, v0, Lio/reactivex/internal/operators/parallel/ParallelRunOn$BaseRunOnSubscriber;->upstream:Lk1/d;

    int-to-long v14, v1

    invoke-interface {v13, v14, v15}, Lk1/d;->request(J)V
    ...
    invoke-interface {v3, v13}, La0/a;->onError(Ljava/lang/Throwable;)V
