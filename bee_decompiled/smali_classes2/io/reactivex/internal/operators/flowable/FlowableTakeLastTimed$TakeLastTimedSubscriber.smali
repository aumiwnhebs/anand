...
# direct methods
.method constructor <init>(Lk1/c;JJLjava/util/concurrent/TimeUnit;Lio/reactivex/h0;IZ)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableTakeLastTimed$TakeLastTimedSubscriber;->downstream:Lk1/c;
    ...
    iput-object p7, p0, Lio/reactivex/internal/operators/flowable/FlowableTakeLastTimed$TakeLastTimedSubscriber;->scheduler:Lio/reactivex/h0;
...
.method public cancel()V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableTakeLastTimed$TakeLastTimedSubscriber;->upstream:Lk1/d;
...
.method checkTerminated(ZLk1/c;Z)Z
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(Z",
    ...
    invoke-interface {p2, p3}, Lk1/c;->onError(Ljava/lang/Throwable;)V
...
.method drain()V
    ...
    :cond_0
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableTakeLastTimed$TakeLastTimedSubscriber;->downstream:Lk1/c;
    ...
    invoke-virtual {p0, v5, v0, v2}, Lio/reactivex/internal/operators/flowable/FlowableTakeLastTimed$TakeLastTimedSubscriber;->checkTerminated(ZLk1/c;Z)Z
    ...
    :goto_1
    invoke-virtual {p0, v11, v0, v2}, Lio/reactivex/internal/operators/flowable/FlowableTakeLastTimed$TakeLastTimedSubscriber;->checkTerminated(ZLk1/c;Z)Z
    ...
    invoke-static {v5, v9, v10}, Lio/reactivex/internal/util/b;->produced(Ljava/util/concurrent/atomic/AtomicLong;J)J
    ...
    invoke-interface {v0, v11}, Lk1/c;->onNext(Ljava/lang/Object;)V
...
.method public onComplete()V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableTakeLastTimed$TakeLastTimedSubscriber;->scheduler:Lio/reactivex/h0;
...
.method public onNext(Ljava/lang/Object;)V
    ...
    iget-object v1, p0, Lio/reactivex/internal/operators/flowable/FlowableTakeLastTimed$TakeLastTimedSubscriber;->scheduler:Lio/reactivex/h0;
    ...
    invoke-virtual {v1, v2}, Lio/reactivex/h0;->now(Ljava/util/concurrent/TimeUnit;)J
...
.method public onSubscribe(Lk1/d;)V
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableTakeLastTimed$TakeLastTimedSubscriber;->upstream:Lk1/d;
...
.method trim(JLio/reactivex/internal/queue/a;)V
    ...
    invoke-virtual {p3}, Lio/reactivex/internal/queue/a;->size()I
