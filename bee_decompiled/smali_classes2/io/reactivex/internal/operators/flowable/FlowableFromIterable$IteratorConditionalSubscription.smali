...
# direct methods
.method constructor <init>(La0/a;Ljava/util/Iterator;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableFromIterable$IteratorConditionalSubscription;->downstream:La0/a;
...
.method fastPath()V
    ...
    iget-object v1, p0, Lio/reactivex/internal/operators/flowable/FlowableFromIterable$IteratorConditionalSubscription;->downstream:La0/a;
    ...
    :cond_3
    invoke-interface {v1, v2}, La0/a;->tryOnNext(Ljava/lang/Object;)Z
...
.method slowPath(J)V
    ...
    invoke-interface {v1, p1}, La0/a;->onError(Ljava/lang/Throwable;)V

    return-void

    :cond_4
    invoke-interface {v1, v6}, La0/a;->tryOnNext(Ljava/lang/Object;)Z
