...
# direct methods
.method public constructor <init>(Lio/reactivex/j;Ljava/lang/Iterable;Lz/o;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 6
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableWithLatestFromMany;->otherArray:[Lk1/b;

    .line 7
    iput-object p2, p0, Lio/reactivex/internal/operators/flowable/FlowableWithLatestFromMany;->otherIterable:Ljava/lang/Iterable;

    .line 8
    iput-object p3, p0, Lio/reactivex/internal/operators/flowable/FlowableWithLatestFromMany;->combiner:Lz/o;

    return-void
.end method

.method public constructor <init>(Lio/reactivex/j;[Lk1/b;Lz/o;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    iput-object p2, p0, Lio/reactivex/internal/operators/flowable/FlowableWithLatestFromMany;->otherArray:[Lk1/b;
...
.method protected subscribeActual(Lk1/c;)V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableWithLatestFromMany;->otherArray:[Lk1/b;
    ...
    invoke-direct {v0, v1, v2}, Lio/reactivex/internal/operators/flowable/p0;-><init>(Lio/reactivex/j;Lz/o;)V

    invoke-virtual {v0, p1}, Lio/reactivex/internal/operators/flowable/p0;->subscribeActual(Lk1/c;)V
    ...
    iget-object v3, p0, Lio/reactivex/internal/operators/flowable/FlowableWithLatestFromMany;->combiner:Lz/o;

    invoke-direct {v1, p1, v3, v2}, Lio/reactivex/internal/operators/flowable/FlowableWithLatestFromMany$WithLatestFromSubscriber;-><init>(Lk1/c;Lz/o;I)V

    invoke-interface {p1, v1}, Lk1/c;->onSubscribe(Lk1/d;)V

    invoke-virtual {v1, v0, v2}, Lio/reactivex/internal/operators/flowable/FlowableWithLatestFromMany$WithLatestFromSubscriber;->subscribe([Lk1/b;I)V
