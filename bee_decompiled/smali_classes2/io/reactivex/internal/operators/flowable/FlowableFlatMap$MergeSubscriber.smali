...
.method constructor <init>(Lk1/c;Lz/o;ZII)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableFlatMap$MergeSubscriber;->downstream:Lk1/c;

    iput-object p2, p0, Lio/reactivex/internal/operators/flowable/FlowableFlatMap$MergeSubscriber;->mapper:Lz/o;
...
.method public cancel()V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableFlatMap$MergeSubscriber;->upstream:Lk1/d;
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableFlatMap$MergeSubscriber;->queue:La0/n;
...
.method checkTerminate()Z
    ...
    iget-object v2, p0, Lio/reactivex/internal/operators/flowable/FlowableFlatMap$MergeSubscriber;->downstream:Lk1/c;
...
.method drainLoop()V
    ...
    iget-object v2, v1, Lio/reactivex/internal/operators/flowable/FlowableFlatMap$MergeSubscriber;->downstream:Lk1/c;
    ...
    :cond_1
    iget-object v0, v1, Lio/reactivex/internal/operators/flowable/FlowableFlatMap$MergeSubscriber;->queue:La0/n;
    ...
    :cond_4
    invoke-interface {v2, v10}, Lk1/c;->onNext(Ljava/lang/Object;)V
    ...
    iget-object v7, v1, Lio/reactivex/internal/operators/flowable/FlowableFlatMap$MergeSubscriber;->queue:La0/n;
    ...
    invoke-interface {v7}, La0/n;->isEmpty()Z
    ...
    invoke-interface {v2}, Lk1/c;->onComplete()V
    ...
    :cond_15
    iget-object v12, v7, Lio/reactivex/internal/operators/flowable/FlowableFlatMap$InnerSubscriber;->queue:La0/o;
    ...
    :try_start_0
    invoke-interface {v12}, La0/o;->poll()Ljava/lang/Object;
    ...
    :cond_17
    invoke-interface {v2, v14}, Lk1/c;->onNext(Ljava/lang/Object;)V
    ...
    iget-object v0, v1, Lio/reactivex/internal/operators/flowable/FlowableFlatMap$MergeSubscriber;->upstream:Lk1/d;
    ...
    iget-object v11, v7, Lio/reactivex/internal/operators/flowable/FlowableFlatMap$InnerSubscriber;->queue:La0/o;

    if-eqz v10, :cond_20

    if-eqz v11, :cond_21

    invoke-interface {v11}, La0/o;->isEmpty()Z
    ...
    invoke-interface {v0, v3, v4}, Lk1/d;->request(J)V
...
.method getInnerQueue(Lio/reactivex/internal/operators/flowable/FlowableFlatMap$InnerSubscriber;)La0/o;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object v0, p1, Lio/reactivex/internal/operators/flowable/FlowableFlatMap$InnerSubscriber;->queue:La0/o;
    ...
    iput-object v0, p1, Lio/reactivex/internal/operators/flowable/FlowableFlatMap$InnerSubscriber;->queue:La0/o;

    :cond_0
    return-object v0
.end method

.method getMainQueue()La0/o;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    :goto_0
    iput-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableFlatMap$MergeSubscriber;->queue:La0/n;
...
.method innerError(Lio/reactivex/internal/operators/flowable/FlowableFlatMap$InnerSubscriber;Ljava/lang/Throwable;)V
    ...
    iget-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableFlatMap$MergeSubscriber;->upstream:Lk1/d;
...
.method public onNext(Ljava/lang/Object;)V
    ...
    :cond_0
    :try_start_0
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableFlatMap$MergeSubscriber;->mapper:Lz/o;
...
.method public onSubscribe(Lk1/d;)V
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableFlatMap$MergeSubscriber;->upstream:Lk1/d;

    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableFlatMap$MergeSubscriber;->downstream:Lk1/c;
...
.method tryEmit(Ljava/lang/Object;Lio/reactivex/internal/operators/flowable/FlowableFlatMap$InnerSubscriber;)V
    ...
    iget-object v0, p2, Lio/reactivex/internal/operators/flowable/FlowableFlatMap$InnerSubscriber;->queue:La0/o;
    ...
    invoke-virtual {p0, p2}, Lio/reactivex/internal/operators/flowable/FlowableFlatMap$MergeSubscriber;->getInnerQueue(Lio/reactivex/internal/operators/flowable/FlowableFlatMap$InnerSubscriber;)La0/o;
    ...
    iput-object v0, p2, Lio/reactivex/internal/operators/flowable/FlowableFlatMap$InnerSubscriber;->queue:La0/o;
...
.method tryEmitScalar(Ljava/lang/Object;)V
    ...
    iget-object v5, p0, Lio/reactivex/internal/operators/flowable/FlowableFlatMap$MergeSubscriber;->queue:La0/n;
    ...
    invoke-interface {v5}, La0/o;->isEmpty()Z
    ...
    :cond_0
    iget-object v1, p0, Lio/reactivex/internal/operators/flowable/FlowableFlatMap$MergeSubscriber;->downstream:Lk1/c;
    ...
    invoke-virtual {p0}, Lio/reactivex/internal/operators/flowable/FlowableFlatMap$MergeSubscriber;->getMainQueue()La0/o;

    move-result-object v5

    :cond_3
    invoke-interface {v5, p1}, La0/o;->offer(Ljava/lang/Object;)Z
