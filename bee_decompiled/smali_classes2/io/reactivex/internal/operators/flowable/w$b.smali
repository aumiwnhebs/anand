...
# direct methods
.method constructor <init>(Lk1/c;Lz/g;Lz/g;Lz/a;Lz/a;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p2, p0, Lio/reactivex/internal/operators/flowable/w$b;->onNext:Lz/g;

    iput-object p3, p0, Lio/reactivex/internal/operators/flowable/w$b;->onError:Lz/g;

    iput-object p4, p0, Lio/reactivex/internal/operators/flowable/w$b;->onComplete:Lz/a;

    iput-object p5, p0, Lio/reactivex/internal/operators/flowable/w$b;->onAfterTerminate:Lz/a;
...
.method public onComplete()V
    ...
    :cond_0
    :try_start_0
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/w$b;->onComplete:Lz/a;
    ...
    :try_start_1
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/w$b;->onAfterTerminate:Lz/a;
    ...
    invoke-virtual {p0, v0}, Lio/reactivex/internal/subscribers/b;->fail(Ljava/lang/Throwable;)V
...
.method public onError(Ljava/lang/Throwable;)V
    ...
    :try_start_0
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/w$b;->onError:Lz/g;
    ...
    iget-object v1, p0, Lio/reactivex/internal/subscribers/b;->downstream:Lk1/c;
    ...
    :goto_0
    :try_start_1
    iget-object p1, p0, Lio/reactivex/internal/operators/flowable/w$b;->onAfterTerminate:Lz/a;
...
.method public onNext(Ljava/lang/Object;)V
    ...
    :cond_1
    :try_start_0
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/w$b;->onNext:Lz/g;
...
.method public poll()Ljava/lang/Object;
    ...
    :try_start_1
    iget-object v1, p0, Lio/reactivex/internal/operators/flowable/w$b;->onNext:Lz/g;

    invoke-interface {v1, v0}, Lz/g;->accept(Ljava/lang/Object;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0

    iget-object v1, p0, Lio/reactivex/internal/operators/flowable/w$b;->onAfterTerminate:Lz/a;
    ...
    :try_start_3
    iget-object v1, p0, Lio/reactivex/internal/operators/flowable/w$b;->onError:Lz/g;
    ...
    :cond_0
    iget v1, p0, Lio/reactivex/internal/subscribers/b;->sourceMode:I

    const/4 v2, 0x1

    if-ne v1, v2, :cond_1

    iget-object v1, p0, Lio/reactivex/internal/operators/flowable/w$b;->onComplete:Lz/a;
