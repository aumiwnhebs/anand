...
# direct methods
.method constructor <init>(Lk1/c;JJLjava/util/concurrent/TimeUnit;Lio/reactivex/h0$c;I)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-wide p2, p0, Lio/reactivex/internal/operators/flowable/k1$c;->timespan:J

    iput-wide p4, p0, Lio/reactivex/internal/operators/flowable/k1$c;->timeskip:J

    iput-object p6, p0, Lio/reactivex/internal/operators/flowable/k1$c;->unit:Ljava/util/concurrent/TimeUnit;

    iput-object p7, p0, Lio/reactivex/internal/operators/flowable/k1$c;->worker:Lio/reactivex/h0$c;

    iput p8, p0, Lio/reactivex/internal/operators/flowable/k1$c;->bufferSize:I

    new-instance p1, Ljava/util/LinkedList;

    invoke-direct {p1}, Ljava/util/LinkedList;-><init>()V

    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/k1$c;->windows:Ljava/util/List;
...
.method complete(Lio/reactivex/processors/UnicastProcessor;)V
    ...
    invoke-virtual {p0}, Lio/reactivex/internal/operators/flowable/k1$c;->drainLoop()V
...
.method drainLoop()V
    ...
    iget-object v2, p0, Lio/reactivex/internal/operators/flowable/k1$c;->windows:Ljava/util/List;
    ...
    :cond_0
    :goto_0
    iget-boolean v5, p0, Lio/reactivex/internal/operators/flowable/k1$c;->terminated:Z

    if-eqz v5, :cond_1

    iget-object v1, p0, Lio/reactivex/internal/operators/flowable/k1$c;->upstream:Lk1/d;
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/k1$c;->worker:Lio/reactivex/h0$c;
    ...
    iget-boolean v5, v6, Lio/reactivex/internal/operators/flowable/k1$c$b;->open:Z

    if-eqz v5, :cond_b

    iget-boolean v5, p0, Lio/reactivex/internal/subscribers/h;->cancelled:Z
    ...
    iget v7, p0, Lio/reactivex/internal/operators/flowable/k1$c;->bufferSize:I
    ...
    invoke-interface {v1, v7}, Lk1/c;->onNext(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, v5, v6}, Lio/reactivex/internal/subscribers/h;->produced(J)J

    :cond_9
    iget-object v5, p0, Lio/reactivex/internal/operators/flowable/k1$c;->worker:Lio/reactivex/h0$c;
    ...
    iget-wide v7, p0, Lio/reactivex/internal/operators/flowable/k1$c;->timespan:J

    iget-object v9, p0, Lio/reactivex/internal/operators/flowable/k1$c;->unit:Ljava/util/concurrent/TimeUnit;

    invoke-virtual {v5, v6, v7, v8, v9}, Lio/reactivex/h0$c;->schedule(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Lio/reactivex/disposables/b;
    ...
    :cond_b
    iget-object v5, v6, Lio/reactivex/internal/operators/flowable/k1$c$b;->w:Lio/reactivex/processors/UnicastProcessor;
    ...
    iput-boolean v3, p0, Lio/reactivex/internal/operators/flowable/k1$c;->terminated:Z
...
.method public onNext(Ljava/lang/Object;)V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/k1$c;->windows:Ljava/util/List;
...
.method public onSubscribe(Lk1/d;)V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/k1$c;->upstream:Lk1/d;
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/k1$c;->upstream:Lk1/d;
    ...
    iget v2, p0, Lio/reactivex/internal/operators/flowable/k1$c;->bufferSize:I

    invoke-static {v2}, Lio/reactivex/processors/UnicastProcessor;->create(I)Lio/reactivex/processors/UnicastProcessor;

    move-result-object v2

    iget-object v3, p0, Lio/reactivex/internal/operators/flowable/k1$c;->windows:Ljava/util/List;

    invoke-interface {v3, v2}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    iget-object v3, p0, Lio/reactivex/internal/subscribers/h;->downstream:Lk1/c;

    invoke-interface {v3, v2}, Lk1/c;->onNext(Ljava/lang/Object;)V
    ...
    iget-wide v5, p0, Lio/reactivex/internal/operators/flowable/k1$c;->timespan:J

    iget-object v2, p0, Lio/reactivex/internal/operators/flowable/k1$c;->unit:Ljava/util/concurrent/TimeUnit;

    invoke-virtual {v0, v1, v5, v6, v2}, Lio/reactivex/h0$c;->schedule(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Lio/reactivex/disposables/b;

    iget-object v7, p0, Lio/reactivex/internal/operators/flowable/k1$c;->worker:Lio/reactivex/h0$c;

    iget-wide v11, p0, Lio/reactivex/internal/operators/flowable/k1$c;->timeskip:J

    iget-object v13, p0, Lio/reactivex/internal/operators/flowable/k1$c;->unit:Ljava/util/concurrent/TimeUnit;

    move-object v8, p0

    move-wide v9, v11

    invoke-virtual/range {v7 .. v13}, Lio/reactivex/h0$c;->schedulePeriodically(Ljava/lang/Runnable;JJLjava/util/concurrent/TimeUnit;)Lio/reactivex/disposables/b;
...
.method public run()V
    ...
    iget v0, p0, Lio/reactivex/internal/operators/flowable/k1$c;->bufferSize:I
