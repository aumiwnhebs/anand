...
.method private constructor <init>(Lk1/b;Lio/reactivex/j;Ljava/util/concurrent/atomic/AtomicReference;Ljava/util/concurrent/Callable;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableReplay;->onSubscribe:Lk1/b;

    iput-object p2, p0, Lio/reactivex/internal/operators/flowable/FlowableReplay;->source:Lio/reactivex/j;
...
.method public static create(Lio/reactivex/j;I)Lio/reactivex/flowables/a;
    ...
    invoke-static {p0, v0}, Lio/reactivex/internal/operators/flowable/FlowableReplay;->create(Lio/reactivex/j;Ljava/util/concurrent/Callable;)Lio/reactivex/flowables/a;
...
.method public static create(Lio/reactivex/j;JLjava/util/concurrent/TimeUnit;Lio/reactivex/h0;)Lio/reactivex/flowables/a;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public static create(Lio/reactivex/j;JLjava/util/concurrent/TimeUnit;Lio/reactivex/h0;I)Lio/reactivex/flowables/a;
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-static {p0, v6}, Lio/reactivex/internal/operators/flowable/FlowableReplay;->create(Lio/reactivex/j;Ljava/util/concurrent/Callable;)Lio/reactivex/flowables/a;
...
.method static create(Lio/reactivex/j;Ljava/util/concurrent/Callable;)Lio/reactivex/flowables/a;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-direct {v2, v1, p0, v0, p1}, Lio/reactivex/internal/operators/flowable/FlowableReplay;-><init>(Lk1/b;Lio/reactivex/j;Ljava/util/concurrent/atomic/AtomicReference;Ljava/util/concurrent/Callable;)V
...
.method public static createFrom(Lio/reactivex/j;)Lio/reactivex/flowables/a;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public static multicastSelector(Ljava/util/concurrent/Callable;Lz/o;)Lio/reactivex/j;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<U:",
    ...
    invoke-direct {v0, p0, p1}, Lio/reactivex/internal/operators/flowable/FlowableReplay$c;-><init>(Ljava/util/concurrent/Callable;Lz/o;)V

    return-object v0
.end method

.method public static observeOn(Lio/reactivex/flowables/a;Lio/reactivex/h0;)Lio/reactivex/flowables/a;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-virtual {p0, p1}, Lio/reactivex/j;->observeOn(Lio/reactivex/h0;)Lio/reactivex/j;

    move-result-object p1

    new-instance v0, Lio/reactivex/internal/operators/flowable/FlowableReplay$a;

    invoke-direct {v0, p0, p1}, Lio/reactivex/internal/operators/flowable/FlowableReplay$a;-><init>(Lio/reactivex/flowables/a;Lio/reactivex/j;)V

    invoke-static {v0}, Lio/reactivex/plugins/a;->onAssembly(Lio/reactivex/flowables/a;)Lio/reactivex/flowables/a;
...
.method public connect(Lz/g;)V
    ...
    iget-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableReplay;->source:Lio/reactivex/j;
...
.method public source()Lk1/b;
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableReplay;->source:Lio/reactivex/j;
...
.method protected subscribeActual(Lk1/c;)V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableReplay;->onSubscribe:Lk1/b;
