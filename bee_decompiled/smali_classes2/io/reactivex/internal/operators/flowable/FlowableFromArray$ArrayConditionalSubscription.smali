...
# direct methods
.method constructor <init>(La0/a;[Ljava/lang/Object;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableFromArray$ArrayConditionalSubscription;->downstream:La0/a;
...
.method fastPath()V
    ...
    iget-object v2, p0, Lio/reactivex/internal/operators/flowable/FlowableFromArray$ArrayConditionalSubscription;->downstream:La0/a;
    ...
    invoke-interface {v2, v0}, La0/a;->onError(Ljava/lang/Throwable;)V

    return-void

    :cond_1
    invoke-interface {v2, v4}, La0/a;->tryOnNext(Ljava/lang/Object;)Z
    ...
    :cond_3
    invoke-interface {v2}, La0/a;->onComplete()V
...
.method slowPath(J)V
    ...
    iget-object v3, p0, Lio/reactivex/internal/operators/flowable/FlowableFromArray$ArrayConditionalSubscription;->downstream:La0/a;
    ...
    invoke-interface {v3, p1}, La0/a;->onError(Ljava/lang/Throwable;)V

    return-void

    :cond_3
    invoke-interface {v3, v8}, La0/a;->tryOnNext(Ljava/lang/Object;)Z
