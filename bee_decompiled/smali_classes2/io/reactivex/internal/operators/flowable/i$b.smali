...
# direct methods
.method constructor <init>(Lk1/c;Ljava/util/concurrent/Callable;Ljava/util/concurrent/Callable;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/i$b;->other:Ljava/util/concurrent/atomic/AtomicReference;

    iput-object p2, p0, Lio/reactivex/internal/operators/flowable/i$b;->bufferSupplier:Ljava/util/concurrent/Callable;

    iput-object p3, p0, Lio/reactivex/internal/operators/flowable/i$b;->boundarySupplier:Ljava/util/concurrent/Callable;
...
.method public bridge synthetic accept(Lk1/c;Ljava/lang/Object;)Z
    ...
    invoke-virtual {p0, p1, p2}, Lio/reactivex/internal/operators/flowable/i$b;->accept(Lk1/c;Ljava/util/Collection;)Z
...
.method public cancel()V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/i$b;->upstream:Lk1/d;

    invoke-interface {v0}, Lk1/d;->cancel()V

    invoke-virtual {p0}, Lio/reactivex/internal/operators/flowable/i$b;->disposeOther()V
...
.method disposeOther()V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/i$b;->other:Ljava/util/concurrent/atomic/AtomicReference;
...
.method next()V
    ...
    :try_start_0
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/i$b;->bufferSupplier:Ljava/util/concurrent/Callable;
    ...
    :try_start_1
    iget-object v1, p0, Lio/reactivex/internal/operators/flowable/i$b;->boundarySupplier:Ljava/util/concurrent/Callable;
    ...
    iget-object v3, p0, Lio/reactivex/internal/operators/flowable/i$b;->other:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    :try_start_2
    iget-object v3, p0, Lio/reactivex/internal/operators/flowable/i$b;->buffer:Ljava/util/Collection;
    ...
    :cond_0
    iput-object v0, p0, Lio/reactivex/internal/operators/flowable/i$b;->buffer:Ljava/util/Collection;
    ...
    invoke-virtual {p0, v3, v0, p0}, Lio/reactivex/internal/subscribers/h;->fastPathEmitMax(Ljava/lang/Object;ZLio/reactivex/disposables/b;)V
    ...
    iget-object v1, p0, Lio/reactivex/internal/operators/flowable/i$b;->upstream:Lk1/d;
...
.method public onComplete()V
    ...
    :try_start_0
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/i$b;->buffer:Ljava/util/Collection;
    ...
    iput-object v1, p0, Lio/reactivex/internal/operators/flowable/i$b;->buffer:Ljava/util/Collection;
...
.method public onSubscribe(Lk1/d;)V
    ...
    :cond_0
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/i$b;->upstream:Lk1/d;
    ...
    :try_start_0
    iget-object v2, p0, Lio/reactivex/internal/operators/flowable/i$b;->bufferSupplier:Ljava/util/concurrent/Callable;
    ...
    iput-object v2, p0, Lio/reactivex/internal/operators/flowable/i$b;->buffer:Ljava/util/Collection;

    :try_start_1
    iget-object v2, p0, Lio/reactivex/internal/operators/flowable/i$b;->boundarySupplier:Ljava/util/concurrent/Callable;
    ...
    invoke-interface {v2, v1}, Lk1/b;->subscribe(Lk1/c;)V
    ...
    invoke-static {v2, v0}, Lio/reactivex/internal/subscriptions/EmptySubscription;->error(Ljava/lang/Throwable;Lk1/c;)V
