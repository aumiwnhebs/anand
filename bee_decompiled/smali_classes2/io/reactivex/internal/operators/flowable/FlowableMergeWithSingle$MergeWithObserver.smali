...
.method constructor <init>(Lk1/c;)V
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableMergeWithSingle$MergeWithObserver;->downstream:Lk1/c;
...
.method public cancel()V
    ...
    iput-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableMergeWithSingle$MergeWithObserver;->queue:La0/n;
...
.method drainLoop()V
    ...
    iget-object v1, v0, Lio/reactivex/internal/operators/flowable/FlowableMergeWithSingle$MergeWithObserver;->downstream:Lk1/c;
    ...
    iput-object v13, v0, Lio/reactivex/internal/operators/flowable/FlowableMergeWithSingle$MergeWithObserver;->queue:La0/n;
    ...
    invoke-interface {v1, v10}, Lk1/c;->onNext(Ljava/lang/Object;)V
    ...
    iget-object v11, v0, Lio/reactivex/internal/operators/flowable/FlowableMergeWithSingle$MergeWithObserver;->queue:La0/n;

    if-eqz v11, :cond_3

    invoke-interface {v11}, La0/n;->poll()Ljava/lang/Object;
    ...
    :cond_6
    invoke-interface {v1, v11}, Lk1/c;->onNext(Ljava/lang/Object;)V
    ...
    invoke-interface {v4, v10, v11}, Lk1/d;->request(J)V
    ...
    iget-object v8, v0, Lio/reactivex/internal/operators/flowable/FlowableMergeWithSingle$MergeWithObserver;->queue:La0/n;

    if-eqz v8, :cond_c

    invoke-interface {v8}, La0/n;->isEmpty()Z
...
.method getOrCreateQueue()La0/n;
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableMergeWithSingle$MergeWithObserver;->queue:La0/n;
...
.method public onNext(Ljava/lang/Object;)V
    ...
    iget-object v4, p0, Lio/reactivex/internal/operators/flowable/FlowableMergeWithSingle$MergeWithObserver;->queue:La0/n;

    if-eqz v4, :cond_1

    invoke-interface {v4}, La0/n;->isEmpty()Z
    ...
    :cond_0
    invoke-interface {v4, p1}, La0/n;->offer(Ljava/lang/Object;)Z
    ...
    iget-object v2, p0, Lio/reactivex/internal/operators/flowable/FlowableMergeWithSingle$MergeWithObserver;->downstream:Lk1/c;

    invoke-interface {v2, p1}, Lk1/c;->onNext(Ljava/lang/Object;)V
    ...
    :cond_3
    invoke-virtual {p0}, Lio/reactivex/internal/operators/flowable/FlowableMergeWithSingle$MergeWithObserver;->getOrCreateQueue()La0/n;
...
.method otherSuccess(Ljava/lang/Object;)V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableMergeWithSingle$MergeWithObserver;->downstream:Lk1/c;
