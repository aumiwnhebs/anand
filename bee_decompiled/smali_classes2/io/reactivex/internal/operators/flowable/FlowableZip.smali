...
# direct methods
.method public constructor <init>([Lk1/b;Ljava/lang/Iterable;Lz/o;IZ)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "([",
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableZip;->sources:[Lk1/b;

    iput-object p2, p0, Lio/reactivex/internal/operators/flowable/FlowableZip;->sourcesIterable:Ljava/lang/Iterable;

    iput-object p3, p0, Lio/reactivex/internal/operators/flowable/FlowableZip;->zipper:Lz/o;
...
.method public subscribeActual(Lk1/c;)V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableZip;->sources:[Lk1/b;
    ...
    iget-object v3, p0, Lio/reactivex/internal/operators/flowable/FlowableZip;->zipper:Lz/o;
    ...
    invoke-direct/range {v1 .. v6}, Lio/reactivex/internal/operators/flowable/FlowableZip$ZipCoordinator;-><init>(Lk1/c;Lz/o;IIZ)V

    invoke-interface {p1, v8}, Lk1/c;->onSubscribe(Lk1/d;)V

    invoke-virtual {v8, v0, v7}, Lio/reactivex/internal/operators/flowable/FlowableZip$ZipCoordinator;->subscribe([Lk1/b;I)V
