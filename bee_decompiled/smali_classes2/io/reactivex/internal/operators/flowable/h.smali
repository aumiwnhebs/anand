...
.method public static subscribe(Lk1/b;)V
    .locals 4
    ...
    sget-object v3, Lio/reactivex/internal/functions/Functions;->REQUEST_MAX:Lz/g;

    invoke-direct {v1, v2, v0, v0, v3}, Lio/reactivex/internal/subscribers/LambdaSubscriber;-><init>(Lz/g;Lz/g;Lz/a;Lz/g;)V

    .line 16
    invoke-interface {p0, v1}, Lk1/b;->subscribe(Lk1/c;)V
...
.method public static subscribe(Lk1/b;Lk1/c;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    .line 11
    invoke-static {p0, p1}, Lio/reactivex/internal/util/NotificationLite;->acceptFull(Ljava/lang/Object;Lk1/c;)Z
...
.method public static subscribe(Lk1/b;Lz/g;Lz/g;Lz/a;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    sget-object v1, Lio/reactivex/internal/functions/Functions;->REQUEST_MAX:Lz/g;

    invoke-direct {v0, p1, p2, p3, v1}, Lio/reactivex/internal/subscribers/LambdaSubscriber;-><init>(Lz/g;Lz/g;Lz/a;Lz/g;)V

    invoke-static {p0, v0}, Lio/reactivex/internal/operators/flowable/h;->subscribe(Lk1/b;Lk1/c;)V

    return-void
.end method

.method public static subscribe(Lk1/b;Lz/g;Lz/g;Lz/a;I)V
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-static {p4}, Lio/reactivex/internal/functions/Functions;->boundedConsumer(I)Lz/g;
    ...
    invoke-direct/range {v1 .. v6}, Lio/reactivex/internal/subscribers/BoundedSubscriber;-><init>(Lz/g;Lz/g;Lz/a;Lz/g;I)V
