...
.method constructor <init>(ILjava/lang/Runnable;Z)V
    ...
    iput-object v0, p0, Lio/reactivex/processors/UnicastProcessor;->queue:Lio/reactivex/internal/queue/a;
...
# virtual methods
.method checkTerminated(ZZZLk1/c;Lio/reactivex/internal/queue/a;)Z
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(ZZZ",
    ...
    invoke-interface {p4, p1}, Lk1/c;->onError(Ljava/lang/Throwable;)V
    ...
    :cond_2
    invoke-interface {p4}, Lk1/c;->onComplete()V
...
.method drain()V
    ...
    invoke-virtual {p0, v0}, Lio/reactivex/processors/UnicastProcessor;->drainFused(Lk1/c;)V

    goto :goto_1

    :cond_1
    invoke-virtual {p0, v0}, Lio/reactivex/processors/UnicastProcessor;->drainRegular(Lk1/c;)V
...
.method drainFused(Lk1/c;)V
    ...
    iget-object v0, p0, Lio/reactivex/processors/UnicastProcessor;->queue:Lio/reactivex/internal/queue/a;
    ...
    :cond_2
    invoke-interface {p1, v4}, Lk1/c;->onNext(Ljava/lang/Object;)V
...
.method drainRegular(Lk1/c;)V
    ...
    iget-object v7, v6, Lio/reactivex/processors/UnicastProcessor;->queue:Lio/reactivex/internal/queue/a;
    ...
    invoke-virtual/range {v0 .. v5}, Lio/reactivex/processors/UnicastProcessor;->checkTerminated(ZZZLk1/c;Lio/reactivex/internal/queue/a;)Z
    ...
    invoke-interface {v5, v8}, Lk1/c;->onNext(Ljava/lang/Object;)V
