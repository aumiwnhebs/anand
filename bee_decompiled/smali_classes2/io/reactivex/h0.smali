...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lio/reactivex/h0;->IS_DRIFT_USE_NANOTIME:Z
    ...
    sput-wide v0, Lio/reactivex/h0;->CLOCK_DRIFT_TOLERANCE_NANOSECONDS:J
...
.method public static clockDriftTolerance()J
    ...
    sget-wide v0, Lio/reactivex/h0;->CLOCK_DRIFT_TOLERANCE_NANOSECONDS:J
...
.method static computeNow(Ljava/util/concurrent/TimeUnit;)J
    ...
    sget-boolean v0, Lio/reactivex/h0;->IS_DRIFT_USE_NANOTIME:Z
...
# virtual methods
.method public abstract createWorker()Lio/reactivex/h0$c;
.end method
...
.method public scheduleDirect(Ljava/lang/Runnable;)Lio/reactivex/disposables/b;
    ...
    invoke-virtual {p0, p1, v0, v1, v2}, Lio/reactivex/h0;->scheduleDirect(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Lio/reactivex/disposables/b;
...
.method public scheduleDirect(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Lio/reactivex/disposables/b;
    ...
    .line 2
    invoke-virtual {p0}, Lio/reactivex/h0;->createWorker()Lio/reactivex/h0$c;
    ...
    .line 5
    invoke-virtual {v0, v1, p2, p3, p4}, Lio/reactivex/h0$c;->schedule(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Lio/reactivex/disposables/b;
...
.method public when(Lz/o;)Lio/reactivex/h0;
    .locals 1
    ...
    invoke-direct {v0, p1, p0}, Lio/reactivex/internal/schedulers/SchedulerWhen;-><init>(Lz/o;Lio/reactivex/h0;)V
