...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/DeserializedPackageFragmentImpl;->initialize(Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/h;)V
.end annotation
...
.method public final invoke()Ljava/util/Collection;
    ...
    invoke-virtual {v0}, Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/DeserializedPackageFragmentImpl;->getClassDataFinder()Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/s;

    move-result-object v0

    invoke-virtual {v0}, Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/s;->getAllClassIds()Ljava/util/Collection;
    ...
    .line 5
    invoke-virtual {v3}, Lkotlin/reflect/jvm/internal/impl/name/b;->isNestedClass()Z

    move-result v4

    if-nez v4, :cond_0

    sget-object v4, Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/ClassDeserializer;->Companion:Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/ClassDeserializer$b;

    invoke-virtual {v4}, Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/ClassDeserializer$b;->getBLACK_LIST()Ljava/util/Set;
    ...
    .line 10
    invoke-virtual {v2}, Lkotlin/reflect/jvm/internal/impl/name/b;->getShortClassName()Lkotlin/reflect/jvm/internal/impl/name/f;
