...
.method public varargs constructor <init>(Lkotlin/reflect/jvm/internal/impl/types/error/ErrorScopeKind;[Ljava/lang/String;)V
    ...
    iput-object p1, p0, Lkotlin/reflect/jvm/internal/impl/types/error/e;->kind:Lkotlin/reflect/jvm/internal/impl/types/error/ErrorScopeKind;
    ...
    iput-object p1, p0, Lkotlin/reflect/jvm/internal/impl/types/error/e;->debugMessage:Ljava/lang/String;
...
.method public getContributedClassifier(Lkotlin/reflect/jvm/internal/impl/name/f;Ls0/b;)Lkotlin/reflect/jvm/internal/impl/descriptors/f;
    ...
    invoke-static {p1}, Lkotlin/reflect/jvm/internal/impl/name/f;->special(Ljava/lang/String;)Lkotlin/reflect/jvm/internal/impl/name/f;
...
.method public bridge synthetic getContributedFunctions(Lkotlin/reflect/jvm/internal/impl/name/f;Ls0/b;)Ljava/util/Collection;
    ...
    .line 1
    invoke-virtual {p0, p1, p2}, Lkotlin/reflect/jvm/internal/impl/types/error/e;->getContributedFunctions(Lkotlin/reflect/jvm/internal/impl/name/f;Ls0/b;)Ljava/util/Set;
...
.method public getContributedFunctions(Lkotlin/reflect/jvm/internal/impl/name/f;Ls0/b;)Ljava/util/Set;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    sget-object p2, Lkotlin/reflect/jvm/internal/impl/types/error/h;->INSTANCE:Lkotlin/reflect/jvm/internal/impl/types/error/h;

    invoke-virtual {p2}, Lkotlin/reflect/jvm/internal/impl/types/error/h;->getErrorClass()Lkotlin/reflect/jvm/internal/impl/types/error/a;

    move-result-object p2

    invoke-direct {p1, p2}, Lkotlin/reflect/jvm/internal/impl/types/error/b;-><init>(Lkotlin/reflect/jvm/internal/impl/descriptors/d;)V
...
.method public bridge synthetic getContributedVariables(Lkotlin/reflect/jvm/internal/impl/name/f;Ls0/b;)Ljava/util/Collection;
    .locals 0

    .line 1
    invoke-virtual {p0, p1, p2}, Lkotlin/reflect/jvm/internal/impl/types/error/e;->getContributedVariables(Lkotlin/reflect/jvm/internal/impl/name/f;Ls0/b;)Ljava/util/Set;
...
.method public getContributedVariables(Lkotlin/reflect/jvm/internal/impl/name/f;Ls0/b;)Ljava/util/Set;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p1}, Lkotlin/reflect/jvm/internal/impl/types/error/h;->getErrorPropertyGroup()Ljava/util/Set;
...
.method protected final getDebugMessage()Ljava/lang/String;
    ...
    iget-object v0, p0, Lkotlin/reflect/jvm/internal/impl/types/error/e;->debugMessage:Ljava/lang/String;
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v1, p0, Lkotlin/reflect/jvm/internal/impl/types/error/e;->debugMessage:Ljava/lang/String;
