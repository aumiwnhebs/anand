...
.field public static final INSTANCE:Lkotlin/reflect/jvm/internal/impl/builtins/jvm/h;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lkotlin/reflect/jvm/internal/impl/builtins/jvm/h;->INSTANCE:Lkotlin/reflect/jvm/internal/impl/builtins/jvm/h;
    ...
    invoke-static {v2, v4}, Lkotlin/collections/w0;->plus(Ljava/util/Set;Ljava/lang/Object;)Ljava/util/Set;

    move-result-object v2

    sput-object v2, Lkotlin/reflect/jvm/internal/impl/builtins/jvm/h;->DROP_LIST_METHOD_SIGNATURES:Ljava/util/Set;

    invoke-direct {v0}, Lkotlin/reflect/jvm/internal/impl/builtins/jvm/h;->buildPrimitiveValueMethodsSet()Ljava/util/Set;
    ...
    invoke-static {v2, v5}, Lkotlin/collections/w0;->plus(Ljava/util/Set;Ljava/lang/Iterable;)Ljava/util/Set;
    ...
    invoke-static {v2, v9}, Lkotlin/collections/w0;->plus(Ljava/util/Set;Ljava/lang/Iterable;)Ljava/util/Set;
    ...
    sput-object v2, Lkotlin/reflect/jvm/internal/impl/builtins/jvm/h;->HIDDEN_METHOD_SIGNATURES:Ljava/util/Set;
    ...
    sput-object v2, Lkotlin/reflect/jvm/internal/impl/builtins/jvm/h;->VISIBLE_METHOD_SIGNATURES:Ljava/util/Set;
    ...
    invoke-static {v2, v3}, Lkotlin/collections/w0;->plus(Ljava/util/Set;Ljava/lang/Iterable;)Ljava/util/Set;
    ...
    sput-object v2, Lkotlin/reflect/jvm/internal/impl/builtins/jvm/h;->MUTABLE_METHOD_SIGNATURES:Ljava/util/Set;

    invoke-direct {v0}, Lkotlin/reflect/jvm/internal/impl/builtins/jvm/h;->buildPrimitiveStringConstructorsSet()Ljava/util/Set;
    ...
    sput-object v0, Lkotlin/reflect/jvm/internal/impl/builtins/jvm/h;->HIDDEN_CONSTRUCTOR_SIGNATURES:Ljava/util/Set;
    ...
    sput-object v0, Lkotlin/reflect/jvm/internal/impl/builtins/jvm/h;->VISIBLE_CONSTRUCTOR_SIGNATURES:Ljava/util/Set;
...
.method private final buildPrimitiveStringConstructorsSet()Ljava/util/Set;
    ...
    invoke-virtual {v3}, Lkotlin/reflect/jvm/internal/impl/name/c;->shortName()Lkotlin/reflect/jvm/internal/impl/name/f;
...
.method private final buildPrimitiveValueMethodsSet()Ljava/util/Set;
    ...
    invoke-virtual {v4}, Lkotlin/reflect/jvm/internal/impl/name/c;->shortName()Lkotlin/reflect/jvm/internal/impl/name/f;
...
.method public final getDROP_LIST_METHOD_SIGNATURES()Ljava/util/Set;
    ...
    sget-object v0, Lkotlin/reflect/jvm/internal/impl/builtins/jvm/h;->DROP_LIST_METHOD_SIGNATURES:Ljava/util/Set;
...
.method public final getHIDDEN_CONSTRUCTOR_SIGNATURES()Ljava/util/Set;
    ...
    sget-object v0, Lkotlin/reflect/jvm/internal/impl/builtins/jvm/h;->HIDDEN_CONSTRUCTOR_SIGNATURES:Ljava/util/Set;
...
.method public final getHIDDEN_METHOD_SIGNATURES()Ljava/util/Set;
    ...
    sget-object v0, Lkotlin/reflect/jvm/internal/impl/builtins/jvm/h;->HIDDEN_METHOD_SIGNATURES:Ljava/util/Set;
...
.method public final getMUTABLE_METHOD_SIGNATURES()Ljava/util/Set;
    ...
    sget-object v0, Lkotlin/reflect/jvm/internal/impl/builtins/jvm/h;->MUTABLE_METHOD_SIGNATURES:Ljava/util/Set;
...
.method public final getVISIBLE_CONSTRUCTOR_SIGNATURES()Ljava/util/Set;
    ...
    sget-object v0, Lkotlin/reflect/jvm/internal/impl/builtins/jvm/h;->VISIBLE_CONSTRUCTOR_SIGNATURES:Ljava/util/Set;
...
.method public final getVISIBLE_METHOD_SIGNATURES()Ljava/util/Set;
    ...
    sget-object v0, Lkotlin/reflect/jvm/internal/impl/builtins/jvm/h;->VISIBLE_METHOD_SIGNATURES:Ljava/util/Set;

    return-object v0
.end method

.method public final isArrayOrPrimitiveArray(Lkotlin/reflect/jvm/internal/impl/name/d;)Z
    .locals 1
    ...
    invoke-static {p1}, Lkotlin/reflect/jvm/internal/impl/builtins/g;->isPrimitiveArray(Lkotlin/reflect/jvm/internal/impl/name/d;)Z
...
.method public final isSerializableInJava(Lkotlin/reflect/jvm/internal/impl/name/d;)Z
    .locals 1
    ...
    invoke-virtual {p0, p1}, Lkotlin/reflect/jvm/internal/impl/builtins/jvm/h;->isArrayOrPrimitiveArray(Lkotlin/reflect/jvm/internal/impl/name/d;)Z
