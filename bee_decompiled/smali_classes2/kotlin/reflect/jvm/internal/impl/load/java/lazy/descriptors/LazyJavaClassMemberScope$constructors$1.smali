...
.method public final invoke()Ljava/util/List;
    ...
    invoke-static {v0}, Lkotlin/reflect/jvm/internal/impl/load/java/lazy/descriptors/LazyJavaClassMemberScope;->access$getJClass$p(Lkotlin/reflect/jvm/internal/impl/load/java/lazy/descriptors/LazyJavaClassMemberScope;)Lu0/g;

    move-result-object v0

    invoke-interface {v0}, Lu0/g;->getConstructors()Ljava/util/Collection;
    ...
    invoke-static {v3, v2}, Lkotlin/reflect/jvm/internal/impl/load/java/lazy/descriptors/LazyJavaClassMemberScope;->access$resolveConstructor(Lkotlin/reflect/jvm/internal/impl/load/java/lazy/descriptors/LazyJavaClassMemberScope;Lu0/k;)Lkotlin/reflect/jvm/internal/impl/load/java/descriptors/b;
    ...
    invoke-static {v0}, Lkotlin/reflect/jvm/internal/impl/load/java/lazy/descriptors/LazyJavaClassMemberScope;->access$createDefaultRecordConstructor(Lkotlin/reflect/jvm/internal/impl/load/java/lazy/descriptors/LazyJavaClassMemberScope;)Lkotlin/reflect/jvm/internal/impl/descriptors/c;
    ...
    .line 9
    invoke-static {v0, v2, v2, v3, v4}, Lkotlin/reflect/jvm/internal/impl/load/kotlin/u;->computeJvmDescriptor$default(Lkotlin/reflect/jvm/internal/impl/descriptors/w;ZZILjava/lang/Object;)Ljava/lang/String;
    ...
    .line 12
    invoke-static {v7, v2, v2, v3, v4}, Lkotlin/reflect/jvm/internal/impl/load/kotlin/u;->computeJvmDescriptor$default(Lkotlin/reflect/jvm/internal/impl/descriptors/w;ZZILjava/lang/Object;)Ljava/lang/String;

    move-result-object v7

    invoke-static {v7, v5}, Lkotlin/jvm/internal/s;->areEqual(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    invoke-interface {v2, v3, v0}, Lkotlin/reflect/jvm/internal/impl/load/java/components/d;->recordConstructor(Lu0/l;Lkotlin/reflect/jvm/internal/impl/descriptors/j;)V
    ...
    invoke-virtual {v3}, Lkotlin/reflect/jvm/internal/impl/load/java/lazy/a;->getSyntheticPartsProvider()Lkotlin/reflect/jvm/internal/impl/resolve/jvm/e;
    ...
    invoke-interface {v3, v0, v2, v1}, Lkotlin/reflect/jvm/internal/impl/resolve/jvm/e;->generateConstructors(Lkotlin/reflect/jvm/internal/impl/load/java/lazy/d;Lkotlin/reflect/jvm/internal/impl/descriptors/d;Ljava/util/List;)V
    ...
    .line 20
    invoke-static {v3}, Lkotlin/reflect/jvm/internal/impl/load/java/lazy/descriptors/LazyJavaClassMemberScope;->access$createDefaultConstructor(Lkotlin/reflect/jvm/internal/impl/load/java/lazy/descriptors/LazyJavaClassMemberScope;)Lkotlin/reflect/jvm/internal/impl/descriptors/c;
    ...
    .line 21
    :cond_5
    invoke-virtual {v0, v2, v1}, Lkotlin/reflect/jvm/internal/impl/load/java/typeEnhancement/SignatureEnhancement;->enhanceSignatures(Lkotlin/reflect/jvm/internal/impl/load/java/lazy/d;Ljava/util/Collection;)Ljava/util/Collection;
