...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lkotlin/reflect/jvm/internal/impl/load/java/lazy/descriptors/LazyJavaPackageScope;-><init>(Lkotlin/reflect/jvm/internal/impl/load/java/lazy/d;Lu0/u;Lkotlin/reflect/jvm/internal/impl/load/java/lazy/descriptors/LazyJavaPackageFragment;)V
.end annotation
...
.method public final invoke(Lkotlin/reflect/jvm/internal/impl/load/java/lazy/descriptors/LazyJavaPackageScope$a;)Lkotlin/reflect/jvm/internal/impl/descriptors/d;
    ...
    invoke-virtual {v3}, Lkotlin/reflect/jvm/internal/impl/descriptors/impl/w;->getFqName()Lkotlin/reflect/jvm/internal/impl/name/c;

    move-result-object v3

    invoke-virtual/range {p1 .. p1}, Lkotlin/reflect/jvm/internal/impl/load/java/lazy/descriptors/LazyJavaPackageScope$a;->getName()Lkotlin/reflect/jvm/internal/impl/name/f;
    ...
    .line 3
    invoke-virtual/range {p1 .. p1}, Lkotlin/reflect/jvm/internal/impl/load/java/lazy/descriptors/LazyJavaPackageScope$a;->getJavaClass()Lu0/g;
    ...
    invoke-virtual {v3}, Lkotlin/reflect/jvm/internal/impl/load/java/lazy/a;->getKotlinClassFinder()Lkotlin/reflect/jvm/internal/impl/load/kotlin/n;
    ...
    invoke-static {v5}, Lkotlin/reflect/jvm/internal/impl/load/java/lazy/descriptors/LazyJavaPackageScope;->access$getJvmMetadataVersion(Lkotlin/reflect/jvm/internal/impl/load/java/lazy/descriptors/LazyJavaPackageScope;)Lkotlin/reflect/jvm/internal/impl/metadata/jvm/deserialization/e;

    move-result-object v5

    invoke-interface {v3, v4, v5}, Lkotlin/reflect/jvm/internal/impl/load/kotlin/n;->findKotlinClassOrContent(Lu0/g;Lkotlin/reflect/jvm/internal/impl/metadata/jvm/deserialization/e;)Lkotlin/reflect/jvm/internal/impl/load/kotlin/n$a;
    ...
    invoke-static {v4}, Lkotlin/reflect/jvm/internal/impl/load/java/lazy/descriptors/LazyJavaPackageScope;->access$getJvmMetadataVersion(Lkotlin/reflect/jvm/internal/impl/load/java/lazy/descriptors/LazyJavaPackageScope;)Lkotlin/reflect/jvm/internal/impl/metadata/jvm/deserialization/e;

    move-result-object v4

    invoke-interface {v3, v1, v4}, Lkotlin/reflect/jvm/internal/impl/load/kotlin/n;->findKotlinClassOrContent(Lkotlin/reflect/jvm/internal/impl/name/b;Lkotlin/reflect/jvm/internal/impl/metadata/jvm/deserialization/e;)Lkotlin/reflect/jvm/internal/impl/load/kotlin/n$a;
    ...
    .line 6
    invoke-virtual {v3}, Lkotlin/reflect/jvm/internal/impl/load/kotlin/n$a;->toKotlinJvmBinaryClass()Lkotlin/reflect/jvm/internal/impl/load/kotlin/p;
    ...
    .line 7
    invoke-interface {v3}, Lkotlin/reflect/jvm/internal/impl/load/kotlin/p;->getClassId()Lkotlin/reflect/jvm/internal/impl/name/b;
    ...
    .line 8
    invoke-virtual {v4}, Lkotlin/reflect/jvm/internal/impl/name/b;->isNestedClass()Z

    move-result v5

    if-nez v5, :cond_3

    invoke-virtual {v4}, Lkotlin/reflect/jvm/internal/impl/name/b;->isLocal()Z
    ...
    invoke-static {v4, v3}, Lkotlin/reflect/jvm/internal/impl/load/java/lazy/descriptors/LazyJavaPackageScope;->access$resolveKotlinBinaryClass(Lkotlin/reflect/jvm/internal/impl/load/java/lazy/descriptors/LazyJavaPackageScope;Lkotlin/reflect/jvm/internal/impl/load/kotlin/p;)Lkotlin/reflect/jvm/internal/impl/load/java/lazy/descriptors/LazyJavaPackageScope$b;
    ...
    invoke-virtual {v3}, Lkotlin/reflect/jvm/internal/impl/load/java/lazy/descriptors/LazyJavaPackageScope$b$a;->getDescriptor()Lkotlin/reflect/jvm/internal/impl/descriptors/d;
    ...
    invoke-virtual {v2}, Lkotlin/reflect/jvm/internal/impl/load/java/lazy/a;->getFinder()Lkotlin/reflect/jvm/internal/impl/load/java/j;
    ...
    invoke-direct/range {v2 .. v7}, Lkotlin/reflect/jvm/internal/impl/load/java/j$a;-><init>(Lkotlin/reflect/jvm/internal/impl/name/b;[BLu0/g;ILkotlin/jvm/internal/o;)V

    .line 15
    invoke-interface {v9, v10}, Lkotlin/reflect/jvm/internal/impl/load/java/j;->findClass(Lkotlin/reflect/jvm/internal/impl/load/java/j$a;)Lu0/g;
    ...
    .line 16
    invoke-interface {v12}, Lu0/g;->getLightClassOriginKind()Lkotlin/reflect/jvm/internal/impl/load/java/structure/LightClassOriginKind;
    ...
    .line 17
    invoke-interface {v12}, Lu0/g;->getFqName()Lkotlin/reflect/jvm/internal/impl/name/c;
    ...
    .line 18
    invoke-virtual {v1}, Lkotlin/reflect/jvm/internal/impl/name/c;->isRoot()Z
    ...
    invoke-virtual {v2}, Lkotlin/reflect/jvm/internal/impl/descriptors/impl/w;->getFqName()Lkotlin/reflect/jvm/internal/impl/name/c;
    ...
    invoke-direct/range {v9 .. v15}, Lkotlin/reflect/jvm/internal/impl/load/java/lazy/descriptors/LazyJavaClassDescriptor;-><init>(Lkotlin/reflect/jvm/internal/impl/load/java/lazy/d;Lkotlin/reflect/jvm/internal/impl/descriptors/k;Lu0/g;Lkotlin/reflect/jvm/internal/impl/descriptors/d;ILkotlin/jvm/internal/o;)V
    ...
    invoke-interface {v1, v8}, Lkotlin/reflect/jvm/internal/impl/load/java/k;->reportClass(Lkotlin/reflect/jvm/internal/impl/load/java/descriptors/c;)V
    ...
    invoke-virtual {v4}, Lkotlin/reflect/jvm/internal/impl/load/java/lazy/a;->getKotlinClassFinder()Lkotlin/reflect/jvm/internal/impl/load/kotlin/n;
    ...
    invoke-static {v4, v12, v5}, Lkotlin/reflect/jvm/internal/impl/load/kotlin/o;->findKotlinClass(Lkotlin/reflect/jvm/internal/impl/load/kotlin/n;Lu0/g;Lkotlin/reflect/jvm/internal/impl/metadata/jvm/deserialization/e;)Lkotlin/reflect/jvm/internal/impl/load/kotlin/p;
    ...
    invoke-static {v4, v1, v5}, Lkotlin/reflect/jvm/internal/impl/load/kotlin/o;->findKotlinClass(Lkotlin/reflect/jvm/internal/impl/load/kotlin/n;Lkotlin/reflect/jvm/internal/impl/name/b;Lkotlin/reflect/jvm/internal/impl/metadata/jvm/deserialization/e;)Lkotlin/reflect/jvm/internal/impl/load/kotlin/p;
