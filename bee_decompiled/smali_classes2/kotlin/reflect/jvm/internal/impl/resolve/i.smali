...
# direct methods
.method public constructor <init>(Ljava/util/Map;Lkotlin/reflect/jvm/internal/impl/types/checker/e$a;Lkotlin/reflect/jvm/internal/impl/types/checker/f;Lkotlin/reflect/jvm/internal/impl/types/checker/KotlinTypePreparator;Lj0/p;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lkotlin/reflect/jvm/internal/impl/resolve/i;->matchingTypeConstructors:Ljava/util/Map;

    iput-object p2, p0, Lkotlin/reflect/jvm/internal/impl/resolve/i;->equalityAxioms:Lkotlin/reflect/jvm/internal/impl/types/checker/e$a;

    iput-object p3, p0, Lkotlin/reflect/jvm/internal/impl/resolve/i;->kotlinTypeRefiner:Lkotlin/reflect/jvm/internal/impl/types/checker/f;

    iput-object p4, p0, Lkotlin/reflect/jvm/internal/impl/resolve/i;->kotlinTypePreparator:Lkotlin/reflect/jvm/internal/impl/types/checker/KotlinTypePreparator;

    iput-object p5, p0, Lkotlin/reflect/jvm/internal/impl/resolve/i;->customSubtype:Lj0/p;

    return-void
.end method

.method public static final synthetic access$getCustomSubtype$p(Lkotlin/reflect/jvm/internal/impl/resolve/i;)Lj0/p;
    .locals 0

    iget-object p0, p0, Lkotlin/reflect/jvm/internal/impl/resolve/i;->customSubtype:Lj0/p;

    return-object p0
.end method

.method private final areEqualTypeConstructorsByAxioms(Lkotlin/reflect/jvm/internal/impl/types/z0;Lkotlin/reflect/jvm/internal/impl/types/z0;)Z
    .locals 4

    iget-object v0, p0, Lkotlin/reflect/jvm/internal/impl/resolve/i;->equalityAxioms:Lkotlin/reflect/jvm/internal/impl/types/checker/e$a;

    invoke-interface {v0, p1, p2}, Lkotlin/reflect/jvm/internal/impl/types/checker/e$a;->equals(Lkotlin/reflect/jvm/internal/impl/types/z0;Lkotlin/reflect/jvm/internal/impl/types/z0;)Z
    ...
    :cond_0
    iget-object v0, p0, Lkotlin/reflect/jvm/internal/impl/resolve/i;->matchingTypeConstructors:Ljava/util/Map;
    ...
    iget-object v3, p0, Lkotlin/reflect/jvm/internal/impl/resolve/i;->matchingTypeConstructors:Ljava/util/Map;
...
.method public areEqualTypeConstructors(La1/l;La1/l;)Z
    ...
    invoke-direct {p0, p1, p2}, Lkotlin/reflect/jvm/internal/impl/resolve/i;->areEqualTypeConstructorsByAxioms(Lkotlin/reflect/jvm/internal/impl/types/z0;Lkotlin/reflect/jvm/internal/impl/types/z0;)Z
...
.method public newTypeCheckerState(ZZ)Lkotlin/reflect/jvm/internal/impl/types/TypeCheckerState;
    ...
    iget-object v0, p0, Lkotlin/reflect/jvm/internal/impl/resolve/i;->customSubtype:Lj0/p;

    if-nez v0, :cond_0

    iget-object v0, p0, Lkotlin/reflect/jvm/internal/impl/resolve/i;->kotlinTypeRefiner:Lkotlin/reflect/jvm/internal/impl/types/checker/f;

    iget-object v1, p0, Lkotlin/reflect/jvm/internal/impl/resolve/i;->kotlinTypePreparator:Lkotlin/reflect/jvm/internal/impl/types/checker/KotlinTypePreparator;

    invoke-static {p1, p2, p0, v1, v0}, Lkotlin/reflect/jvm/internal/impl/types/checker/a;->createClassicTypeCheckerState(ZZLkotlin/reflect/jvm/internal/impl/types/checker/b;Lkotlin/reflect/jvm/internal/impl/types/checker/KotlinTypePreparator;Lkotlin/reflect/jvm/internal/impl/types/checker/f;)Lkotlin/reflect/jvm/internal/impl/types/TypeCheckerState;
    ...
    :cond_0
    iget-object v4, p0, Lkotlin/reflect/jvm/internal/impl/resolve/i;->kotlinTypePreparator:Lkotlin/reflect/jvm/internal/impl/types/checker/KotlinTypePreparator;

    iget-object v5, p0, Lkotlin/reflect/jvm/internal/impl/resolve/i;->kotlinTypeRefiner:Lkotlin/reflect/jvm/internal/impl/types/checker/f;
