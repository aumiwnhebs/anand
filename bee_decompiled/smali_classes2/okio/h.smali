...
.method public constructor <init>(Lokio/d;Ljava/util/zip/Deflater;)V
    ...
    .line 2
    iput-object p1, p0, Lokio/h;->sink:Lokio/d;

    iput-object p2, p0, Lokio/h;->deflater:Ljava/util/zip/Deflater;
...
.method public constructor <init>(Lokio/h0;Ljava/util/zip/Deflater;)V
    ...
    invoke-direct {p0, p1, p2}, Lokio/h;-><init>(Lokio/d;Ljava/util/zip/Deflater;)V
...
.method private final deflate(Z)V
    ...
    iget-object v0, p0, Lokio/h;->sink:Lokio/d;
    ...
    invoke-virtual {v0, v1}, Lokio/c;->writableSegment$okio(I)Lokio/f0;

    move-result-object v1

    if-eqz p1, :cond_1

    iget-object v2, p0, Lokio/h;->deflater:Ljava/util/zip/Deflater;

    iget-object v3, v1, Lokio/f0;->data:[B
    ...
    iget-object v1, p0, Lokio/h;->sink:Lokio/d;
    ...
    iget p1, v1, Lokio/f0;->pos:I

    iget v2, v1, Lokio/f0;->limit:I

    if-ne p1, v2, :cond_3

    invoke-virtual {v1}, Lokio/f0;->pop()Lokio/f0;

    move-result-object p1

    iput-object p1, v0, Lokio/c;->head:Lokio/f0;

    invoke-static {v1}, Lokio/g0;->recycle(Lokio/f0;)V
...
.method public close()V
    ...
    iget-boolean v0, p0, Lokio/h;->closed:Z
    ...
    :cond_0
    :try_start_0
    invoke-virtual {p0}, Lokio/h;->finishDeflate$okio()V
    :try_end_0
    ...
    :goto_0
    :try_start_1
    iget-object v1, p0, Lokio/h;->deflater:Ljava/util/zip/Deflater;
    ...
    iput-boolean v1, p0, Lokio/h;->closed:Z
...
.method public final finishDeflate$okio()V
    ...
    iget-object v0, p0, Lokio/h;->deflater:Ljava/util/zip/Deflater;

    invoke-virtual {v0}, Ljava/util/zip/Deflater;->finish()V

    const/4 v0, 0x0

    invoke-direct {p0, v0}, Lokio/h;->deflate(Z)V
...
.method public write(Lokio/c;J)V
    ...
    invoke-direct {p0, v2}, Lokio/h;->deflate(Z)V
