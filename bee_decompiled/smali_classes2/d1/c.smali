...
.method public static final synthetic access$durationOf(JI)J
    ...
    invoke-static {p0, p1, p2}, Ld1/c;->durationOf(JI)J
...
.method public static final synthetic access$durationOfMillis(J)J
    ...
    invoke-static {p0, p1}, Ld1/c;->durationOfMillis(J)J
...
.method public static final synthetic access$durationOfMillisNormalized(J)J
    ...
    invoke-static {p0, p1}, Ld1/c;->durationOfMillisNormalized(J)J
...
.method public static final synthetic access$durationOfNanos(J)J
    ...
    invoke-static {p0, p1}, Ld1/c;->durationOfNanos(J)J
...
.method public static final synthetic access$durationOfNanosNormalized(J)J
    ...
    invoke-static {p0, p1}, Ld1/c;->durationOfNanosNormalized(J)J
...
.method public static final synthetic access$millisToNanos(J)J
    ...
    invoke-static {p0, p1}, Ld1/c;->millisToNanos(J)J
...
.method public static final synthetic access$nanosToMillis(J)J
    ...
    invoke-static {p0, p1}, Ld1/c;->nanosToMillis(J)J
...
.method public static final synthetic access$parseDuration(Ljava/lang/String;Z)J
    ...
    invoke-static {p0, p1}, Ld1/c;->parseDuration(Ljava/lang/String;Z)J
...
.method private static final durationOf(JI)J
    ...
    invoke-static {p0, p1}, Ld1/a;->constructor-impl(J)J
...
.method public static final synthetic getDays(I)J
    ...
    invoke-static {p0, v0}, Ld1/c;->toDuration(ILkotlin/time/DurationUnit;)J
...
.method public static final synthetic getDays(J)J
    ...
    invoke-static {p0, p1, v0}, Ld1/c;->toDuration(JLkotlin/time/DurationUnit;)J
...
.method private static final parseDuration(Ljava/lang/String;Z)J
    ...
    sget-object v8, Ld1/a;->Companion:Ld1/a$a;

    invoke-virtual {v8}, Ld1/a$a;->getZERO-UwyO8pc()J
    ...
    invoke-static {v6, v2, v11, v0, v15}, Lkotlin/text/l;->startsWith$default(Ljava/lang/CharSequence;CZILjava/lang/Object;)Z
    ...
    invoke-static {v3, v14, v5, v12, v15}, Lkotlin/text/l;->contains$default(Ljava/lang/CharSequence;CZILjava/lang/Object;)Z
    ...
    :cond_7
    invoke-static {v6, v11}, Lkotlin/jvm/internal/s;->checkNotNull(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    invoke-static {v5, v1}, Ld1/e;->durationUnitByIsoChar(CZ)Lkotlin/time/DurationUnit;
    ...
    invoke-static/range {v20 .. v25}, Lkotlin/text/l;->indexOf$default(Ljava/lang/CharSequence;CIZILjava/lang/Object;)I
    ...
    invoke-static {v3, v11}, Lkotlin/jvm/internal/s;->checkNotNull(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    invoke-static {v14, v0}, Lkotlin/jvm/internal/s;->checkNotNullExpressionValue(Ljava/lang/Object;Ljava/lang/String;)V

    move/from16 p1, v13

    invoke-static {v14}, Ld1/c;->parseOverLongIsoComponent(Ljava/lang/String;)J

    move-result-wide v12

    invoke-static {v12, v13, v5}, Ld1/c;->toDuration(JLkotlin/time/DurationUnit;)J

    move-result-wide v12

    invoke-static {v9, v10, v12, v13}, Ld1/a;->plus-LRDsOJo(JJ)J
    ...
    invoke-static {v2, v3, v5}, Ld1/c;->toDuration(DLkotlin/time/DurationUnit;)J

    move-result-wide v2

    invoke-static {v9, v10, v2, v3}, Ld1/a;->plus-LRDsOJo(JJ)J
    ...
    invoke-static {v3}, Ld1/c;->parseOverLongIsoComponent(Ljava/lang/String;)J

    move-result-wide v2

    invoke-static {v2, v3, v5}, Ld1/c;->toDuration(JLkotlin/time/DurationUnit;)J
    ...
    invoke-virtual {v8}, Ld1/a$a;->getINFINITE-UwyO8pc()J
    ...
    invoke-static/range {p0 .. p0}, Lkotlin/text/l;->last(Ljava/lang/CharSequence;)C
    ...
    invoke-static {v4, v15}, Lkotlin/jvm/internal/s;->checkNotNullExpressionValue(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    invoke-static {v5, v15}, Lkotlin/jvm/internal/s;->checkNotNullExpressionValue(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    invoke-static {v5}, Ld1/e;->durationUnitByShortName(Ljava/lang/String;)Lkotlin/time/DurationUnit;
    ...
    invoke-static/range {v18 .. v23}, Lkotlin/text/l;->indexOf$default(Ljava/lang/CharSequence;CIZILjava/lang/Object;)I

    move-result v9

    if-lez v9, :cond_1a

    invoke-static {v4, v11}, Lkotlin/jvm/internal/s;->checkNotNull(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    invoke-static {v14, v15}, Lkotlin/jvm/internal/s;->checkNotNullExpressionValue(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    invoke-static {v1, v2, v12, v13}, Ld1/a;->plus-LRDsOJo(JJ)J
    ...
    invoke-static {v12, v13, v5}, Ld1/c;->toDuration(DLkotlin/time/DurationUnit;)J
    ...
    invoke-static {v8, v9, v5}, Ld1/c;->toDuration(JLkotlin/time/DurationUnit;)J

    move-result-wide v8

    invoke-static {v1, v2, v8, v9}, Ld1/a;->plus-LRDsOJo(JJ)J
    ...
    invoke-static {v9, v10}, Ld1/a;->unaryMinus-UwyO8pc(J)J
...
.method private static final parseOverLongIsoComponent(Ljava/lang/String;)J
    ...
    invoke-static {v5, v6, v4, v3, v2}, Lkotlin/text/l;->contains$default(Ljava/lang/CharSequence;CZILjava/lang/Object;)Z
    ...
    invoke-direct {v0, v5, v6}, Ln0/l;-><init>(II)V
    ...
    invoke-virtual {v5}, Lkotlin/collections/g0;->nextInt()I
    ...
    invoke-static {p0, v0, v4, v3, v2}, Lkotlin/text/l;->startsWith$default(Ljava/lang/String;Ljava/lang/String;ZILjava/lang/Object;)Z

    move-result v0

    if-eqz v0, :cond_5

    invoke-static {p0, v1}, Lkotlin/text/l;->drop(Ljava/lang/String;I)Ljava/lang/String;
...
.method private static final skipWhile(Ljava/lang/String;ILj0/l;)I
    .locals 1
...
.method private static final substringWhile(Ljava/lang/String;ILj0/l;)Ljava/lang/String;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {p0, p2}, Lkotlin/jvm/internal/s;->checkNotNull(Ljava/lang/Object;Ljava/lang/String;)V
...
.method private static final times-kIfJnKk(DJ)J
    ...
    invoke-static {p2, p3, p0, p1}, Ld1/a;->times-UwyO8pc(JD)J
...
.method private static final times-mvk6XK0(IJ)J
    ...
    invoke-static {p1, p2, p0}, Ld1/a;->times-UwyO8pc(JI)J
...
.method public static final toDuration(DLkotlin/time/DurationUnit;)J
    ...
    invoke-static {p0, p1, p2, v0}, Ld1/d;->convertDurationUnit(DLkotlin/time/DurationUnit;Lkotlin/time/DurationUnit;)D
    ...
    .line 10
    invoke-static {v0, v1}, Ll0/b;->roundToLong(D)J
    ...
    .line 11
    invoke-static {v0, v1}, Ld1/c;->durationOfNanos(J)J
    ...
    invoke-static {p0, p1}, Ll0/b;->roundToLong(D)J
...
.method public static final toDuration(ILkotlin/time/DurationUnit;)J
    ...
    invoke-static {v0, v1, p1, p0}, Ld1/d;->convertDurationUnitOverflow(JLkotlin/time/DurationUnit;Lkotlin/time/DurationUnit;)J
    ...
    .line 3
    invoke-static {v0, v1, p1}, Ld1/c;->toDuration(JLkotlin/time/DurationUnit;)J
...
.method public static final toDuration(JLkotlin/time/DurationUnit;)J
    ...
    invoke-static {v1, v2, v0, p2}, Ld1/d;->convertDurationUnitOverflow(JLkotlin/time/DurationUnit;Lkotlin/time/DurationUnit;)J
    ...
    .line 5
    invoke-static {p0, p1, p2, v0}, Ld1/d;->convertDurationUnitOverflow(JLkotlin/time/DurationUnit;Lkotlin/time/DurationUnit;)J
    ...
    invoke-static {p0, p1, p2, v0}, Ld1/d;->convertDurationUnit(JLkotlin/time/DurationUnit;Lkotlin/time/DurationUnit;)J
