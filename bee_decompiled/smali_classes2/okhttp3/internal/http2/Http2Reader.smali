...
.method public constructor <init>(Lokio/e;Z)V
    ...
    invoke-direct/range {v1 .. v6}, Lokhttp3/internal/http2/Hpack$Reader;-><init>(Lokio/j0;IIILkotlin/jvm/internal/o;)V
...
.method private final readGoAway(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    invoke-interface {v0, v1, v2}, Lokio/e;->readByteString(J)Lokio/ByteString;
...
.method private final readSettings(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    invoke-static {v0, p2}, Ln0/s;->until(II)Ln0/l;

    move-result-object p2

    const/4 v1, 0x6

    invoke-static {p2, v1}, Ln0/s;->step(Ln0/j;I)Ln0/j;

    move-result-object p2

    invoke-virtual {p2}, Ln0/j;->getFirst()I

    move-result v1

    invoke-virtual {p2}, Ln0/j;->getLast()I

    move-result v2

    invoke-virtual {p2}, Ln0/j;->getStep()I
    ...
    invoke-interface {v4}, Lokio/e;->readShort()S
    ...
    iget-object v5, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lokio/e;

    invoke-interface {v5}, Lokio/e;->readInt()I
...
.method public final nextFrame(ZLokhttp3/internal/http2/Http2Reader$Handler;)Z
    ...
    invoke-static {v0}, Lokhttp3/internal/Util;->readMedium(Lokio/e;)I
    ...
    invoke-static {v0, p2}, Lkotlin/jvm/internal/s;->stringPlus(Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/String;
...
.method public final readConnectionPreface(Lokhttp3/internal/http2/Http2Reader$Handler;)V
    ...
    invoke-interface {p1, v1, v2}, Lokio/e;->readByteString(J)Lokio/ByteString;
    ...
    invoke-static {v2, v3}, Lkotlin/jvm/internal/s;->stringPlus(Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/String;
