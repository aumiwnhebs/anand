...
.method private final connectSocket(IILokhttp3/Call;Lokhttp3/EventListener;)V
    ...
    :try_start_1
    invoke-static {v1}, Lokio/w;->source(Ljava/net/Socket;)Lokio/j0;
    ...
    invoke-static {v1}, Lokio/w;->sink(Ljava/net/Socket;)Lokio/h0;
    ...
    invoke-static {p2, p3}, Lkotlin/jvm/internal/s;->areEqual(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    invoke-static {p4, p3}, Lkotlin/jvm/internal/s;->stringPlus(Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/String;
...
.method private final connectTls(Lokhttp3/internal/connection/ConnectionSpecSelector;)V
    ...
    invoke-static {p1, v2, v6, v2}, Lkotlin/text/l;->trimMargin$default(Ljava/lang/String;Ljava/lang/String;ILjava/lang/Object;)Ljava/lang/String;
    ...
    invoke-direct {v5, v6, v7, v8, v9}, Lokhttp3/Handshake;-><init>(Lokhttp3/TlsVersion;Lokhttp3/CipherSuite;Ljava/util/List;Lj0/a;)V
    ...
    invoke-virtual {v3, v0, v4}, Lokhttp3/CertificatePinner;->check$okhttp(Ljava/lang/String;Lj0/a;)V
...
.method private final createTunnel(IILokhttp3/Request;Lokhttp3/HttpUrl;)Lokhttp3/Request;
    ...
    invoke-virtual {v5, v6, v7, v8}, Lokio/k0;->timeout(JLjava/util/concurrent/TimeUnit;)Lokio/k0;

    invoke-interface {v2}, Lokio/d;->timeout()Lokio/k0;
    ...
    invoke-static {v2, p3, v1}, Lkotlin/text/l;->equals(Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    invoke-static {p3, p2}, Lkotlin/jvm/internal/s;->stringPlus(Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/String;
...
.method public final newCodec$okhttp(Lokhttp3/OkHttpClient;Lokhttp3/internal/http/RealInterceptorChain;)Lokhttp3/internal/http/ExchangeCodec;
    ...
    invoke-interface {v1}, Lokio/e;->timeout()Lokio/k0;
