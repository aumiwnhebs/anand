...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "timeUnit",
        "skipAll",
        "(Lokio/j0;ILjava/util/concurrent/TimeUnit;)Z",
        "timeout",
        "discard",
        "Ljava/net/Socket;",
        "peerName",
        ...
        "predicate",
        "filterList",
        "(Ljava/lang/Iterable;Lj0/l;)Ljava/util/List;",
        "",
        "EMPTY_BYTE_ARRAY",
        "[B",
        "EMPTY_HEADERS",
...
.field private static final UNICODE_BOMS:Lokio/z;
...
.method static constructor <clinit>()V
    ...
    sget-object v1, Lokio/z;->Companion:Lokio/z$a;

    sget-object v2, Lokio/ByteString;->Companion:Lokio/ByteString$a;

    const-string v3, "efbbbf"

    invoke-virtual {v2, v3}, Lokio/ByteString$a;->decodeHex(Ljava/lang/String;)Lokio/ByteString;

    move-result-object v3

    const-string v4, "feff"

    invoke-virtual {v2, v4}, Lokio/ByteString$a;->decodeHex(Ljava/lang/String;)Lokio/ByteString;

    move-result-object v4

    const-string v5, "fffe"

    invoke-virtual {v2, v5}, Lokio/ByteString$a;->decodeHex(Ljava/lang/String;)Lokio/ByteString;

    move-result-object v5

    const-string v6, "0000ffff"

    invoke-virtual {v2, v6}, Lokio/ByteString$a;->decodeHex(Ljava/lang/String;)Lokio/ByteString;

    move-result-object v6

    const-string v7, "ffff0000"

    invoke-virtual {v2, v7}, Lokio/ByteString$a;->decodeHex(Ljava/lang/String;)Lokio/ByteString;
    ...
    invoke-virtual {v1, v2}, Lokio/z$a;->of([Lokio/ByteString;)Lokio/z;

    move-result-object v1

    sput-object v1, Lokhttp3/internal/Util;->UNICODE_BOMS:Lokio/z;
    ...
    invoke-static {v0, v1}, Lkotlin/text/l;->removePrefix(Ljava/lang/String;Ljava/lang/CharSequence;)Ljava/lang/String;

    move-result-object v0

    const-string v1, "Client"

    invoke-static {v0, v1}, Lkotlin/text/l;->removeSuffix(Ljava/lang/String;Ljava/lang/CharSequence;)Ljava/lang/String;
...
.method public static final asFactory(Lokhttp3/EventListener;)Lokhttp3/EventListener$Factory;
    ...
    invoke-direct {v0, p0}, Lj1/a;-><init>(Lokhttp3/EventListener;)V
...
.method public static final checkDuration(Ljava/lang/String;JLjava/util/concurrent/TimeUnit;)I
    ...
    invoke-static {p0, p1}, Lkotlin/jvm/internal/s;->stringPlus(Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/String;
...
.method public static final delimiterOffset(Ljava/lang/String;Ljava/lang/String;II)I
    ...
    invoke-static {p1, v1, v4, v2, v3}, Lkotlin/text/l;->contains$default(Ljava/lang/CharSequence;CZILjava/lang/Object;)Z
...
.method public static final discard(Lokio/j0;ILjava/util/concurrent/TimeUnit;)Z
    ...
    :try_start_0
    invoke-static {p0, p1, p2}, Lokhttp3/internal/Util;->skipAll(Lokio/j0;ILjava/util/concurrent/TimeUnit;)Z
...
.method public static final filterList(Ljava/lang/Iterable;Lj0/l;)Ljava/util/List;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    :cond_1
    invoke-static {v0}, Lkotlin/jvm/internal/a0;->asMutableList(Ljava/lang/Object;)Ljava/util/List;
...
.method public static final varargs format(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    ...
    sget-object v0, Lkotlin/jvm/internal/z;->INSTANCE:Lkotlin/jvm/internal/z;
...
.method public static final ignoreIoExceptions(Lj0/a;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static final indexOfControlOrNonAscii(Ljava/lang/String;)I
    ...
    invoke-static {v3, v4}, Lkotlin/jvm/internal/s;->compare(II)I
...
.method public static final isCivilized(Lokhttp3/internal/io/FileSystem;Ljava/io/File;)Z
    ...
    invoke-interface {p0, p1}, Lokhttp3/internal/io/FileSystem;->sink(Ljava/io/File;)Lokio/h0;
    ...
    invoke-static {v0, v1}, Lh0/a;->closeFinally(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    ...
    invoke-static {v0, p0}, Lh0/a;->closeFinally(Ljava/io/Closeable;Ljava/lang/Throwable;)V
...
.method public static final readBomAsCharset(Lokio/e;Ljava/nio/charset/Charset;)Ljava/nio/charset/Charset;
    ...
    sget-object v0, Lokhttp3/internal/Util;->UNICODE_BOMS:Lokio/z;

    invoke-interface {p0, v0}, Lokio/e;->select(Lokio/z;)I
    ...
    sget-object p0, Lkotlin/text/d;->INSTANCE:Lkotlin/text/d;

    invoke-virtual {p0}, Lkotlin/text/d;->UTF32_LE()Ljava/nio/charset/Charset;
    ...
    invoke-virtual {p0}, Lkotlin/text/d;->UTF32_BE()Ljava/nio/charset/Charset;
...
.method public static final threadFactory(Ljava/lang/String;Z)Ljava/util/concurrent/ThreadFactory;
    ...
    invoke-direct {v0, p0, p1}, Lj1/b;-><init>(Ljava/lang/String;Z)V
...
.method public static final threadName(Ljava/lang/String;Lj0/a;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {p0}, Lkotlin/jvm/internal/r;->finallyStart(I)V

    invoke-virtual {v0, v1}, Ljava/lang/Thread;->setName(Ljava/lang/String;)V

    invoke-static {p0}, Lkotlin/jvm/internal/r;->finallyEnd(I)V
...
.method public static final toHeaderList(Lokhttp3/Headers;)Ljava/util/List;
    ...
    invoke-static {v1, v0}, Ln0/s;->until(II)Ln0/l;
...
.method public static final toHostHeader(Lokhttp3/HttpUrl;Z)Ljava/lang/String;
    ...
    invoke-static {v0, v3, v4, v1, v2}, Lkotlin/text/l;->contains$default(Ljava/lang/CharSequence;Ljava/lang/CharSequence;ZILjava/lang/Object;)Z
...
.method public static final withSuppressed(Ljava/lang/Exception;Ljava/util/List;)Ljava/lang/Throwable;
    ...
    invoke-static {p0, v0}, Lb0/a;->addSuppressed(Ljava/lang/Throwable;Ljava/lang/Throwable;)V
