...
.method private final writeCanonicalized(Lokio/c;Ljava/lang/String;IILjava/lang/String;ZZZZLjava/nio/charset/Charset;)V
    ...
    :goto_2
    invoke-virtual {p1, v8}, Lokio/c;->writeUtf8(Ljava/lang/String;)Lokio/c;
    ...
    invoke-static {v12, v8, v10, v11, v4}, Lkotlin/text/l;->contains$default(Ljava/lang/CharSequence;CZILjava/lang/Object;)Z
    ...
    :cond_8
    :goto_4
    invoke-virtual {p1, v7}, Lokio/c;->writeUtf8CodePoint(I)Lokio/c;
    ...
    invoke-static {v3, v10}, Lkotlin/jvm/internal/s;->areEqual(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    invoke-virtual {v6, v1, v5, v10, v3}, Lokio/c;->writeString(Ljava/lang/String;IILjava/nio/charset/Charset;)Lokio/c;

    goto :goto_7

    :cond_b
    :goto_6
    invoke-virtual {v6, v7}, Lokio/c;->writeUtf8CodePoint(I)Lokio/c;

    :goto_7
    invoke-virtual {v6}, Lokio/c;->exhausted()Z
    ...
    invoke-virtual {p1, v9}, Lokio/c;->writeByte(I)Lokio/c;
    ...
    invoke-virtual {p1, v11}, Lokio/c;->writeByte(I)Lokio/c;
    ...
    invoke-virtual {p1, v10}, Lokio/c;->writeByte(I)Lokio/c;
...
.method private final writePercentDecoded(Lokio/c;Ljava/lang/String;IIZ)V
    ...
    invoke-virtual {p1, p3}, Lokio/c;->writeByte(I)Lokio/c;
    ...
    :cond_1
    invoke-virtual {p1, v0}, Lokio/c;->writeUtf8CodePoint(I)Lokio/c;
...
.method public final canonicalize$okhttp(Ljava/lang/String;IILjava/lang/String;ZZZZLjava/nio/charset/Charset;)Ljava/lang/String;
    ...
    invoke-static {v5, v1, v8, v6, v7}, Lkotlin/text/l;->contains$default(Ljava/lang/CharSequence;CZILjava/lang/Object;)Z
    ...
    invoke-virtual {v12, p1, p2, v3}, Lokio/c;->writeUtf8(Ljava/lang/String;II)Lokio/c;
    ...
    invoke-virtual {v12}, Lokio/c;->readUtf8()Ljava/lang/String;
...
.method public final percentDecode$okhttp(Ljava/lang/String;IIZ)Ljava/lang/String;
    ...
    invoke-virtual {v0, p1, p2, v4}, Lokio/c;->writeUtf8(Ljava/lang/String;II)Lokio/c;
...
.method public final toQueryString$okhttp(Ljava/util/List;Ljava/lang/StringBuilder;)V
    ...
    invoke-static {v0, v1}, Ln0/s;->step(Ln0/j;I)Ln0/j;

    move-result-object v0

    invoke-virtual {v0}, Ln0/j;->getFirst()I

    move-result v1

    invoke-virtual {v0}, Ln0/j;->getLast()I

    move-result v2

    invoke-virtual {v0}, Ln0/j;->getStep()I
