...
# instance fields
.field private final zaa:Lcom/google/android/gms/common/api/internal/g;
...
.method constructor <init>(Lcom/google/android/gms/common/api/internal/g;ILcom/google/android/gms/common/api/internal/b;JJLjava/lang/String;Ljava/lang/String;)V
    ...
    iput-object p1, p0, Lcom/google/android/gms/common/api/internal/y1;->zaa:Lcom/google/android/gms/common/api/internal/g;

    iput p2, p0, Lcom/google/android/gms/common/api/internal/y1;->zab:I

    iput-object p3, p0, Lcom/google/android/gms/common/api/internal/y1;->zac:Lcom/google/android/gms/common/api/internal/b;

    iput-wide p4, p0, Lcom/google/android/gms/common/api/internal/y1;->zad:J

    iput-wide p6, p0, Lcom/google/android/gms/common/api/internal/y1;->zae:J

    return-void
.end method

.method static zaa(Lcom/google/android/gms/common/api/internal/g;ILcom/google/android/gms/common/api/internal/b;)Lcom/google/android/gms/common/api/internal/y1;
    .locals 12
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
    ...
    invoke-virtual {p0, p2}, Lcom/google/android/gms/common/api/internal/g;->zai(Lcom/google/android/gms/common/api/internal/b;)Lcom/google/android/gms/common/api/internal/l1;

    move-result-object v1

    if-eqz v1, :cond_3

    invoke-virtual {v1}, Lcom/google/android/gms/common/api/internal/l1;->zaf()Lcom/google/android/gms/common/api/a$f;
    ...
    invoke-static {v1, v2, p1}, Lcom/google/android/gms/common/api/internal/y1;->zab(Lcom/google/android/gms/common/api/internal/l1;Lcom/google/android/gms/common/internal/d;I)Lcom/google/android/gms/common/internal/ConnectionTelemetryConfiguration;

    move-result-object v0

    if-eqz v0, :cond_1

    invoke-virtual {v1}, Lcom/google/android/gms/common/api/internal/l1;->zaq()V
...
.method private static zab(Lcom/google/android/gms/common/api/internal/l1;Lcom/google/android/gms/common/internal/d;I)Lcom/google/android/gms/common/internal/ConnectionTelemetryConfiguration;
    .locals 2
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
    ...
    :cond_0
    invoke-static {v1, p2}, Lq/b;->contains([II)Z
    ...
    :cond_2
    :goto_0
    invoke-virtual {p0}, Lcom/google/android/gms/common/api/internal/l1;->zac()I
...
.method public final onComplete(Lcom/google/android/gms/tasks/i;)V
    ...
    iget-object v1, v0, Lcom/google/android/gms/common/api/internal/y1;->zaa:Lcom/google/android/gms/common/api/internal/g;

    invoke-virtual {v1}, Lcom/google/android/gms/common/api/internal/g;->zaD()Z
    ...
    invoke-virtual {v1}, Lcom/google/android/gms/common/internal/n;->getConfig()Lcom/google/android/gms/common/internal/RootTelemetryConfiguration;
    ...
    :cond_1
    iget-object v2, v0, Lcom/google/android/gms/common/api/internal/y1;->zaa:Lcom/google/android/gms/common/api/internal/g;

    iget-object v3, v0, Lcom/google/android/gms/common/api/internal/y1;->zac:Lcom/google/android/gms/common/api/internal/b;

    invoke-virtual {v2, v3}, Lcom/google/android/gms/common/api/internal/g;->zai(Lcom/google/android/gms/common/api/internal/b;)Lcom/google/android/gms/common/api/internal/l1;

    move-result-object v2

    if-eqz v2, :cond_b

    invoke-virtual {v2}, Lcom/google/android/gms/common/api/internal/l1;->zaf()Lcom/google/android/gms/common/api/a$f;
    ...
    iget-wide v4, v0, Lcom/google/android/gms/common/api/internal/y1;->zad:J
    ...
    iget v4, v0, Lcom/google/android/gms/common/api/internal/y1;->zab:I

    invoke-static {v2, v3, v4}, Lcom/google/android/gms/common/api/internal/y1;->zab(Lcom/google/android/gms/common/api/internal/l1;Lcom/google/android/gms/common/internal/d;I)Lcom/google/android/gms/common/internal/ConnectionTelemetryConfiguration;
    ...
    iget-wide v3, v0, Lcom/google/android/gms/common/api/internal/y1;->zad:J
    ...
    :goto_2
    iget-object v5, v0, Lcom/google/android/gms/common/api/internal/y1;->zaa:Lcom/google/android/gms/common/api/internal/g;

    invoke-virtual/range {p1 .. p1}, Lcom/google/android/gms/tasks/i;->isSuccessful()Z
    ...
    :cond_6
    invoke-virtual/range {p1 .. p1}, Lcom/google/android/gms/tasks/i;->isCanceled()Z
    ...
    :cond_7
    invoke-virtual/range {p1 .. p1}, Lcom/google/android/gms/tasks/i;->getException()Ljava/lang/Exception;
    ...
    iget-wide v6, v0, Lcom/google/android/gms/common/api/internal/y1;->zad:J

    iget-wide v9, v0, Lcom/google/android/gms/common/api/internal/y1;->zae:J
    ...
    :goto_6
    iget v10, v0, Lcom/google/android/gms/common/api/internal/y1;->zab:I
    ...
    invoke-virtual/range {v11 .. v16}, Lcom/google/android/gms/common/api/internal/g;->zaw(Lcom/google/android/gms/common/internal/MethodInvocation;IJI)V
