...
.method public constructor <init>(J)V
    ...
    .line 7
    invoke-static {}, Lcom/bumptech/glide/load/engine/bitmap_recycle/j;->getDefaultStrategy()Lcom/bumptech/glide/load/engine/bitmap_recycle/k;

    move-result-object v0

    invoke-static {}, Lcom/bumptech/glide/load/engine/bitmap_recycle/j;->getDefaultAllowedConfigs()Ljava/util/Set;
...
.method private dump()V
    ...
    invoke-direct {p0}, Lcom/bumptech/glide/load/engine/bitmap_recycle/j;->dumpUnchecked()V
...
.method private evict()V
    ...
    invoke-direct {p0, v0, v1}, Lcom/bumptech/glide/load/engine/bitmap_recycle/j;->trimToSize(J)V
...
.method private static getDefaultStrategy()Lcom/bumptech/glide/load/engine/bitmap_recycle/k;
    .locals 1
...
.method private declared-synchronized getDirtyOrNull(IILandroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;
    ...
    :try_start_0
    invoke-static {p3}, Lcom/bumptech/glide/load/engine/bitmap_recycle/j;->assertNotHardwareConfig(Landroid/graphics/Bitmap$Config;)V
    ...
    :goto_0
    invoke-interface {v0, p1, p2, v1}, Lcom/bumptech/glide/load/engine/bitmap_recycle/k;->get(IILandroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;
    ...
    invoke-interface {v3, p1, p2, p3}, Lcom/bumptech/glide/load/engine/bitmap_recycle/k;->logBitmap(IILandroid/graphics/Bitmap$Config;)Ljava/lang/String;
    ...
    invoke-interface {v3, v0}, Lcom/bumptech/glide/load/engine/bitmap_recycle/k;->getSize(Landroid/graphics/Bitmap;)I
    ...
    invoke-interface {v1, v0}, Lcom/bumptech/glide/load/engine/bitmap_recycle/j$a;->remove(Landroid/graphics/Bitmap;)V

    invoke-static {v0}, Lcom/bumptech/glide/load/engine/bitmap_recycle/j;->normalize(Landroid/graphics/Bitmap;)V
...
.method private static normalize(Landroid/graphics/Bitmap;)V
    ...
    invoke-static {p0}, Lcom/bumptech/glide/load/engine/bitmap_recycle/j;->maybeSetPreMultiplied(Landroid/graphics/Bitmap;)V
...
.method private declared-synchronized trimToSize(J)V
    ...
    invoke-interface {v3, v0}, Lcom/bumptech/glide/load/engine/bitmap_recycle/k;->logBitmap(Landroid/graphics/Bitmap;)Ljava/lang/String;
...
.method public evictionCount()J
    ...
    iget v0, p0, Lcom/bumptech/glide/load/engine/bitmap_recycle/j;->evictions:I
...
.method public get(IILandroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;
    ...
    invoke-direct {p0, p1, p2, p3}, Lcom/bumptech/glide/load/engine/bitmap_recycle/j;->getDirtyOrNull(IILandroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;
...
.method public hitCount()J
    ...
    iget v0, p0, Lcom/bumptech/glide/load/engine/bitmap_recycle/j;->hits:I
...
.method public missCount()J
    ...
    iget v0, p0, Lcom/bumptech/glide/load/engine/bitmap_recycle/j;->misses:I
...
.method public declared-synchronized put(Landroid/graphics/Bitmap;)V
    ...
    invoke-interface {v0, p1}, Lcom/bumptech/glide/load/engine/bitmap_recycle/k;->getSize(Landroid/graphics/Bitmap;)I
    ...
    invoke-interface {v2, p1}, Lcom/bumptech/glide/load/engine/bitmap_recycle/k;->put(Landroid/graphics/Bitmap;)V
    ...
    invoke-interface {v2, p1}, Lcom/bumptech/glide/load/engine/bitmap_recycle/j$a;->add(Landroid/graphics/Bitmap;)V
    ...
    invoke-interface {v2, p1}, Lcom/bumptech/glide/load/engine/bitmap_recycle/k;->logBitmap(Landroid/graphics/Bitmap;)Ljava/lang/String;
    ...
    invoke-direct {p0}, Lcom/bumptech/glide/load/engine/bitmap_recycle/j;->evict()V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public declared-synchronized setSizeMultiplier(F)V
    ...
    :try_start_0
    iget-wide v0, p0, Lcom/bumptech/glide/load/engine/bitmap_recycle/j;->initialMaxSize:J
