...
.method private declared-synchronized getModelLoadersForClass(Ljava/lang/Class;)Ljava/util/List;
    ...
    invoke-virtual {v0, p1}, Lcom/bumptech/glide/load/model/p$a;->get(Ljava/lang/Class;)Ljava/util/List;
    ...
    invoke-virtual {v0, p1}, Lcom/bumptech/glide/load/model/r;->build(Ljava/lang/Class;)Ljava/util/List;
    ...
    invoke-virtual {v1, p1, v0}, Lcom/bumptech/glide/load/model/p$a;->put(Ljava/lang/Class;Ljava/util/List;)V
    :try_end_0
...
# virtual methods
.method public declared-synchronized append(Ljava/lang/Class;Ljava/lang/Class;Lcom/bumptech/glide/load/model/o;)V
    .locals 1
    .param p1    # Ljava/lang/Class;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    invoke-virtual {v0, p1, p2, p3}, Lcom/bumptech/glide/load/model/r;->append(Ljava/lang/Class;Ljava/lang/Class;Lcom/bumptech/glide/load/model/o;)V

    iget-object p1, p0, Lcom/bumptech/glide/load/model/p;->cache:Lcom/bumptech/glide/load/model/p$a;

    invoke-virtual {p1}, Lcom/bumptech/glide/load/model/p$a;->clear()V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public declared-synchronized build(Ljava/lang/Class;Ljava/lang/Class;)Lcom/bumptech/glide/load/model/n;
    ...
    invoke-virtual {v0, p1, p2}, Lcom/bumptech/glide/load/model/r;->build(Ljava/lang/Class;Ljava/lang/Class;)Lcom/bumptech/glide/load/model/n;
...
.method public declared-synchronized getDataClasses(Ljava/lang/Class;)Ljava/util/List;
    ...
    invoke-virtual {v0, p1}, Lcom/bumptech/glide/load/model/r;->getDataClasses(Ljava/lang/Class;)Ljava/util/List;
...
.method public getModelLoaders(Ljava/lang/Object;)Ljava/util/List;
    ...
    invoke-static {p1}, Lcom/bumptech/glide/load/model/p;->getClass(Ljava/lang/Object;)Ljava/lang/Class;

    move-result-object v0

    invoke-direct {p0, v0}, Lcom/bumptech/glide/load/model/p;->getModelLoadersForClass(Ljava/lang/Class;)Ljava/util/List;
...
.method public declared-synchronized prepend(Ljava/lang/Class;Ljava/lang/Class;Lcom/bumptech/glide/load/model/o;)V
    .locals 1
    .param p1    # Ljava/lang/Class;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    invoke-virtual {v0, p1, p2, p3}, Lcom/bumptech/glide/load/model/r;->prepend(Ljava/lang/Class;Ljava/lang/Class;Lcom/bumptech/glide/load/model/o;)V
...
.method public declared-synchronized remove(Ljava/lang/Class;Ljava/lang/Class;)V
    ...
    invoke-virtual {v0, p1, p2}, Lcom/bumptech/glide/load/model/r;->remove(Ljava/lang/Class;Ljava/lang/Class;)Ljava/util/List;

    move-result-object p1

    invoke-direct {p0, p1}, Lcom/bumptech/glide/load/model/p;->tearDown(Ljava/util/List;)V
...
.method public declared-synchronized replace(Ljava/lang/Class;Ljava/lang/Class;Lcom/bumptech/glide/load/model/o;)V
    .locals 1
    .param p1    # Ljava/lang/Class;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    invoke-virtual {v0, p1, p2, p3}, Lcom/bumptech/glide/load/model/r;->replace(Ljava/lang/Class;Ljava/lang/Class;Lcom/bumptech/glide/load/model/o;)Ljava/util/List;
