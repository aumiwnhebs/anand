...
.field private static volatile instance:Lcom/bumptech/glide/load/resource/bitmap/o;
...
.method static constructor <clinit>()V
    ...
    :goto_0
    sput-boolean v1, Lcom/bumptech/glide/load/resource/bitmap/o;->BLOCK_HARDWARE_BITMAPS_WHEN_GL_CONTEXT_MIGHT_NOT_BE_INITIALIZED:Z
    ...
    :cond_1
    sput-boolean v2, Lcom/bumptech/glide/load/resource/bitmap/o;->HARDWARE_BITMAPS_SUPPORTED:Z
    ...
    sput-object v0, Lcom/bumptech/glide/load/resource/bitmap/o;->FD_SIZE_LIST:Ljava/io/File;
...
.method constructor <init>()V
    ...
    iput-boolean v0, p0, Lcom/bumptech/glide/load/resource/bitmap/o;->isFdSizeBelowHardwareLimit:Z
    ...
    iput-object v0, p0, Lcom/bumptech/glide/load/resource/bitmap/o;->isHardwareConfigAllowedByAppState:Ljava/util/concurrent/atomic/AtomicBoolean;

    const/16 v0, 0x4e20

    iput v0, p0, Lcom/bumptech/glide/load/resource/bitmap/o;->sdkBasedMaxFdCount:I
...
.method private areHardwareBitmapsBlockedByAppState()Z
    ...
    iget-object v0, p0, Lcom/bumptech/glide/load/resource/bitmap/o;->isHardwareConfigAllowedByAppState:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public static getInstance()Lcom/bumptech/glide/load/resource/bitmap/o;
    .locals 2

    sget-object v0, Lcom/bumptech/glide/load/resource/bitmap/o;->instance:Lcom/bumptech/glide/load/resource/bitmap/o;
    ...
    :try_start_0
    sget-object v1, Lcom/bumptech/glide/load/resource/bitmap/o;->instance:Lcom/bumptech/glide/load/resource/bitmap/o;
    ...
    sput-object v1, Lcom/bumptech/glide/load/resource/bitmap/o;->instance:Lcom/bumptech/glide/load/resource/bitmap/o;
...
.method private getMaxFdCount()I
    ...
    invoke-static {}, Lcom/bumptech/glide/load/resource/bitmap/o;->isHardwareBitmapCountReducedOnApi28ByB139097735()Z
    ...
    :cond_0
    iget v0, p0, Lcom/bumptech/glide/load/resource/bitmap/o;->sdkBasedMaxFdCount:I
...
.method private declared-synchronized isFdSizeBelowHardwareLimit()Z
    ...
    :try_start_0
    iget v0, p0, Lcom/bumptech/glide/load/resource/bitmap/o;->decodesSinceLastFdCheck:I

    const/4 v1, 0x1

    add-int/2addr v0, v1

    iput v0, p0, Lcom/bumptech/glide/load/resource/bitmap/o;->decodesSinceLastFdCheck:I
    ...
    sget-object v2, Lcom/bumptech/glide/load/resource/bitmap/o;->FD_SIZE_LIST:Ljava/io/File;
    ...
    invoke-direct {p0}, Lcom/bumptech/glide/load/resource/bitmap/o;->getMaxFdCount()I
    ...
    :goto_0
    iput-boolean v1, p0, Lcom/bumptech/glide/load/resource/bitmap/o;->isFdSizeBelowHardwareLimit:Z
    ...
    :cond_1
    :goto_1
    iget-boolean v0, p0, Lcom/bumptech/glide/load/resource/bitmap/o;->isFdSizeBelowHardwareLimit:Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public isHardwareConfigAllowed(IIZZ)Z
    ...
    :cond_1
    sget-boolean p3, Lcom/bumptech/glide/load/resource/bitmap/o;->HARDWARE_BITMAPS_SUPPORTED:Z
    ...
    :cond_3
    invoke-direct {p0}, Lcom/bumptech/glide/load/resource/bitmap/o;->areHardwareBitmapsBlockedByAppState()Z
    ...
    :cond_8
    invoke-direct {p0}, Lcom/bumptech/glide/load/resource/bitmap/o;->isFdSizeBelowHardwareLimit()Z
...
.method setHardwareConfigIfAllowed(IILandroid/graphics/BitmapFactory$Options;ZZ)Z
    ...
    invoke-virtual {p0, p1, p2, p4, p5}, Lcom/bumptech/glide/load/resource/bitmap/o;->isHardwareConfigAllowed(IIZZ)Z
