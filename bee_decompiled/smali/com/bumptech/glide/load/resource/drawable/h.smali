...
.method public static getDrawable(Landroid/content/Context;ILandroid/content/res/Resources$Theme;)Landroid/graphics/drawable/Drawable;
    ...
    .line 2
    invoke-static {p0, p0, p1, p2}, Lcom/bumptech/glide/load/resource/drawable/h;->getDrawable(Landroid/content/Context;Landroid/content/Context;ILandroid/content/res/Resources$Theme;)Landroid/graphics/drawable/Drawable;
...
.method public static getDrawable(Landroid/content/Context;Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    .line 1
    invoke-static {p0, p1, p2, v0}, Lcom/bumptech/glide/load/resource/drawable/h;->getDrawable(Landroid/content/Context;Landroid/content/Context;ILandroid/content/res/Resources$Theme;)Landroid/graphics/drawable/Drawable;
...
.method private static getDrawable(Landroid/content/Context;Landroid/content/Context;ILandroid/content/res/Resources$Theme;)Landroid/graphics/drawable/Drawable;
    ...
    .line 3
    :try_start_0
    sget-boolean v0, Lcom/bumptech/glide/load/resource/drawable/h;->shouldCallAppCompatResources:Z

    if-eqz v0, :cond_1

    .line 4
    invoke-static {p1, p2, p3}, Lcom/bumptech/glide/load/resource/drawable/h;->loadDrawableV7(Landroid/content/Context;ILandroid/content/res/Resources$Theme;)Landroid/graphics/drawable/Drawable;
    ...
    .line 8
    sput-boolean p0, Lcom/bumptech/glide/load/resource/drawable/h;->shouldCallAppCompatResources:Z
    ...
    :goto_0
    invoke-static {p1, p2, p3}, Lcom/bumptech/glide/load/resource/drawable/h;->loadDrawableV4(Landroid/content/Context;ILandroid/content/res/Resources$Theme;)Landroid/graphics/drawable/Drawable;
