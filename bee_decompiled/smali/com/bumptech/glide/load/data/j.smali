...
.field private final glideUrl:Lcom/bumptech/glide/load/model/h;
...
.method constructor <init>(Lcom/bumptech/glide/load/model/h;ILcom/bumptech/glide/load/data/j$b;)V
    ...
    .line 3
    iput-object p1, p0, Lcom/bumptech/glide/load/data/j;->glideUrl:Lcom/bumptech/glide/load/model/h;
...
.method private buildAndConfigureConnection(Ljava/net/URL;Ljava/util/Map;)Ljava/net/HttpURLConnection;
    ...
    :try_start_0
    iget-object v1, p0, Lcom/bumptech/glide/load/data/j;->connectionFactory:Lcom/bumptech/glide/load/data/j$b;

    invoke-interface {v1, p1}, Lcom/bumptech/glide/load/data/j$b;->build(Ljava/net/URL;)Ljava/net/HttpURLConnection;
    ...
    :cond_0
    iget p2, p0, Lcom/bumptech/glide/load/data/j;->timeout:I
...
.method private getStreamForSuccessfulRequest(Ljava/net/HttpURLConnection;)Ljava/io/InputStream;
    ...
    invoke-static {v1, v2, v3}, Lcom/bumptech/glide/util/b;->obtain(Ljava/io/InputStream;J)Ljava/io/InputStream;

    move-result-object v0

    iput-object v0, p0, Lcom/bumptech/glide/load/data/j;->stream:Ljava/io/InputStream;
    ...
    invoke-static {p1}, Lcom/bumptech/glide/load/data/j;->getHttpStatusCodeOrInvalid(Ljava/net/HttpURLConnection;)I
...
.method private loadDataWithRedirects(Ljava/net/URL;ILjava/net/URL;Ljava/util/Map;)Ljava/io/InputStream;
    ...
    :cond_1
    :goto_0
    invoke-direct {p0, p1, p4}, Lcom/bumptech/glide/load/data/j;->buildAndConfigureConnection(Ljava/net/URL;Ljava/util/Map;)Ljava/net/HttpURLConnection;
    ...
    invoke-static {p3}, Lcom/bumptech/glide/load/data/j;->getHttpStatusCodeOrInvalid(Ljava/net/HttpURLConnection;)I

    move-result p3

    invoke-static {p3}, Lcom/bumptech/glide/load/data/j;->isHttpOk(I)Z
    ...
    invoke-direct {p0, p1}, Lcom/bumptech/glide/load/data/j;->getStreamForSuccessfulRequest(Ljava/net/HttpURLConnection;)Ljava/io/InputStream;
    ...
    :cond_3
    invoke-static {p3}, Lcom/bumptech/glide/load/data/j;->isHttpRedirect(I)Z
    ...
    invoke-direct {p0, v1, p2, p1, p4}, Lcom/bumptech/glide/load/data/j;->loadDataWithRedirects(Ljava/net/URL;ILjava/net/URL;Ljava/util/Map;)Ljava/io/InputStream;
...
.method public loadData(Lcom/bumptech/glide/Priority;Lcom/bumptech/glide/load/data/d$a;)V
    ...
    :try_start_0
    iget-object v4, p0, Lcom/bumptech/glide/load/data/j;->glideUrl:Lcom/bumptech/glide/load/model/h;

    invoke-virtual {v4}, Lcom/bumptech/glide/load/model/h;->toURL()Ljava/net/URL;

    move-result-object v4

    iget-object v5, p0, Lcom/bumptech/glide/load/data/j;->glideUrl:Lcom/bumptech/glide/load/model/h;

    invoke-virtual {v5}, Lcom/bumptech/glide/load/model/h;->getHeaders()Ljava/util/Map;
    ...
    invoke-direct {p0, v4, v6, v7, v5}, Lcom/bumptech/glide/load/data/j;->loadDataWithRedirects(Ljava/net/URL;ILjava/net/URL;Ljava/util/Map;)Ljava/io/InputStream;
