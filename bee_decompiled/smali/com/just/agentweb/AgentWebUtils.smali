...
.method static clearCache(Landroid/content/Context;I)V
    ...
    const-string v1, "Starting cache prune, deleting files older than %d days"
    ...
    const-string p1, "Cache pruning completed, %d files deleted"
...
.method static clearCacheFolder(Ljava/io/File;I)I
    ...
    invoke-static {v4, p1}, Lcom/just/agentweb/AgentWebUtils;->clearCacheFolder(Ljava/io/File;I)I
    ...
    const-string p1, "Failed to clean the cache, result %s"
...
.method public static createImageFile(Landroid/content/Context;)Ljava/io/File;
    ...
    invoke-static {p0, v0, v1}, Lcom/just/agentweb/AgentWebUtils;->createFileByName(Landroid/content/Context;Ljava/lang/String;Z)Ljava/io/File;
...
.method public static showFileChooserCompat(Landroid/app/Activity;Landroid/webkit/WebView;Landroid/webkit/ValueCallback;Landroid/webkit/WebChromeClient$FileChooserParams;Lcom/just/agentweb/PermissionInterceptor;Landroid/webkit/ValueCallback;Ljava/lang/String;Landroid/os/Handler$Callback;)Z
    ...
    :try_start_0
    const-string v2, "com.just.agentweb.filechooser.FileChooser"
    ...
    const-class p6, Landroid/os/Handler$Callback;
    ...
    const-class p6, Lcom/just/agentweb/PermissionInterceptor;
